...
namespace JQToCordovaWizard
{
    ...
    internal sealed class Command1
    {
        ...
        /// </summary>
        public static readonly Guid MenuGroup = new Guid("fbe15b66-dfec-4640-9ac1-cc0ab2fb30c7");
        ...
        private Command1(Package package)
        {
            ...
            if (commandService != null)
            {
                ...
                EventHandler eventHandler = this.ShowMainForm;
