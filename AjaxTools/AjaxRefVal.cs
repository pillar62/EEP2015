...
namespace AjaxTools
{
    public class AjaxRefVal : WebRefValBase, ICallbackEventHandler, IAjaxDataSource, INamingContainer
    {
        public AjaxRefVal()
        {
    ...
    public class AjaxRefValTemplateField : DataControlField
    {
        // Fields
        ...
        // Properties
        [PersistenceMode(PersistenceMode.InnerProperty), Browsable(false), DefaultValue((string)null), TemplateContainer(typeof(IDataItemContainer), BindingDirection.TwoWay)]
        ...
        [DefaultValue((string)null), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(IDataItemContainer), BindingDirection.TwoWay)]
        ...
        [Browsable(false), TemplateContainer(typeof(IDataItemContainer)), DefaultValue((string)null), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue((string)null), Browsable(false), TemplateContainer(typeof(IDataItemContainer)), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Browsable(false), TemplateContainer(typeof(IDataItemContainer), BindingDirection.TwoWay), DefaultValue((string)null), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue((string)null), PersistenceMode(PersistenceMode.InnerProperty), Browsable(false), TemplateContainer(typeof(IDataItemContainer), BindingDirection.TwoWay)]
        ...
        {
            return new AjaxRefValTemplateField();
        }
        ...
        public override void InitializeCell(DataControlFieldCell cell, DataControlCellType cellType, DataControlRowState rowState, int rowIndex)
        {
            ...
            else if (cellType == DataControlCellType.DataCell)
            {
                ...
                btnSelect.ImageUrl = "~/Image/refval/RefValSelect.gif";
    ...
    public class GridViewSelectTemplate : System.Web.UI.ITemplate
    {
        ...
        public void InstantiateIn(Control container)
        {
            switch (templateType)
            {
                ...
                case DataControlRowType.Footer:
                    ...
                    ImageButton btnQuery = new ImageButton();
                    btnQuery.ImageUrl = "~/Image/UIPics/RefQuery.png";
                    btnQuery.CommandName = "Query";
                    cell11.Controls.Add(btnQuery);
                    TableCell cell12 = new TableCell();
                    cell12.Text = "&nbsp;";
                    TableCell cell13 = new TableCell();
                    ImageButton btnRefresh = new ImageButton();
                    btnRefresh.ImageUrl = "~/Image/UIPics/Refresh.png";
                    btnRefresh.CommandName = "Refresh";
                    cell13.Controls.Add(btnRefresh);
                    row1.Cells.AddRange(new TableCell[] { cell11, cell13 });
                    table.Rows.Add(row1);
