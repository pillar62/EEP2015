...
Type.registerNamespace('AjaxTools');

AjaxTools.AjaxAutoCompleteBehavior = function(element) {
    /// <summary>
    ...
    /// </param>
    /// <returns />
    AjaxTools.AjaxAutoCompleteBehavior.initializeBase(this, [element]);
...
AjaxTools.AjaxAutoCompleteBehavior.prototype = {
    initialize: function() {
        /// <summary>
        /// Initializes the autocomplete behavior.
        /// </summary>
        /// <returns />
        AjaxTools.AjaxAutoCompleteBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose: function() {
        ...
        AjaxTools.AjaxAutoCompleteBehavior.callBaseMethod(this, 'dispose');
    },
    ...
    _onTimerTick: function(sender, eventArgs) {
        ...
        if (this._servicePath && this._serviceMethod) {
            ...
            if ((this._currentPrefix !== text) || ((text == "") && (this._minimumPrefixLength == 0))) {
                ...
                params.commandTable = this._commandTable;
                params.dataKeyField = this._dataKeyField;

                params.userId = this._userId;
                params.password = this._password;
                params.dataBase = this._dataBase;
                params.solution = this._solution;
                Sys.Net.WebServiceProxy.invoke(this.get_servicePath(), this.get_serviceMethod(), false,
                                        { prefixText: this._currentPrefix, count: this._completionSetCount,
                                            commandTable: this._commandTable, dataKeyField: this._dataKeyField,
                                            userId: this._userId, password: this._password,
                                            dataBase: this._dataBase, solution: this._solution
                                        },
    ...
    // rax add
    get_commandTable: function() {
        return this._commandTable;
    },
    set_commandTable: function(value) {
        this._commandTable = value;
    },
...
AjaxTools.AjaxAutoCompleteBehavior.registerClass('AjaxTools.AjaxAutoCompleteBehavior', AjaxControlToolkit.BehaviorBase);
AjaxTools.AjaxAutoCompleteBehavior.descriptor = {
