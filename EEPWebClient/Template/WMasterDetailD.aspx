<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WMasterDetailD.aspx.cs" Inherits="Template_WMasterDetail1" Theme="ControlSkin" StylesheetTheme="ControlSkin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>WMasterDetailD</title>
...
<asp:ImageButton runat="server" Text="Update" CommandName="Update" ImageUrl="~/Image/UIPics/OK.gif" CausesValidation="True" id="ImageButton1"></asp:ImageButton>&nbsp;<asp:ImageButton runat="server" Text="Cancel" CommandName="Cancel" ImageUrl="~/Image/UIPics/Cancel.gif" CausesValidation="False" id="ImageButton2"></asp:ImageButton>
            ...
            <itemtemplate>
<asp:ImageButton runat="server" Text="Edit" CommandName="Edit" ImageUrl="~/Image/UIPics/Edit.gif" CausesValidation="False" id="ImageButton1"></asp:ImageButton>&nbsp;<asp:ImageButton runat="server" Text="Select" CommandName="Select" ImageUrl="~/Image/UIPics/Select.gif" CausesValidation="False" id="ImageButton2"></asp:ImageButton>&nbsp;<asp:ImageButton runat="server" Text="Delete" CommandName="Delete" ImageUrl="~/Image/UIPics/Delete.gif" CausesValidation="False" id="ImageButton3"></asp:ImageButton>
</itemtemplate>
        </asp:TemplateField>
    </Columns>
