...
Partial Class Template_VBWebSingle
    ...
    Protected Sub WebNavigator1_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles WebNavigator1.Command
        ...
        ElseIf (e.CommandName = "cmdDelete") Then
            Detail.ExecuteSelect(wdvMaster)
            DataBind()
        ElseIf (e.CommandName = "cmdApply" And wdvMaster.AllValidateSucess) Then
            Detail.ExecuteSelect(wdvMaster)
            DataBind()
        End If
    End Sub

    Protected Sub wdvMaster_PageIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles wdvMaster.PageIndexChanged
        Detail.ExecuteSelect(wdvMaster)
        DataBind()
    End Sub

    Protected Sub wdvMaster_AfterInsertLocate(ByVal sender As Object, ByVal e As System.EventArgs) Handles wdvMaster.AfterInsertLocate
        Detail.ExecuteSelect(wdvMaster)
        DataBind()
    End Sub

    Protected Sub wdvMaster_Canceled(ByVal sender As Object, ByVal e As System.EventArgs) Handles wdvMaster.Canceled
        Detail.ExecuteSelect(wdvMaster)
        DataBind()
    End Sub
