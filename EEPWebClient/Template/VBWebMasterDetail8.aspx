<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VBWebMasterDetail8.aspx.vb" Inherits="Template_VBWebMasterDetail8" %>
...
<AjaxTools:ExtGridToolItem ButtonName="btnRefresh" Text="refresh" IconUrl="~/Image/Ext/refresh.gif"></AjaxTools:ExtGridToolItem>
        ...
        <AjaxTools:AjaxLayout ID="AjaxLayout1" runat="server" View="AjaxGridView1">
            ...
            <ToolItems>
                ...
                <AjaxTools:ExtGridToolItem ButtonName="btnOK" IconUrl="~/Image/Ext/ok.gif" 
                    SysHandlerType="OK" Text="ok" />
                <AjaxTools:ExtGridToolItem ButtonName="btnCancel" 
                    IconUrl="~/Image/Ext/cancel.gif" SysHandlerType="Cancel" Text="cancel" />
            </ToolItems>
            <Masters>
