<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VBWebSingle3.aspx.vb" Inherits="Template_VBWebSingle3" %>
...
<body>
    ...
    <div>
        ...
        <AjaxTools:AjaxModalPanel ID="AjaxModalPanel1" runat="server" 
        DataContainer="WebFormView1" TriggerUpdatePanel="UpdatePanel1" Width="500px">
