...
(function($) {
                        ...
                        $.each(this.split(','), function(j, buttonName) {
                            if (buttonName == 'title') {
                                ...
                                if (buttonClick) {
                                    ...
                                    var button,
									icon = null; //options.theme ? smartProperty(options.buttonIcons, buttonName) : null,
    ...
    var viewMethods = {
        ...
        */
        ...
        // attaches eventClick, eventMouseover, eventMouseout, eventDoubleClick
        ...
        eventElementHandlers: function(event, eventElement) {
			...
			.hover(
			    ...
			    function(ev) {
			        view.trigger('eventDoubleClick', this, event, ev);
			    }
			);
        },
