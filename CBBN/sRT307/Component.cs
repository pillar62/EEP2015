        ...
        public object[] smRT3071(object[] objParam)
        {
            ...
            try
            {
                ...
                /*
                 ...
                 17、備註
                 */
                selectSql = @"SELECT 'S,'+ STR_INVOICE +','+CASE 
                            WHEN ISNULL(UNINO, '') = '' AND ISNULL(LTRIM(EMAIL), '') = '' THEN 'B2C,,' + CUSNC + ',' + 'invoice@cbbn.com.tw' + ',' + raddr + ',2,' + CUSID + ',,N,'
                            ...
                            'I,' + STR_INVOICE + ',' + amtnc + ',' + CAST(QTY AS VARCHAR(10)) + ',個,' + CAST(amt AS VARCHAR(10)) + ',' + CAST(amt AS VARCHAR(10)) AS S2
