        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sRT1032.RT10326" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="right" Caption="主線" Editor="numberbox" FieldName="LINEQ1" Format="" Width="120" />
                    <JQTools:JQGridColumn Alignment="right" Caption="項次" Editor="numberbox" FieldName="ENTRYNO" Format="" Width="120" />
                    <JQTools:JQGridColumn Alignment="right" Caption="異動項次" Editor="numberbox" FieldName="seq1" Format="" MaxLength="0" Width="120" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="異動員" Editor="text" FieldName="cusnc" Format="" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="撤線種類" Editor="text" FieldName="CODENC1" Format="" MaxLength="0" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="撤線申請日" Editor="datebox" FieldName="DROPAPPLYDAT" Format="" MaxLength="0" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="預定撤線日" Editor="datebox" FieldName="SCHDROPDAT" Format="" MaxLength="0" Width="120" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="派工日期" Editor="datebox" FieldName="SNDWORKDAT" Format="" MaxLength="0" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="拆機結案日" Editor="datebox" FieldName="SNDCLOSEDAT" Format="" MaxLength="0" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="撤線結案日" Editor="datebox" FieldName="CLOSEDAT" Format="" Width="120" />
