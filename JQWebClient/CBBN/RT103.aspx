        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sRT103.RTLessorAVSCmtyLine" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="PPPOE撥接帳號" Condition="%" DataType="string" Editor="text" FieldName="PPPOEACCOUNT" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="光纖號碼" Condition="%" DataType="string" Editor="text" FieldName="FIBERID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="可否建置(Y)" Condition="%" DataType="string" Editor="infocombobox" EditorOptions="items:[{value:'Y',text:'Y',selected:'false'},{value:'N',text:'N',selected:'false'}],checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="AGREE" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="主線維護" Width="800px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="RTLessorAVSCmtyLine" HorizontalColumnsCount="2" RemoteName="sRT103.RTLessorAVSCmtyLine" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="True" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="地址" Editor="text" FieldName="STREET" Format="" maxlength="14" Width="360" RowSpan="1" Span="2" />
                        <JQTools:JQFormColumn Alignment="left" Caption="可供裝範圍" Editor="text" FieldName="SUPPLYRANGE" Format="" maxlength="100" Width="300" RowSpan="1" Span="2" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="建檔日" Editor="datebox" FieldName="EDAT" Format="yyyy/mm/dd" Width="180" ReadOnly="True" maxlength="0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="光纖號碼" Editor="text" FieldName="FIBERID" Format="" maxlength="15" Width="180" Span="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption="主線SUBNET" Editor="infocombobox" FieldName="SUBNET" Format="" maxlength="20" Width="180" EditorOptions="items:[{value:' ',text:' ',selected:'false'},{value:'255.255.255.0',text:'255.255.255.0',selected:'false'},{value:'255.255.255.128',text:'255.255.255.128',selected:'false'}],checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" ReadOnly="False" />
                        <JQTools:JQFormColumn Alignment="left" Caption="閘道IP(Gateway)" Editor="text" FieldName="GATEWAY" Format="" maxlength="20" Width="180" ReadOnly="False" />
                        <JQTools:JQFormColumn Alignment="left" Caption="DNS IP" Editor="text" FieldName="DNSIP" Format="" maxlength="20" Width="180" ReadOnly="False" Span="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption="IP數量" Editor="numberbox" FieldName="IPCNT" Format="" Width="180" ReadOnly="False" RowSpan="1" Span="1" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="主線勘察日" Editor="datebox" FieldName="INSPECTDAT" Format="yyyy/mm/dd" Width="180" maxlength="0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="主線測通日" Editor="datebox" FieldName="ADSLAPPLYDAT" Format="yyyy/mm/dd" Width="180" maxlength="0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="作廢日" Editor="datebox" FieldName="CANCELDAT" Format="yyyy/mm/dd" Width="180" maxlength="0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="備註說明" Editor="textarea" FieldName="MEMO" Format="" maxlength="500" Width="500" EditorOptions="height:50" Span="2" />
                    </Columns>
                </JQTools:JQDataForm>
