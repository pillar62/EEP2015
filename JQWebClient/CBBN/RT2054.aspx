            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="客訴派工單維護" Width="800px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="RTSndWork" HorizontalColumnsCount="2" RemoteName="sRT2054.RTSndWork" AlwaysReadOnly="False" ChainDataFormID="JQDataForm1" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="派工別" Editor="inforefval" FieldName="WORKTYPE" Format="" maxlength="2" Width="180" EditorOptions="title:'派工別',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTCode',tableName:'RTCode',columns:[],columnMatches:[],whereItems:[{field:'KIND',value:'P6'}],valueField:'CODE',textField:'CODENC',valueFieldCaption:'代號',textFieldCaption:'名稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" />
                        <JQTools:JQFormColumn Alignment="left" Caption="預定施工員工" Editor="inforefval" FieldName="ASSIGNENG" Format="" maxlength="6" Width="180" EditorOptions="title:'員工',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTEmployee',tableName:'RTEmployee',columns:[],columnMatches:[],whereItems:[],valueField:'EMPLY',textField:'NAME',valueFieldCaption:'編號',textFieldCaption:'姓名',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="完工方式" Editor="inforefval" FieldName="FINISHTYP" Format="" maxlength="2" Width="180" EditorOptions="title:'完工方式',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTCode',tableName:'RTCode',columns:[],columnMatches:[],whereItems:[{field:'KIND',value:'P9'}],valueField:'CODE',textField:'CODENC',valueFieldCaption:'代號',textFieldCaption:'名稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" />
