            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="客訴派工單維護" Width="800px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="RTSndWork" HorizontalColumnsCount="2" RemoteName="sRT2054.RTSndWork" AlwaysReadOnly="False" ChainDataFormID="JQDataForm1" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="實際完工工桯師" Editor="inforefval" EditorOptions="title:'選擇工程師',panelWidth:350,panelHeight:350,remoteName:'sRT100.RT20541',tableName:'RT20541',columns:[],columnMatches:[],whereItems:[],valueField:'emply',textField:'cusnc',valueFieldCaption:'員工編號',textFieldCaption:'員工姓名',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" FieldName="FINISHENG" Format="" maxlength="6" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="預定施工經銷商" Editor="inforefval" EditorOptions="title:'經銷商',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTObj',tableName:'RTObj',columns:[],columnMatches:[],whereItems:[],valueField:'CUSID',textField:'SHORTNC',valueFieldCaption:'編號',textFieldCaption:'名稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" FieldName="ASSIGNCONS" Format="" maxlength="10" Span="1" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="實際完工經銷商" Editor="inforefval" EditorOptions="title:'經銷商',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTObj',tableName:'RTObj',columns:[],columnMatches:[],whereItems:[],valueField:'CUSID',textField:'SHORTNC',valueFieldCaption:'代號',textFieldCaption:'名稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" FieldName="FINISHCONS" Format="" maxlength="10" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="備註" Editor="textarea" EditorOptions="height:60" FieldName="MEMO" Format="" maxlength="600" ReadOnly="False" Span="2" Width="500" />
                        <JQTools:JQFormColumn Alignment="left" Caption="派工人員" Editor="infocombobox" EditorOptions="valueField:'EMPLY',textField:'NAME',remoteName:'sRT100.RTEmployee',tableName:'RTEmployee',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="SNDWRKUSR" Format="" MaxLength="6" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="派工日" Editor="datebox" EditorOptions="dateFormat:'datetime',showTimeSpinner:true,showSeconds:false,editable:true" FieldName="SNDWRKDAT" Format="yyyy/mm/dd HH:MM:SS" maxlength="0" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="完工人員" Editor="infocombobox" EditorOptions="valueField:'EMPLY',textField:'NAME',remoteName:'sRT100.RTEmployee',tableName:'RTEmployee',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="FINISHUSR" Format="" maxlength="6" NewRow="True" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="完工日" Editor="datebox" FieldName="FINISHDAT" Format="yyyy/mm/dd HH:MM:SS" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="異動員" Editor="infocombobox" EditorOptions="valueField:'EMPLY',textField:'NAME',remoteName:'sRT100.RTEmployee',tableName:'RTEmployee',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="UUSR" Format="" maxlength="6" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="異動日" Editor="datebox" FieldName="UDAT" Format="yyyy/mm/dd HH:MM:SS" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="作廢員" Editor="infocombobox" EditorOptions="valueField:'EMPLY',textField:'NAME',remoteName:'sRT100.RTEmployee',tableName:'RTEmployee',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="CANCELUSR" Format="" maxlength="6" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="作廢日" Editor="datebox" FieldName="CANCELDAT" Format="yyyy/mm/dd HH:MM:SS" ReadOnly="True" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="完工方式" Editor="inforefval" EditorOptions="title:'完工方式',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTCode',tableName:'RTCode',columns:[],columnMatches:[],whereItems:[{field:'KIND',value:'P9'}],valueField:'CODE',textField:'CODENC',valueFieldCaption:'代號',textFieldCaption:'名稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" FieldName="FINISHTYP" Format="" maxlength="2" ReadOnly="True" Width="160" />
                        <JQTools:JQFormColumn Alignment="left" Caption="預定施工日期" Editor="datebox" FieldName="ASSIGNDAT" Format="yyyy/mm/dd HH:MM:SS" Visible="False" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="預定施工時間" Editor="inforefval" EditorOptions="title:'JQRefval',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTCode',tableName:'RTCode',columns:[],columnMatches:[],whereItems:[{field:'KIND',value:'Q4'}],valueField:'CODE',textField:'CODENC',valueFieldCaption:'CODE',textFieldCaption:'CODENC',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" FieldName="ASSIGNTIME" Format="" maxlength="5" Visible="False" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="預定施工員工" Editor="inforefval" FieldName="ASSIGNENG" Format="" maxlength="6" Width="180" EditorOptions="title:'員工',panelWidth:350,panelHeight:200,remoteName:'sRT100.RT20542',tableName:'RT20542',columns:[],columnMatches:[],whereItems:[],valueField:'CODE',textField:'CODENC',valueFieldCaption:'編號',textFieldCaption:'姓名',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" Visible="False" />
                    </Columns>
                </JQTools:JQDataForm>
