<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RT104111.aspx.cs" Inherits="Template_JQueryQuery1" %>
...
<head runat="server">
    ...
    <script>
        ...
        function btn1Click()
        {
            ...
            $.ajax({
                type: "POST",
                url: '../handler/jqDataHandle.ashx?RemoteName=sRT1041.cmdRT104111', //連接的Server端，command
    ...
    <form id="form1" runat="server">
        <div hidden="hidden">
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sRT1041.cmdRT10411" runat="server" AutoApply="True"
                DataMember="cmdRT10411" Pagination="True" QueryTitle="Query"
