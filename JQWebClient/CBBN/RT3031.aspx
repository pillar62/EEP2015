<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RT3031.aspx.cs" Inherits="Template_JQueryQuery1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sRT303.cmRT3031" runat="server" AutoApply="True"
                DataMember="cmRT3031" Pagination="True" QueryTitle="Query"
                Title="用戶應收應付帳款明細查詢" AllowDelete="False" AllowInsert="False" AllowUpdate="False" QueryMode="Panel" AlwaysClose="False" AllowAdd="False" ViewCommandVisible="False" OnLoadSuccess="dgOnloadSuccess" EditOnEnter="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="False">
                <Columns>
