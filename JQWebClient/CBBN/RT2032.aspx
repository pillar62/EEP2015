    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sRT203.RT2032" runat="server" AutoApply="True"
                ...
                <Columns>
                    <JQTools:JQGridColumn Alignment="right" Caption="社區" Editor="numberbox" FieldName="comq1" Format="" Width="120" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="異動原因" Editor="text" FieldName="DROPDESC" Format="" Width="150" />
