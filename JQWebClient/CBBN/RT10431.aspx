<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RT10431.aspx.cs" Inherits="Template_JQueryQuery1" %>
...
<head runat="server">
    ...
    <script>
        ...
        function btnIns(val) {
            var sMODE = "I";
            parent.addTab("用戶續約裝機派工單資料新增", "CBBN/RT104311.aspx?CUSID=" + CUSID + "&PRTNO=自動編號" + "&sMODE=" + sMODE);
        }
        ...
        function btn1Click()
        {
            var row = $('#dataGridMaster').datagrid('getSelected');//取得當前主檔中選中的那個Data
            var PRTNO = row.PRTNO;
            parent.addTab("物品領用單資料維護", "CBBN/RT104312.aspx?PRTNO=" + PRTNO);
        }
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sRT1043.RT10431" runat="server" AutoApply="True"
                DataMember="RT10431" Pagination="True" QueryTitle="Query"
                Title="用戶續約裝機派工單資料維護" AllowDelete="False" AllowInsert="False" AllowUpdate="False" QueryMode="Fuzzy" AlwaysClose="True" AllowAdd="False" ViewCommandVisible="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="False" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" OnLoadSuccess="dgOnloadSuccess" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="False" EnableViewState="False" OnSelect="mySelect">
                <Columns>
