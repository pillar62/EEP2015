            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="客訴資料維護" Width="606px" DialogCenter="False" EditMode="Dialog">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="RTFaqM" HorizontalColumnsCount="2" RemoteName="sRT2051.RTFaqM" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="主線IP" Editor="text" FieldName="CMTYIP" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="2" Visible="True" Width="500" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="用戶地址" Editor="text" FieldName="raddr" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="2" Visible="False" Width="450" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="是否為第二戶" Editor="text" FieldName="secondcase" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="1" Visible="False" Width="180" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="對帳代號" Editor="text" FieldName="nciccusno" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="1" Visible="False" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="客戶項次" Editor="text" FieldName="ENTRYNO" maxlength="3" Width="180" Visible="False" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="客戶來電詢問方案" Editor="inforefval" FieldName="ASKCASE" MaxLength="2" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="180" EditorOptions="title:'JQRefval',panelWidth:350,panelHeight:200,remoteName:'sRT100.RTCode',tableName:'RTCode',columns:[],columnMatches:[],whereItems:[{field:'KIND',value:'Q2'}],valueField:'CODE',textField:'CODENC',valueFieldCaption:'CODE',textFieldCaption:'CODENC',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none',fixTextbox:'false'" />
                    </Columns>
                </JQTools:JQDataForm>
