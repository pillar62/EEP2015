<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevReportViewerTemplate.aspx.cs"
    Inherits="DevReportViewerTemplate" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server" Theme="SoftOrange" ClientInstanceName="aspxViewer1" OnCacheReportDocument="ASPxDocumentViewer1_CacheReportDocument" OnRestoreReportDocumentFromCache="ASPxDocumentViewer1_RestoreReportDocumentFromCache">
