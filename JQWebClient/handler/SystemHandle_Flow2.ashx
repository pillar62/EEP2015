<%@ WebHandler Language="C#" Class="SystemHandle_Flow2" %>
...
public class SystemHandle_Flow2 : IHttpHandler, IRequiresSessionState
{
        ...
        try
        {
                ...
                || hContext.Request.Form["Type"] == "FlowRunOver")
            {
                ...
                else if (hContext.Request.Form["Type"] == "FlowRunOver")
                {
                    ...
                    FlowDataParameter aFlowDataParameter = new FlowDataParameter();
                    aFlowDataParameter.Description = realFilter;
                    var ds1 = EFClientTools.ClientUtility.Client.GetFlowDataDS(EFClientTools.ClientUtility.ClientInfo, FlowDataType.End, aFlowDataParameter);
                    ds = Deserialize<DataSet>(ds1);
                    //ESqlMode mode = (ESqlMode)Enum.Parse(typeof(ESqlMode), hContext.Request.Form["Type"]);
                    //ds = EFClientTools.ClientUtility.ExecuteSQL(EFClientTools.ClientUtility.ClientInfo.Database, GetFlowSql(user, mode));
                }
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (hContext.Request.Form["Type"] != "FlowRunOver")
                    {
                        ...
                        {
                            context.Response.Write(DataTableToJson(view.ToTable(), true));
                        }
                    }
                    else
                    {
            ...
            {
                var ds1 = EFClientTools.ClientUtility.Client.GetFlowDataDS(EFClientTools.ClientUtility.ClientInfo, FlowDataType.Notify, null);
            ...
            else if (hContext.Request.Form["Type"] == "Delay")
            {
                ...
                {
                    var ds1 = EFClientTools.ClientUtility.Client.GetFlowDataDS(EFClientTools.ClientUtility.ClientInfo, FlowDataType.Do, null);
                    DataSet ds = Deserialize<DataSet>(ds1);
                ...
                else
                {
                    ...
                    DataTable tab = FLOvertimeList(user, delayLevel, false);
                    if (tab.Rows.Count > 0)
                    {
                        messageKey = "FLDesigner/FLDesigner/Item3";
                        string[] Item3 = provider[messageKey].Split(',');
            ...
            else if (hContext.Request.Form["Type"] == "DelayAllData")
            {
                ...
                int delayLevel = int.Parse(hContext.Request.Form["Level"]);
                DataTable tab = FLOvertimeList(user, delayLevel, true);
                if (tab.Rows.Count > 0)
                {
                    messageKey = "FLDesigner/FLDesigner/Item3";
                    string[] Item3 = provider[messageKey].Split(',');
            ...
            else if (hContext.Request.Form["Type"] == "Count")
            {
                ...
                obj["Delay"] = FLOvertimeList(user, 0, false).Rows.Count;
            ...
            else if (hContext.Request.Form["Type"] == "gdvHis")
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    dv.Sort = "UPDATE_WHOLE_TIME DESC";
    ...
    public DataTable FLOvertimeList(string user, int level, bool isAllData)
    {
        try
        {
            bool delay = true;
            FlowDataParameter flp = new FlowDataParameter();
