<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WReport2.aspx.cs" Inherits="WReport2" %>
...
<body style="background-color: #ffffff">
    ...
    <div>
        ...
        <table style="width: 519px">
            <tr>
                ...
                <td style="width: 169px; height: 28px">
                    <InfoLight:WebDateTimePicker ID="WebDateTimePicker1" runat="server" DateFormat="ShortDate" ></InfoLight:WebDateTimePicker></td>
                <td style="width: 163px; height: 28px">
                    <span style="background-color: #ffffff">&nbsp;日期: </span><span style="background-color: #ff0066">
                    </span>
                </td>
                <td style="width: 163px; height: 28px">
                    <InfoLight:WebDateTimePicker ID="WebDateTimePicker2" runat="server" DateFormat="ShortDate"></InfoLight:WebDateTimePicker></td>
        ...
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
            DisplayGroupTree="False" DisplayPage="False" Height="50px"
            Width="350px" />
