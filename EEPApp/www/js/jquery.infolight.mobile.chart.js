$(document).ready(function () {
    $("." + $.fn.plotbarchart.class).plotbarchart({});
    $("." + $.fn.plotpiechart.class).plotpiechart({});
    $("." + $.fn.plotlinechart.class).plotlinechart({});
    $("." + $.fn.plotDashBoard.class).plotDashBoard({});
    $(window).bind("orientationchange resize pageshow", fixgeometry);
});
function fixgeometry() {
    var viewport_width = $(window).width();
    $("." + $.fn.plotbarchart.class).each(function () {
    ...
    $("." + $.fn.plotlinechart.class).each(function () {
        var plotwidth = $(this).width();
    ...
    $("." + $.fn.plotpiechart.class).each(function () {
        var plotwidth = $(this).width();
    ...
    $("." + $.fn.plotDashBoard.class).each(function () {
        var plotwidth = $(this).width();
...
$.fn.plotpiechart = function (methodName, value) {
    if (typeof methodName == "string") {
        ...
        this.each(function () {
            ...
            if (!$(this).hasClass($.fn.plotpiechart.class)) {
                $(this).addClass($.fn.plotpiechart.class)
            }
        });
    }
};

$.fn.plotpiechart.class = 'info-plotpiechart';
...
$.fn.plotpiechart.methods = {
        ...
        jq.each(function () {
            ...
            if (chartOptions.renderObjectID != undefined && chartOptions.renderObjectID != "") {
                if ($('#' + chartOptions.renderObjectID) != undefined) {
                    var diva = $('<div data-theme="b" data-role="content"></div>').appendTo($('#' + chartOptions.renderObjectID));
                    $(this).appendTo(diva);
                }
            }
    ...
    loadData: function (jq) {
        ...
        if (jq.length > 0) {
            ...
            if (options.remoteName != undefined && options.remoteName != "" && options.tableName != undefined) {
                var url = $.getUrl(options.remoteName, options.tableName, false); //呼叫Server取得數據的url
                var queryWord = new Object();
                if (options.whereString != undefined) {
                    queryWord.whereString = options.whereString;
                }
    ...
    getWhereItem: function (jq, op) {
        if (jq.length > 0) {
            ...
            if (op != undefined) {
                ...
                options = $.parseOption($(jq[0]).attr('infolight-options'));
            }
...
$.fn.plotlinechart = function (methodName, value) {
    if (typeof methodName == "string") {
        ...
        this.each(function () {
            ...
            if (!$(this).hasClass($.fn.plotlinechart.class)) {
                $(this).addClass($.fn.plotlinechart.class)
            }
        });
    }
};

$.fn.plotlinechart.class = 'info-plotlinechart';
...
$.fn.plotbarchart = function (methodName, value) {
    if (typeof methodName == "string") {
        ...
        this.each(function () {
            ...
            if (!$(this).hasClass($.fn.plotbarchart.class)) {
                $(this).addClass($.fn.plotbarchart.class)
            }
        });
    }
};

$.fn.plotbarchart.class = 'info-plotbarchart';
        ...
        if (jq.length > 0) {
            ...
            if (options.remoteName != undefined && options.remoteName != "" && options.tableName != undefined) {
                ...
                $.ajax({
                    type: "POST",
                    url: url,
                    data: { queryWord: $.toJSONString(queryWord) },//cordova 
                    //data: "queryWord=" + $.toJSONString(queryWord),
                    cache: false,
                    async: false,
                    success: function (returndata) {
...
$.fn.plotDashBoard = function (methodName, value) {
    if (typeof methodName == "string") {
        ...
        this.each(function () {
            ...
            if (!$(this).hasClass($.fn.plotDashBoard.class)) {
                $(this).addClass($.fn.plotDashBoard.class)
            }
        });
    }
};

$.fn.plotDashBoard.class = 'info-plotDashBoard';
