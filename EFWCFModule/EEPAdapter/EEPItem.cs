...
namespace EFWCFModule.EEPAdapter
{
    ...
    internal class EEPItem
    {
        ...
        private Type GetType(string assemblyName, string typeName)
        {
            ...
            var refereceName = serverAssembly.GetReferencedAssemblies().FirstOrDefault(c => c.Name.Equals(assemblyName));
            if (refereceName == null)
            {
            ...
            {
                var assembly = Assembly.Load(refereceName);
                return assembly.GetType(typeName, true);
            }
        }
    ...
    /// </summary>
    internal static class DbConnectionSet
    {
        ...
        {
            var obj = Item.Execute("GetDbConn", new object[] { dataBaseName });
            if (obj == null)
            {
    ...
    /// DbConnection item
    /// </summary>
    internal class DbConnection: EEPItem
    {
        /// <summary>
    ...
    /// </summary>
    internal static class SysEEPLogService
    {
    ...
    /// SysEEPLog item
    /// </summary>
    internal class SysEEPLog : EEPItem
    {
        /// <summary>
    ...
    /// </summary>
    internal class InstanceManager: EEPItem
    {
        /// <summary>
