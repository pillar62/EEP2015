...
SELECT          c.comtype, A.COMQ1, NULL AS LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, b.comn, 
                            ...
                            '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTCmty X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATEM
...
SELECT          c.comtype, A.COMQ1, '' AS LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, b.comn, 
                            ...
                            '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                ((SELECT          ipaddr + '/ '
                                    ...
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.MOBILE, a.HOME, '01' AS CUSTSRC, A.SPEED,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTCustAdslCmty X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.CUTYID = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
SELECT          c.comtype, A.COMQ1, '' AS LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, b.comn, 
                            ...
                            a.exttel + '-' + a.sphnno AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTSparqAdslCmty X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.CUTYID = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            '' AS SPEED,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTEbtCmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            '' AS SPEED,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTSparq499CmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
WHERE          c.comtype = '6'
UNION ALL
SELECT          D.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.codenc AS comtypenc, k.CONT AS belongnc, l.NAME AS salesnc, 
                            ...
                            '01') AS CUSTSRC, A.USERRATE,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTLessorAVSCmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
FROM              RTLessorAvsCust a LEFT OUTER JOIN
                            ...
                            RTCode c ON c.code = D.comtype AND c.kind = 'P5' LEFT OUTER JOIN
                            RTCode f ON f.code = b.linerate AND f.kind = 'D3' LEFT OUTER JOIN
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            A.USERRATE,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTLessorCmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            '01' AS CUSTSRC, '' AS SPEED,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTPrjCmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            A.USERRATE,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTSonetCmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            A.USERRATE,
                                (SELECT          TOP 1 Y.CODENC
                                  FROM               RTfareastCmtyLine X LEFT JOIN
                                                              RTCode Y ON Y.KIND = 'D3' AND Y.CODE = X.LINERATE
                                  WHERE           X.COMQ1 = A.COMQ1
                                  ORDER BY    X.LINERATE DESC) AS LINERATE
