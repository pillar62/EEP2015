...
, left((select NETIP + '/ ' from RTCmty where COMQ1=a.COMQ1 for XML PATH('')),len((select NETIP + '/ ' from RTCmty where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
c.docketdat, NULL AS strbillingdat, NULL AS newbillingdat, NULL AS duedat, c.dropdat, c.canceldat, '' AS secondcase, 
'' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat
, left((select ipaddr + '/ ' from RTCmty where COMQ1=a.COMQ1 for XML PATH('')),len((select ipaddr + '/ ' from RTCmty where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
, left((select ipaddr + '/ ' from RTSparqAdslCmty where cutyid=a.COMQ1 for XML PATH('')),len((select ipaddr + '/ ' from RTSparqAdslCmty where cutyid=a.COMQ1 for XML PATH('')))-1) as PP
...
c.docketdat, NULL AS strbillingdat, NULL AS newbillingdat, NULL AS duedat, c.dropdat, c.canceldat, '' AS secondcase, 
'' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat
, left((select lineip + '/ ' from RTEbtCmtyLine where COMQ1=a.COMQ1 for XML PATH('')),len((select lineip + '/ ' from RTEbtCmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
, left((select DISTINCT replace(str(lineipstr1) + '.' + str(lineipstr2) + '.' + str(lineipstr3) + '.' + str(lineipstr4)+ '~' + str(lineipend) , ' ', '') + '/ ' 
from RTSparq499CmtyLine where COMQ1=a.COMQ1  for XML PATH(''))
,len((select DISTINCT replace(str(lineipstr1) + '.' + str(lineipstr2) + '.' + str(lineipstr3) + '.' + str(lineipstr4)+ '~' + str(lineipend) , ' ', '') + '/ ' 
from RTSparq499CmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
a.cusnc, a.contacttel, d .CONTACTTEL AS companytel, j.CUTNC + a.TOWNSHIP2 + a.RADDR2 AS raddr, 
replace(a.ip11 + '.' + a.ip12 + '.' + a.ip13 + '.' + a.ip14, '...', '') AS CUSTIP, g.codenc AS CASEKIND, 
h.codenc AS paycycle, i.codenc AS paytype, replace(a.overdue, 'N', '') AS overdue, replace(a.freecode, 'N', '') 
AS freecode, a.docketdat, a.strbillingdat, a.newbillingdat, a.duedat, a.dropdat, a.canceldat, replace(a.secondcase, 'N', 
'') AS secondcase, '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat
, left((select LINEIP + '/ ' from RTLessorAVSCmtyLine where COMQ1=a.COMQ1 for XML PATH('')),len((select LINEIP + '/ ' from RTLessorAVSCmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
, left((select lineip + '/ ' from RTLessorCmtyLine where COMQ1=a.COMQ1 for XML PATH('')),len((select lineip + '/ ' from RTLessorCmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
'' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat
, left((select lineip + '/ ' from RTPrjCmtyLine where COMQ1=a.COMQ1 for XML PATH('')),len((select lineip + '/ ' from RTPrjCmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
, left((select lineip + '/ ' from RTSonetCmtyLine where COMQ1=a.COMQ1 for XML PATH('')),len((select lineip + '/ ' from RTSonetCmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
...
c.docketdat, a.strbillingdat, NULL AS newbillingdat, NULL AS duedat, c.dropdat, c.canceldat, '' AS secondcase, 
a.memberid AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat
, left((select lineip + '/ ' from RTfareastCmtyLine where COMQ1=a.COMQ1 for XML PATH('')),len((select lineip + '/ ' from RTfareastCmtyLine where COMQ1=a.COMQ1 for XML PATH('')))-1) as PP
