...
SELECT          c.comtype, A.COMQ1, NULL AS LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, b.comn, 
                            ...
                            '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                ((SELECT          NETIP + '/ '
                                    FROM              RTCmty
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.MOBILE, a.HOME, '01' AS CUSTSRC, A.SPEED
...
SELECT          c.comtype, A.COMQ1, '' AS LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, b.comn, 
                            ...
                            a.exttel + '-' + a.sphnno AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                ((SELECT          ipaddr + '/ '
                                    FROM              RTSparqAdslCmty
                                    WHERE          cutyid = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.MOBILE, a.HOME, '01' AS CUSTSRC, A.SPEED
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                ((SELECT          lineip + '/ '
                                    FROM              RTEbtCmtyLine
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.MOBILE, a.CONTACTTEL, '01' AS CUSTSRC, '' AS SPEED
...
SELECT          a.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.codenc AS comtypenc, k.CONT AS belongnc, l.NAME AS salesnc, 
                            ...
                            replace(a.ip11, '...', '') AS CUSTIP, g.codenc AS CASEKIND, 
                            ...
                            '') AS secondcase, '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ((SELECT          LINEIP + '/ '
                                    FROM              RTLessorAVSCmtyLine
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH('')), len
                                ((SELECT          LINEIP + '/ '
                                    FROM              RTLessorAVSCmtyLine
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.MOBILE, a.CONTACTTEL, isnull(A.CUSTSRC, '01') as CUSTSRC, A.USERRATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            LEFT
                                ...
                                ((SELECT          lineip + '/ '
                                    FROM              RTLessorCmtyLine
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.MOBILE, a.CONTACTTEL, '01' AS CUSTSRC, A.USERRATE
...
SELECT          c.comtype, A.COMQ1, A.LINEQ1, A.CUSID, c.comtypenc, c.belongnc, c.salesnc, c.comq, d .comn, b.linetel AS LINETEL, 
                            ...
                            '' AS nciccusno, '' AS Sp499cons, NULL AS WtlApplyDat, LEFT
                                ...
                                ((SELECT          lineip + '/ '
                                    FROM              RTPrjCmtyLine
                                    WHERE          COMQ1 = a.COMQ1 FOR XML PATH(''))) - 1) AS PP, a.CONTACTTEL, a.CONTACTTEL, '01' AS CUSTSRC, '' AS SPEED
