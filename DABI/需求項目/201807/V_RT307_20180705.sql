...
SELECT          B.CODENC, A.paytype, A.belongnc, A.qty, A.unino, A.invtitle, A.COMN, A.CUSNC, A.raddr, A.CONTACTTEL, 
                            ...
                            A.setnc, A.setmoney, A.gtnc, A.GTMONEY, A.returnnc, A.returnmoney, A.gtserial, A.CUSID, A.PRTNO, 
                            A.CREDITCARDNO
FROM              (SELECT          '02' AS paytype, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS belongnc, 1 AS qty, SPACE(60) AS unino, 
                                                        ...
                                                        0 AS setmoney, '保證金' AS gtnc, b.GTMONEY, '' AS returnnc, 0 AS returnmoney, '' AS gtserial, b.CUSID, 
                                                        b.CUSID + '-1' AS PRTNO, '' AS CREDITCARDNO
                            ...
                            SELECT          a.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, '' AS Expr3, '' AS Expr4, 
                                                        ...
                                                        a.CUSID, a.CUSID + '_' + CAST(a.ENTRYNO AS VARCHAR(2)) AS PRTNO, a.CREDITCARDNO
                            ...
                            SELECT          b.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, '' AS Expr3, '' AS Expr4, 
                                                        ...
                                                        b.GTMONEY, '' AS Expr13, 0 AS Expr14, '' AS Expr15, a.CUSID, a.PRTNO, i.COD2
                            ...
                            SELECT          a.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, '' AS Expr3, '' AS Expr4, 
                                                        ...
                                                        0 AS Expr13, '' AS Expr14, 0 AS Expr15, '' AS Expr16, a.CUSID, 
                                                        a.CUSID + '_' + CAST(a.ENTRYNO AS VARCHAR(2)) AS ENTRYNO, a.CREDITCARDNO
                            ...
                            SELECT          a.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, '' AS Expr3, '' AS Expr4, 
                                                        ...
                                                        '' AS Expr15, 0 AS Expr16, '' AS Expr17, a.CUSID, a.CUSID + '_' + CAST(a.ENTRYNO AS VARCHAR(2)) 
                                                        AS ENTRYNO, a.CREDITCARDNO
                            ...
                            SELECT          a.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, '' AS Expr3, '' AS Expr4, 
                                                        ...
                                                        a.CUSID, a.CUSID + '_' + CAST(a.ENTRYNO AS VARCHAR(2)) AS ENTRYNO, a.CREDITCARDNO
                            ...
                            WHERE          (b.CANCELDAT IS NULL) AND (a.CANCELDAT IS NULL)
                            UNION ALL
                            SELECT          b.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, b.UNINO AS Expr3, 
                                                        b.INVTITLE AS Expr4, d.COMN, b.CUSNC, ISNULL(h.CUTNC, '') + b.TOWNSHIP3 + b.RADDR3 AS Expr5, 
                                                        CASE b.mobile WHEN '' THEN b.contacttel ELSE b.mobile END AS Expr6, b.DOCKETDAT, 
                            ...
                            WHERE          (b.CANCELDAT IS NULL) AND (a.DROPDAT IS NULL)
                            UNION ALL
                            SELECT          a.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, b.UNINO, b.INVTITLE, 
                                                        d.COMN, b.CUSNC, ISNULL(h.CUTNC, '') + b.TOWNSHIP3 + b.RADDR3 AS Expr5, 
                                                        CASE b.mobile WHEN '' THEN b.contacttel ELSE b.mobile END AS Expr6, b.DOCKETDAT, 
                            ...
                            WHERE          (b.CANCELDAT IS NULL) AND (a.CANCELDAT IS NULL)
                            UNION ALL
                            SELECT          a.PAYTYPE, ISNULL(e.SHORTNC, ISNULL(g.CUSNC, '')) AS Expr1, 1 AS Expr2, b.UNINO AS Expr3, 
                                                        b.INVTITLE AS Expr4, d.COMN, b.CUSNC, ISNULL(h.CUTNC, '') + b.TOWNSHIP3 + b.RADDR3 AS Expr5, 
                                                        CASE b.mobile WHEN '' THEN b.contacttel ELSE b.mobile END AS Expr6, b.DOCKETDAT, 
