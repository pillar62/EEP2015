...
<% '程式: DM單筆列印
 ...
 ' Response.Write "sql=" & sqlstring1 & sqlstring2   
...
FROM_String_upd = "FROM RTCustADSL LEFT OUTER JOIN RTCounty ON RTCustADSL.CUTID2 = RTCounty.CUTID " &_
              "INNER JOIN RT365ACCOUNT ON RTCustADSL.CUSID = RT365ACCOUNT.CUSID AND RTCustADSL.ENTRYNO = RT365ACCOUNT.ENTRYNO " &_
              "LEFT OUTER JOIN RTObj ON RTCustADSL.CUSID = RTObj.CUSID "
...
' 更新列印日期及產生列印批號
  ...
  conn.Open DSN
   ...
   rsc.close
   set rsc=nothing     
  UpdSql=from_string_upd & sqlstring1
'Response.Write "Update rt365account set prtdat = getdate(), prtno='" & newprtno & "' " & updsql
