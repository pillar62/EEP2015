...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT CUSID, ENTRYNO,STOCKID,BRANCH,BUSSMAN,BUSSID,SEX,BIRTHDAY, " _
             ...
             &"SETFEEDESC,orderno,ss365,REPLYDATE,Lookdat,formaldat,deliverdat,socialid,agree,haveroom,homestat,LOOKDESC,CHTSIGNDAT,SENDWORKING,WORKINGREPLY " _
...
<table width="100%" ><tr><td width="100%">&nbsp;</td></tr>                                                      
    ...
    <tr>
        ...
        <td width="30%" colspan="5" height="25" bgcolor="silver"> 
...
<%  Call SrGetCountyTownShip(accessMode,sw,Len(Trim(FIELDROLE(1) &dataProtect)),dspkey(8),dspkey(9),s,t)%>
         <select size="1" name="key8"<%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> size="1" 
                onChange="SrRenew()" class="dataListEntry"><%=s%></select>
         <select name="key9" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> size="1" class=dataListEntry><%=t%></select>   
      ...
      <tr>                                 
        ...
        <td width="60%" colspan="3" height="25" bgcolor="silver">
<%  Call SrGetCountyTownShip(accessMode,sw,Len(Trim(FIELDROLE(1) &dataProtect)),dspkey(12),dspkey(13),s,t)%>
        <select name="key12" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> size="1" 
                onChange="SrRenew()"
               style="text-align:left;" maxlength="8" class="dataListEntry"><%=s%></select>
        <select name="key13" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> size="1"    
...
<input type="text" name="key14" size="41" value="<%=dspkey(14)%>" maxlength="60" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry"></td>                                 
      ...
      <tr>                                 
        ...
        <td width="60%" colspan="3" height="25" bgcolor="silver">
<%  Call SrGetCountyTownShip(accessMode,sw,Len(Trim(FIELDROLE(1) &dataProtect)),dspkey(16),dspkey(17),s,t)%>
        <select name="key16" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> size="1" 
                onChange="SrRenew()"
               style="text-align:left;" maxlength="8" class="dataListEntry"><%=s%></select>
        <select name="key17" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> size="1"    
               style="text-align:left;" maxlength="8" class="dataListEntry"><%=t%></select>   
