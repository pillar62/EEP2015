...
Sub SrEnvironment()
  ...
  title="調撥單明細資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT transno,prodno,itemno,transqty,price,amt,cost,CAMT,transdesc,CHECKQTY " _
             &"FROM RTStockTNSD1 WHERE TRANSno='*' "
  sqlList="SELECT TRANSno,prodno,itemno,TRANSqty,price,amt,cost,CAMT,TRANSdesc,CHECKQTY " _
             &"FROM RTStockTNSD1 WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="10%" class=dataListHead>調撥單號</td><td width="10%" bgcolor=silver>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">調撥數量</font></td>
  ...
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">調撥原因</font></td>
    <td width="35%" COLSPAN=3 bgcolor="#C0C0C0">
    <input class=dataListEntry name="key8" maxlength=70 size=70    
            style="TEXT-ALIGN: left" value="<%=dspkey(8)%>"  ID="Text2">　</td>
  </tr>  
</table>
<% conn.close
   set rs=nothing
