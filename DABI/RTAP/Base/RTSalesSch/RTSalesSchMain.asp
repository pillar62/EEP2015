...
<table border="0" width="100%">
  ...
  <tr>
    <td width="20%">　</td>
    <td width="60%" align="middle"><font color="#0000ff">工程師行程維護</font></td>
...
<TABLE style="WIDTH: 300px; HEIGHT: 75px" cellSpacing=0 cellPadding=0 bgColor=antiquewhite border=1>
  <TR>
    <TD style="WIDTH: 25%"  bgColor=#3e7373>
      <P style="COLOR: yellow;font-size:16pt" align=center><FONT size=3>工程師行程</FONT></P></TD></TR>
  <TR>
    <TD onclick="newurl(1)" >
        <FONT style="COLOR: darkorchid;font-size:12pt">
        <INPUT type="BUTTON" style="WIDTH: 100%;height:30;font-size:12pt"  VALUE="工程師行程維護" ID="B1" NAME="B1">
        </FONT></TD>
  </TR>
  <tr><td> &nbsp; </td></tr>  
