...
Sub SrEnvironment()
  ...
  title="進貨單明細資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT stockno,prodno,itemno,stockqty,price,amt,cost,CAMT,warehouse,stockdesc " _
             &"FROM RTStockGoodsD1 WHERE stockno='*' "
  sqlList="SELECT stockno,prodno,itemno,stockqty,price,amt,cost,CAMT,warehouse,stockdesc " _
             &"FROM RTStockGoodsD1 WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="10%" class=dataListHead>進貨單號</td><td width="10%" bgcolor=silver>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">進貨數量</font></td>
  ...
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">備註</font></td>
    <td width="35%" COLSPAN=3 bgcolor="#C0C0C0">
