              ...
              '   On Error Resume Next
                      if i=0 then  
                         ...
                         if len(rsc("caseno")) > 0 then
                            dspkey(i)="S" & yymmdd & right("000" & cstr(cint(mid(rsc("caseno"),8,3)) + 1),3)
                         else
                            dspkey(i)="S" & yymmdd & "001"
                         end if                                                             
                      end if
...
Sub SrEnvironment()
  ...
  title="進貨單資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT STOCKNO,STOCKDAT,FACTORY,CHECKUSR,EUSR,EDAT,UUSR,UDAT,CHECKDEPT,DROPUSR,DROPDAT " _
             &"FROM RTSTOCKGOODSH WHERE STOCKNO='*' "
  sqlList="SELECT STOCKNO,STOCKDAT,FACTORY,CHECKUSR,EUSR,EDAT,UUSR,UDAT,CHECKDEPT,DROPUSR,DROPDAT " _
             &"FROM RTSTOCKGOODSH WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="21%" class=dataListHead>進貨單號</td><td width="79%" READONLY bgcolor=silver>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">進貨日期</font></td>
    ...
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">進貨廠商</font></td>
    <td width="35%" bgcolor="#C0C0C0">
 <% If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) AND (LEN(TRIM(DSPKEY(9)))=0 AND LEN(TRIM(DSPKEY(10))) = 0) Then 
  ...
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">驗收單位</font></td>
    <td width="35%" bgcolor="#C0C0C0">
  <%s=""
    sx=" selected " 
    If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) AND (LEN(TRIM(DSPKEY(9)))=0 AND LEN(TRIM(DSPKEY(10))) = 0) Then 
