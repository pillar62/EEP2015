...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       ...
       WINDOW.Form2.action="/REPORT/RTFaq/RTFaqSndWrkP.asp?parm=" & document.all("key1").value & ";" & document.all("key2").value & ";" & document.all("key3").value
...
<form name=frm1 method=post action="RTFaqSndWrkPV.asp" ID="Form1">
