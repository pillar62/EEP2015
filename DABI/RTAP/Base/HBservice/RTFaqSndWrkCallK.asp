...
Sub SrEnvironment()
	...
	End IF
	DSN="DSN=RTLib"
	formatName="調查單號;派工單號;電訪日期;電訪人員;電訪客戶;作廢日"
	sqlDelete=	"select	a.callno, a.workno, a.calldat, c.cusnc, a.callcust, canceldat " &_
				"from RTSndWorkCall a " &_
				"left outer join RTEmployee b inner join RTObj c on c.cusid = b.cusid on b.emply = a.callusr " &_
				"where a.callno='' "
	dataTable="RTSndWorkCall"
	userDefineDelete="Yes"
	numberOfKey=1
	dataProg="RTFaqSndWrkCallD.asp"
	datawindowFeature=""
	...
	sqlList="select	a.callno, a.workno, a.calldat, c.cusnc, a.callcust, canceldat " &_
			"from RTSndWorkCall a " &_
			"left outer join RTEmployee b inner join RTObj c on c.cusid = b.cusid on b.emply = a.callusr " &_
			"where a.workno='" & aryparmkey(0) & "' "
