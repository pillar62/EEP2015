...
Sub SrEnvironment()
  ...
  title="業務管理專案設定作業"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT  SCITEM, SCNAME, SCDESC, ENDCODE FROM HBSalesManageProject WHERE SCITEM='*' "
  sqlList="SELECT  SCITEM, SCNAME, SCDESC, ENDCODE FROM HBSalesManageProject WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       ...
       <td width="80%" bgcolor=silver>
           <input class=dataListEntry type="text" name="key0" <%=keyprotect%> size="2" 
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td  WIDTH=15% bgcolor="#008080"><font color="#FFFFFF">專案名稱</font></td>
    <td  WIDTH=85% bgcolor="#C0C0C0" >
     <input <%=xxclass%> name="KEY1" <%=dataprotect%> maxlength=20 size=20 style="TEXT-ALIGN: left" value
            ="<%=DSPKEY(1)%>"></td>
  </tr>
  <tr>
    <td bgcolor="#008080"><font color="#FFFFFF">專案目的</font></td>
    <td  bgcolor="#C0C0C0">
     <TEXTAREA cols="70%" name="key2" rows=4  <%=XXclass%>  <%=dataprotect%>  value="<%=dspkey(2)%>" ID="Textarea1"><%=dspkey(2)%></TEXTAREA></td>
  </tr>
  <tr>
    <td  bgcolor="#008080"><font color="#FFFFFF">終止</font></td>
    <td  bgcolor="#C0C0C0" >
    <%
    IF DSPKEY(3)="Y" THEN
       SELX=" SELECTED "
    ...
    END IF
    %>
     <select NAME="KEY3" id="KEY3" class=dataListENTRY <%=dataprotect%>>
       <option value="Y" <%=SELX%> >是</option>
       <option value="N" <%=SELY%>>否</option>
     </select>
    </td>            
  </tr>          
</table>
