...
Sub SrEnvironment()
  ...
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT  SCITEM, STAT,STATDESC FROM HBSalesManageProjectD WHERE SCITEM='*' "
  sqlList="SELECT  SCITEM, STAT,STATDESC FROM HBSalesManageProjectD WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="20%" class=dataListHead>專案代號</td>
       <td width="30%" bgcolor=silver>
           <input class=dataListDATA type="text" name="key0" <%=keyprotect%> size="2" 
           value="<%=dspKey(0)%>" maxlength="2" ></td>
        <td width="20%" class=dataListHead>回覆代號</td>
       <td width="30%" bgcolor=silver>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20%" bgcolor="#008080"><font color="#FFFFFF">回覆類別說明</font></td>
    <td width="80%" bgcolor="#C0C0C0" colspan=3>
     <input CLASS=DATALISTENTRY name="KEY2" <%=dataprotect%> maxlength=4 size=8 style="TEXT-ALIGN: left" value
            ="<%=DSPKEY(2)%>"></td>
  </tr>
</table>
<%
