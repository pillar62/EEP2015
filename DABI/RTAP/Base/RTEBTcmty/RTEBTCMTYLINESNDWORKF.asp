...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTEBTcmtylinesndwork set FINISHdat=getdate() ,CLOSEUSR='" & V(0) & "' where comq1=" & KEY(0) & " and lineq1=" & key(1)  & " and prtno='" & key(2) & "' "
   ...
   IF ENDPGM="1" AND STS="3" THEN '當需更新主線之完工日的派工種類(STS=3)返轉才須要通知相關人員
      ...
      IF STS="1" THEN
         jmail.Subject = "AVS社區︰" & COMN & "，派工單︰" & KEY(0) & "-" & KEY(1) & "-" & KEY(2) & "，完工結案通知"
      ELSE
         jmail.Subject = "AVS社區︰" & COMN & "，派工單︰" & KEY(0) & "-" & KEY(1) & "-" & KEY(2) & "，未完工結案通知"
      END IF
      
      jmail.priority = 1  
      body="<html><body><table border=0 width=""60%""><tr><td colspan=2>" _
      &"<H3>東森AVS主線派工結案通知</h3></td></tr>" _
      ...
      &"</table>" _
      &"<P><U>此主線已完工結案，可執行用戶申請作業</U></body></html>"  
      jmail.HTMLBody = BODY
