...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;主線;竣工單號;派工日期;列印人員;預定施工員;實際施工員;獎金結算月;獎金審核日;庫存結算月;庫存審核日;作廢日"
  sqlDelete="SELECT RTEBTCUSTSNDWORK.COMQ1, RTEBTCUSTSNDWORK.LINEQ1, RTEBTCUSTSNDWORK.CUSID, RTEBTCUSTSNDWORK.PRTNO,rtrim(convert(char(6),RTEBTCUSTSNDWORK.COMQ1)) +'-'+ rtrim(convert(char(6),RTEBTCUSTSNDWORK.lineQ1))  as comqline, RTEBTCUSTSNDWORK.PRTNO, RTEBTCUSTSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_2.CUSNC END, " _
           &"RTEBTCUSTSNDWORK.BONUSCLOSEYM, RTEBTCUSTSNDWORK.BONUSFINCHK, RTEBTCUSTSNDWORK.STOCKCLOSEYM, RTEBTCUSTSNDWORK.STOCKFINCHK, " _
