...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTEBTCMTYlinesndwork set dropdat=getdate(),dropdesc='主線派工單作廢' where comq1=" & KEY(0) & " and lineq1=" & key(1) & " and prtno='" & key(2) & "' "
   ...
   IF ENDPGM="1" THEN
      ...
      jmail.Subject = "AVS派工單︰" & KEY(0) & "-" & KEY(1) & "-" & KEY(2) & "，作廢通知"
      jmail.priority = 1  
      body="<html><body><table border=0 width=""100%""><tr><td colspan=2>" _
      &"<H3>東森AVS主線派工單作廢通知</h3></td></tr>" _
