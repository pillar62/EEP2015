...
Sub SrEnvironment()
  ...
  functionOptName="拆機工單"
  functionOptProgram="rtebtcustdropsndworkk2.asp"
  functionOptPrompt="N"
  If V(1)="Y" then
     accessMode="U"
  Else
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTEBTCUSTDROP.ComQ1<>0 and RTEBTCUSTDROP.FINISHCHKDAT is null and RTEBTCUSTDROPsndwork.closedat is null "
