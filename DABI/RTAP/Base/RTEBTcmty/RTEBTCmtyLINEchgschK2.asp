...
Sub SrEnvironment()
  ...
  functionOptName="異動派工;歷史異動"
  functionOptProgram="rtEBTcmtylineCHGsndworkk.asp;rtEBTcmtylineCHGLOGK.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTEBTCMTYLINECHG.FINISHDAT IS NULL AND RTEBTCMTYLINECHG.CHGCOD3=1 "
     searchShow="全部待派工主線(移機異動)，不含頻寬異動"
  ELSE
     SEARCHFIRST=FALSE
  End If
