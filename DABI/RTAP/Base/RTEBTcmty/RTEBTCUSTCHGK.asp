...
Sub SrEnvironment()
  ...
  functionOptName="移機工單; 作 廢 ;作廢返轉;異動查詢"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;項次;異動申請日;報竣異動項目;作廢日;作廢人員;異動申請確認日;異動申請轉檔日;轉檔序號;異動完工日;完工回報確認日;完工回報轉檔日;作廢日"
  sqlDelete="SELECT       RTEBTCUSTCHG.COMQ1, RTEBTCUSTCHG.LINEQ1, " _
                       &"   RTEBTCUSTCHG.CUSID, RTEBTCUSTCHG.ENTRYNO, " _
                       &" RTEBTCUSTCHG.APPLYDAT,CASE WHEN RTEBTCUSTCHG.CHGCOD1 = 1 THEN '變更用戶資料' ELSE '' END +  " _
                       &"CASE WHEN RTEBTCUSTCHG.CHGCOD2 = 1 THEN '／移機' ELSE '' END + " _
                       &"CASE WHEN RTEBTCUSTCHG.CHGCOD3 = 1 THEN '／換號' ELSE '' END + " _
                       &"CASE WHEN RTEBTCUSTCHG.CHGCOD4 = 1 THEN '／其它' ELSE '' END, " _
