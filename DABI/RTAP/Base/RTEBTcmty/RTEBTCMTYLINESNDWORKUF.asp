 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      sqlyy="insert into RTEBTCMTYLINEsndworklog " _ 
           &"SELECT   COMQ1, LINEQ1, PRTNO, " & ENTRYNO & ", GETDATE() ,'UF','" & V(0) & "',SENDWORKDAT, PRTUSR, ASSIGNENGINEER1, ASSIGNENGINEER2, " _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTEBTcmtylinesndwork set UNCLOSEdat=getdate() ,CLOSEUSR='" & V(0) & "' where comq1=" & KEY(0) & " and lineq1=" & key(1)  & " and prtno='" & key(2) & "' "
