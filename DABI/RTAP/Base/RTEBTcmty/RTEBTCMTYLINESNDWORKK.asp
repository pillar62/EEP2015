...
Sub SrEnvironment()
  ...
  functionOptProgram="\RTAP\BASE\RTEBTCMTY\RTEBTCMTYLINESNDWORKPV.asp;rtebtcmtylinesndworkF.asp;rtebtcmtylinesndworkUF.asp;rtebtcmtylinesndworkFR.asp;rtebtcmtylinesndworkdrop.asp;rtebtcmtylinesndworkdropc.asp;rtEBTcmtyhardwareK.asp;rtEBTcmtylinesndworkLOGK.asp"
  ...
  sqlDelete="SELECT RTEBTCMTYLINESNDWORK.COMQ1, RTEBTCMTYLINESNDWORK.LINEQ1, RTEBTCMTYLINESNDWORK.PRTNO,rtrim(convert(char(6),RTEBTCMTYLINESNDWORK.COMQ1)) +'-'+ rtrim(convert(char(6),RTEBTCMTYLINESNDWORK.lineQ1))  as comqline, RTEBTCMTYLINESNDWORK.PRTNO, " _
           ...
           &"RTEBTCMTYLINESNDWORK.FINISHDAT,RTEBTCMTYLINESNDWORK.UNCLOSEDAT,RTEBTCMTYLINESNDWORK.DROPDAT,RTEBTCMTYLINESNDWORK.BONUSCLOSEYM, RTEBTCMTYLINESNDWORK.BONUSFINCHK, RTEBTCMTYLINESNDWORK.STOCKCLOSEYM, " _
