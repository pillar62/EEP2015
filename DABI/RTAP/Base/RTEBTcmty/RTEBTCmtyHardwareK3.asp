...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;主線;<center>派工單號</center>;<center>項次</center>;<center>設備名稱/規格</center>;<center>數量</center>;<center>出庫別</center>;<center>資產編號</center>;<center>作廢日期</center>;<center>作廢原因</center>;<center>作廢人員</center>"
  ...
  If searchQry="" Then
     ...
     searchShow="社區序號︰"& aryparmkey(0) & ",社區名稱︰" & COMN 
  ELSE
     SEARCHFIRST=FALSE
  End If  
  searchProg="self"
