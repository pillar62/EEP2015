          ...
          For i = 0 To numberOfField-1
              ...
              '   On Error Resume Next
                ...
                select case ucase(runpgm)   
                   ...
                   case ucase("/webap/rtap/base/rtEBTcmty/RTEBTCUSTM2M3SNDWORKd.asp")
                       ...
                       if i=3 then
                         ...
                         rsc.open "select max(PRTNO) AS PRTNO from RTEBTCUSTM2M3SNDWORK where PRTNO like '" & cusidxx & "%' " ,conn
...
Sub SrEnvironment()
  ...
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT AVSNO,M2M3,seq, PRTNO, SENDWORKDAT, PRTUSR, ASSIGNENGINEER," _
             ...
             &"FROM RTEBTCUSTM2M3SNDWORK WHERE AVSNO='' "
  sqlList="SELECT AVSNO,M2M3,seq, PRTNO, SENDWORKDAT, PRTUSR, ASSIGNENGINEER, " _
             &"ASSIGNCONSIGNEE, REALENGINEER, REALCONSIGNEE,  " _
             &"DROPDAT, DROPDESC, CLOSEDAT, BONUSCLOSEYM, BONUSCLOSEDAT, BONUSCLOSEUSR, BONUSFINCHK, STOCKCLOSEYM, STOCKCLOSEDAT, " _
             &" STOCKCLOSEUSR, STOCKFINCHK, MDF1,MDF2,HOSTNO,HOSTPORT, MEMO,PRTDAT,UNCLOSEDAT,DROPUSR,CLOSEUSR,eusr,edat,uusr,udat " _
             &"FROM RTEBTCUSTM2M3SNDWORK WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  extDBField=1
...
Sub SrCheckData(message,formValid)
    '新增拆機工單時，要先檢查系統是否已有拆機工單
    errcode=""    
    IF ACCESSMODE="A" THEN
       Set connXX=Server.CreateObject("ADODB.Connection")
       Set rsXX=Server.CreateObject("ADODB.Recordset")
       connXX.open DSN
       SQLXX="SELECT COUNT(*) as cnt FROM RTEBTCUSTM2M3SNDWORK WHERE AVSNO='" & DSPKEY(0) & "' AND M2M3='" & DSPKEY(1) & "' and seq=" & dspkey(2) & " AND DROPDAT IS NULL "
...
Sub SrGetUserDefineKey()%>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0 ID="Table2">
       <tr><td width="12%" class=dataListHead>AVS合約編號</td>
           ...
           <td width="15%" class=dataListHead>拆機單號</td>
