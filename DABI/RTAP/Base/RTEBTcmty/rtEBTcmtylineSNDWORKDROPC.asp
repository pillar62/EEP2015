...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTEBTCMTYlinesndwork set dropdat=null,dropdesc='主線派工單作廢返轉' where comq1=" & KEY(0) & " and lineq1=" & key(1) & " and prtno='" & key(2) & "' "
   ...
   END IF
   IF ENDPGM="1" THEN
      TOemail="edson@cbbn.com.tw;maybe0606@CBBN.COM.TW"
      FROMEMAIL="MIS@CBBN.COM.TW"
      Set jmail = Server.CreateObject("Jmail.Message")
      jmail.charset="BIG5"
      jmail.from = "MIS@cbbn.com.tw"
      jmail.Subject = "東森AVS主線派工單︰" & KEY(0) & "-" & KEY(1) & "-" & KEY(2) & "，作廢返轉通知"
      jmail.priority = 1  
      body="<html><body><table border=0 width=""100%""><tr><td colspan=2>" _
      &"<H3>東森AVS主線派工單作廢返轉通知</h3></td></tr>" _
