...
Sub SrEnvironment()
  ...
  system="東森AVS管理系統"
  title="東森AVS用戶已報竣無合約生效日查詢"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable="N;N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="繳款記錄;歷史異動"
  functionOptProgram="rtEBTCUSTPAYK.asp;rtEBTCUSTLOGK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;主線;主線名稱;用戶;AVS合約號;none;裝機地址;連絡電話;none;申請日;none;none;完工日;報竣日;轉檔日;合約生效日;退租日;移入;移出"
 ...
 ' if userlevel=31 or userlevel =1  or userlevel =5 then DAreaID="<>'*'"
  ...
  '  Else
         sqlList="SELECT RTEBTCUST.COMQ1, RTEBTCUST.LINEQ1,RTEBTCUST.CUSID,rtrim(ltrim(convert(char(6),RTEBTCUST.COMQ1))) +'-'+ rtrim(ltrim(convert(char(6),RTEBTCUST.lineQ1))) as comqline,rtebtcmtyh.comn,LEFT(RTEBTCUST.CUSnc,4),  right(RTEBTCUST.AVSNO,11),RTCODE_3.CODENC,  " _
           ...
           &"LEFT OUTER JOIN RTCODE RTCODE_3 ON RTEBTCUST.CASETYPE = RTCODE_3.CODE AND RTCODE_3.KIND='H5' " _
           &"where " & searchqry & " AND RTAREATOWNSHIP.AREAID " & DAREAID & " and rtebtcust.DOCKETdat is not null and rtebtcust.STRBILLINGDAT is null " _
