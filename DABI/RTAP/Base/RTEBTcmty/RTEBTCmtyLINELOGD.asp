...
<tr><td class=dataListHEAD>ADSL裝機地址</td>
  ...
  <%s=""
   ...
   %>
        ...
        <input type="text" name="key15" readonly  size="8" value="<%=dspkey(15)%>" maxlength="10" readonly <%=fieldpA%><%=fieldpB%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListDATA" ID="Text4"><font size=2>(鄉鎮)                 
...
<%if DSPKEY(37)="" THEN DSPKEY(37)="信義區" %>        
        <input type="text" name="key37" size="8" value="<%=dspkey(37)%>" maxlength="10"  readonly <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListDATA" ID="Text10"><font size=2>(鄉鎮)                 
         <input type="button" id="B37"  <%=FIELDPC%>  <%=FIELDPF%>   name="B37"   width="100%" style="Z-INDEX: 1"  value="..." <%=SXX37%>  >        
          <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF"  <%=FIELDPC%>  <%=FIELDPF%>  alt="清除" id="C37"  name="C37"   style="Z-INDEX: 1" <%=fieldpe%>  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" >          
...
<%  dim sexd1, sexd2
    ...
    If dspKey(55)="02" Then sexd2=" checked " %>            
        <input type="RADIO" <%=sexd1%> name="key55" size="1" value="01"    <%=fieldpa%><%=fieldRole(1)%> class="dataListEntry" ID="Text2">週一~週五
...
<%  If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) And protect<1  AND len(trim(dspKey(59))) = 0  Then 
    ...
    <input type="text" name="key4" <%=fieldRole(1)%><%=dataProtect%> 
         ...
         <input type="button" id="B4"  <%=FIELDPC%>  <%=FIELDPF%>   name="B4"   width="100%" style="Z-INDEX: 1"  value="...." readonly onclick="SrsalesGrouponclick()"  >  
          <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF"  <%=FIELDPC%>  <%=FIELDPF%>  alt="清除" id="C4"  name="C4"   style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut"  onclick="SrClear">                               
         <%name="" 
           if dspkey(5) <> "" then
        ...
        <input type="TEXT" name="key5" <%=fieldRole(1)%><%=dataProtect%> 
           ...
           <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF"  <%=FIELDPC%> alt="清除" id="C5"  name="C5"   style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut"  onclick="SrClear">
...
<%  dim sexd5, sexd6
    ...
    <tr>
        ...
        <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF"  <%=FIELDPC%>  <%=FIELDPF%>  alt="清除" id="C57"  name="C57"   style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"> </td>          
        ...
        <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF"  <%=FIELDPD%>   <%=FIELDPF%> alt="清除" id="C84"  name="C84"   style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"> </td>          
   ...
   <select size="1" name="key85" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry" ID="Select15">                                                                  
        ...
        <td  class="dataListSEARCH" height="23">CHT預定施工日</td>                                 
        <td  height="23" bgcolor="silver">
     ...
     <tr>
        ...
        <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF"  <%=FIELDPD%>  <%=FIELDPF%>  alt="清除" id="C64"  name="C64"   style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"> </td>          
      </tr>     
      </tr>       
        <tr>
