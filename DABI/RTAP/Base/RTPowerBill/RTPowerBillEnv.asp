...
Session("oRpt").ParameterFields.GetItemByName("@belong").AddCurrentValue(CStr(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@consignee").AddCurrentValue(CStr(v(1)))
