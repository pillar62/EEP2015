...
<%
  ...
  v=split(parm,";")
  if v(1) = "1" then
     reportname = "ADSLReport18a.rpt"
  elseif v(1) = "2" then    
     reportname = "ADSLReport18b.rpt"
  end if
...
Session("oRpt").ParameterFields.GetItemByName("@typ").AddCurrentValue(CStr(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@break").AddCurrentValue(CStr(v(1)))
