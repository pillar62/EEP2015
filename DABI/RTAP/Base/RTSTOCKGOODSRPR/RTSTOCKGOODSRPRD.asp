              ...
              '   On Error Resume Next
                      if i=0 then  
                         ...
                         if len(rsc("caseno")) > 0 then
                            dspkey(i)="M" & yymmdd & right("000" & cstr(cint(mid(rsc("caseno"),8,3)) + 1),3)
                         else
                            dspkey(i)="M" & yymmdd & "001"
                         end if                                                             
                      end if
...
Sub SrEnvironment()
  ...
  title="送修單資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT REPAIRNO,REPAIRDAT,FACTORY,CHECKUSR,EUSR,EDAT,UUSR,UDAT,CHECKDEPT,DROPUSR,DROPDAT " _
             &"FROM RTSTOCKREPAIRH WHERE REPAIRNO='*' "
  sqlList="SELECT REPAIRNO,REPAIRDAT,FACTORY,CHECKUSR,EUSR,EDAT,UUSR,UDAT,CHECKDEPT,DROPUSR,DROPDAT " _
             &"FROM RTSTOCKREPAIRH WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="21%" class=dataListHead>送修單號</td><td width="79%" READONLY bgcolor=silver>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">送修日期</font></td>
    ...
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">送修廠商</font></td>
    <td width="35%" bgcolor="#C0C0C0">
 <% If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) AND (LEN(TRIM(DSPKEY(9)))=0 AND LEN(TRIM(DSPKEY(10))) = 0) Then 
  ...
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">送修單位</font></td>
    <td width="35%" bgcolor="#C0C0C0">
  <%s=""
    sx=" selected " 
    If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) AND (LEN(TRIM(DSPKEY(9)))=0 AND LEN(TRIM(DSPKEY(10))) = 0) Then 
    ...
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">送修人員</font></td>
    <td width="35%" bgcolor="#C0C0C0">
