...
Sub SrEnvironment()
  ...
  functionOptProgram="RTFareastCustRepairTRNAR.asp;RTFareastCustRepairTRNFR.asp;RTFareastCustARK2.asp;RTFareastCustRepairDROP.asp;RTFareastCustRepairDROPC.asp"
  ...
  sqlDelete="SELECT  a.CUSID, a.ENTRYNO, c.CUSNC, a.ENTRYNO, a.APPLYDAT, b.CODENC, a.SETAMT, a.MOVEAMT, " &_
			...
			"FROM    RTFareastCustRepair a " &_
					"LEFT OUTER JOIN RTCode b ON a.PAYTYPE = b.CODE AND b.KIND = 'M9' " &_
					"LEFT OUTER JOIN RTFareastCust c ON a.CUSID = c.CUSID " &_
			"WHERE	a.cusid='' "

  dataTable="RTFareastCustRepair"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTFareastCustRepairD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTFareastCustRepairS.asp"
  '========================================================================================================
