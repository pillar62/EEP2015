...
Sub SrCheckData(message,formValid)
  ...
  '客戶檔已作廢則不可建立派工單
   ...
   connxx.open DSN
   sqlxx="select canceldat from RTfareastCust where comq1 =" & aryparmkey(1) & " and lineq1 =" & aryparmkey(2)& " and cusid = '" & aryparmkey(3) &"' "
...
<%
	sql="select isnull(d.shortnc, f.cusnc) as belongnc, c.comn, g.cutnc+a.township+a.raddr as addr, a.linetel, a.lineip, " &_
		...
		"inner join RTfareastCust k on k.comq1 = a.comq1 and k.lineq1 = a.lineq1 " &_
