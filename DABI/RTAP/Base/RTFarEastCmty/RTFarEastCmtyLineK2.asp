...
Sub SrEnvironment()
  ...
  functionOptProgram="RTfareastCmtyLineMrtg.asp;RTfareastCmtyLineTool.asp;RTfareastCustK2.asp;RTfareastCmtyLineSndWrkK.asp;RTfareastCmtyLineCancel.asp;RTfareastCmtyLineCancelRtn.asp"
  ...
  sqlDelete="select i_smallint, i.tinyint, c_varchar, c_varchar, c_varchar, c_varchar, c_varchar,c_varchar, c_varchar, c_varchar, " &_
  			...
  			"from RTTemplate "
  dataTable="RTfareastCmtyLine"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTfareastCmtyLineD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=30
  searchProg="RTfareastCmtyLineS2.asp"
  ...
  '-------------------------------------------------------------------------------------------
    sqlList="select  a.comq1, a.lineq1, isnull(m.cusnc,''), isnull(d.shortnc, f.cusnc), c.comn, convert(varchar(6), a.comq1) +'-'+ convert(varchar(3),a.lineq1), " &_
			...
			"left outer join (select y.comq1, y.lineq1, count(*) as custnum from RTfareastCust x inner join RTfareastCmtyLine y " &_
