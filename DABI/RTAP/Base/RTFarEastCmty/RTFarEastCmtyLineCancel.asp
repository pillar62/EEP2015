...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   sqlxx="select * FROM RTfareastCMTYLINE WHERE comq1=" & KEY(0) & " and lineq1=" & key(1) 
 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      strSP="update RTfareastCmtyLine set canceldat=getdate(),cancelusr='" &V(0)& "' where comq1=" &key(0)&" and lineq1=" &key(1)
