...
Sub SrEnvironment()
	...
	functionOptProgram="/RTAP/REPORT/fareast/RTfareastCmtyLineSndWrkPV.asp;RTfareastCmtyLineSndWrkClose.asp;RTfareastCmtyLineSndWrkCloseRtn.asp;RTfareastCmtyLineSndWrkCancel.asp;RTfareastCmtyLineSndWrkCancelRtn.asp"
	...
	End IF
	DSN="DSN=RTLib"
	formatName="派工單號;none;none;派工別;主線;社區名稱;FTP資料<BR>匯入日;派工日;預定<BR>施工人;預定<BR>施工日;完工人;完工日;結案人;結案日;作廢日"
	sqlDelete="SELECT c_varchar,i_smallint,i_tinyint,c_varchar,c_varchar,c_varchar,d_datetime,d_datetime,c_varchar, " &_
			"d_datetime,c_varchar,d_datetime,c_varchar,d_datetime,d_datetime from RTTemplate"
    ...
    'else
    	dataProg="RTfareastCmtyLineSndWrkD.asp"
    'end if        	
...
'		searchShow="主線序號︰"& aryParmKey(1) &"-" & aryParmKey(2) & ",客戶代號︰" & aryParmKey(3) & ",客戶項次︰" & aryParmKey(4)
	...
	'讀取登入帳號之群組資料
	'-------------------------------------------------------------------------------------------
  	sqlList="select a.wrkno, a.comq1, a.lineq1, b.codenc, convert(varchar(6), a.comq1) +'-'+ convert(varchar(3),a.lineq1), " &_
  			"c.comn, impdat, a.sndwrkdat, isnull(f.shortnc, h.cusnc), a.assigndat, isnull(i.shortnc, k.cusnc), " &_
