...
'----------經銷商
    S11=""
    rs.Open "SELECT  a.CONSIGNEE,  CASE WHEN a.CONSIGNEE = '' THEN '直銷' ELSE RTObj.SHORTNC  END as shortnc FROM RTfareastCmtyH a LEFT OUTER JOIN RTObj ON a.CONSIGNEE = RTObj.CUSID GROUP BY  a.CONSIGNEE,  CASE WHEN a.CONSIGNEE = '' THEN '直銷' ELSE RTObj.SHORTNC  END ",CONN
...
<body>
<table width="100%">
  <tr class=dataListTitle align=center>遠傳大寬頻社區型主線資料搜尋條件</td><tr>
</table>
