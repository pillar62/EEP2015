...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlyy="select count(*) as cnt FROM RTlessorCmtylinehardware WHERE comq1=" & KEY(0) & " and lineq1=" & key(1) & " and prtno='" & key(2) & "' and dropdat is null and RCVPRTNO <> '' "
   ...
   ELSE
      ...
      strSP="usp_RTLessorCmtyLineSndworkUF " & key(0) & "," & key(1) & ",'" & key(2) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=rtlessorcmtylinesndworkUf.asp ID="Form1">
