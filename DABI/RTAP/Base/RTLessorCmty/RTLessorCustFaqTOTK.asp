...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustFaqTRNSndwork.ASP;RTLessorCustFaqSndworkK.asp;RTLessorCustFaqCfmCallback.asp;RTLessorCustFaqCancelCallback.asp;RTLessorCustFaqF.asp;RTLessorCustFaqFR.asp;RTLessorCustFaqDrop.asp;RTLessorCustFaqDropC.asp;RTLessorCustFaqLogK.asp"
  ...
  sqlDelete="SELECT  RTLessorCustFaqH.CUSID, RTLessorCustFaqH.FAQNO,RTLessorCmtyh.comn,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1)),rtlessorcust.cusnc, RTLessorCustFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorCustFaqH.MEMO, 12) AS Expr6, RTLessorCustFaqH.CONTACTTEL, RTLessorCustFaqH.MOBILE,  " _
                      &"  RTLessorCustFaqH.EMAIL,  " _
                      &"  RTLessorCustFaqH.SNDWORK, RTObj_4.CUSNC,  " _
                      &"  RTLessorCustFaqH.SNDPRTNO, RTLessorCustFaqH.PRTDAT, RTLessorCustFaqH.SNDCLOSEDAT,  " _
                      &"  RTLessorCustFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                      &"  RTLessorCustFaqH.FINISHDAT, RTObj_6.CUSNC AS Expr2,  " _
                      &"  RTLessorCustFaqH.CANCELDAT, RTObj_1.CUSNC AS Expr3,  " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTLessorCustFaqH ON  " _
                      &"  RTEmployee_5.EMPLY = RTLessorCustFaqH.CALLBACKUSR LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_4 INNER JOIN " _
                      &"  RTObj RTObj_4 ON RTEmployee_4.CUSID = RTObj_4.CUSID ON  " _ 
                      &"  RTLessorCustFaqH.SNDUSR = RTEmployee_4.EMPLY LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_3 INNER JOIN " _
                      &"  RTObj RTObj_3 ON RTEmployee_3.CUSID = RTObj_3.CUSID ON  " _
                      &"  RTLessorCustFaqH.UUSR = RTEmployee_3.EMPLY LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_2 INNER JOIN " _
                      &"  RTObj RTObj_2 ON RTEmployee_2.CUSID = RTObj_2.CUSID ON  " _
                      &"  RTLessorCustFaqH.EUSR = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_1 INNER JOIN " _
                      &"  RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON  " _
                      &"  RTLessorCustFaqH.CANCELUSR = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
                      &"  RTObj RTObj_6 INNER JOIN " _
                      &"  RTEmployee RTEmployee_6 ON RTObj_6.CUSID = RTEmployee_6.CUSID ON  " _
                      &"  RTLessorCustFaqH.FUSR = RTEmployee_6.EMPLY LEFT OUTER JOIN " _
                      &"  RTCode ON RTLessorCustFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorCustFaqH.cusid='' "
  dataTable="RTLessorCustFaqH"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorCustFaqD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustFaqtots.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustFaqH.cusid<>'' and  RTLessorCustFaqH.canceldat is null and RTLessorCustFaqH.finishdat is null "
     searchShow="全部未結案客服單" 
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCustFaqH.CUSID, RTLessorCustFaqH.FAQNO,RTLessorCmtyh.comn,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1)),rtlessorcust.cusnc, RTLessorCustFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorCustFaqH.MEMO, 15) AS Expr6,RTLessorCustFaqH.CONTACTTEL, RTLessorCustFaqH.MOBILE,  " _
                      &"  RTLessorCustFaqH.EMAIL,  " _
                      &"  RTLessorCustFaqH.SNDWORK, RTObj_4.CUSNC,  " _
                      &"  RTLessorCustFaqH.SNDPRTNO, RTLessorCustFaqH.PRTDAT, RTLessorCustFaqH.SNDCLOSEDAT,  " _
                      &"  RTLessorCustFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                      ...
                      &"  RTLessorCustFaqH.CANCELDAT, RTObj_1.CUSNC AS Expr3,  " _
                      &"   RTObj_2.CUSNC AS Expr4,  " _
                      &"  RTObj_3.CUSNC AS Expr5,case when RTLessorCustFaqH.finishdat is null then datediff(dd,RTLessorCustFaqH.rcvdat,getdate())+1 else datediff(dd,RTLessorCustFaqH.rcvdat,RTLessorCustFaqH.finishdat)+1 end " _
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      &"  RTObj RTObj_5 ON RTEmployee_5.CUSID = RTObj_5.CUSID RIGHT OUTER JOIN " _
                      &"  RTLessorCustFaqH ON  " _
                      &"  RTEmployee_5.EMPLY = RTLessorCustFaqH.CALLBACKUSR LEFT OUTER JOIN " _
                      ...
                      &"  RTLessorCustFaqH.FUSR = RTEmployee_6.EMPLY LEFT OUTER JOIN " _
                      &"  RTCode ON RTLessorCustFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4' left outer join rtlessorcust on "  _
                      &"  RTLessorCustFaqH.cusid=rtlessorcust.cusid left outer join rtlessorcmtyh on " _
                      &"  rtlessorcust.comq1=rtlessorcmtyh.comq1 " _
                      &"  where RTLessorCustFaqH.cusid<>'' AND " & searchqry
