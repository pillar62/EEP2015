<%
	...
	Response.AddHeader "Content-Disposition","filename=ET超商未沖帳列表.xls"
...
<%
	sql="SELECT  c.BATCHNO, a.COMN,b.CUSNC, g.CODENC as ARAC, c.PERIOD, c.AMT, c.REALAMT, " &_
		...
		"INNER JOIN RTLessorCust b ON a.COMQ1 = b.COMQ1 " &_
		"RIGHT OUTER JOIN RTLessorCustAR c ON b.CUSID = c.CUSID " &_
