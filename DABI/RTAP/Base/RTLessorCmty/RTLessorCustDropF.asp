...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   elseif LEN(TRIM(RSXX("FINISHDAT"))) <> 0 then
      endpgm="4"
   '當一般退租時(非不續約退租)，表示退租日在期限內，必須有應收付帳款編號，否則不可退租
   ...
   ELSE
      ...
      strSP="usp_RTLessorCustDROPF " & "'" & key(0) & "'," & key(1) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorcustDROPf.asp ID="Form1">
