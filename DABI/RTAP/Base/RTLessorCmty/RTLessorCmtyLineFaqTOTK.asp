...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCmtyLineFaqTRNSndwork.ASP;RTLessorCmtyLineFaqSndworkK.asp;RTLessorCmtyLineFaqF.asp;RTLessorCmtyLineFaqFR.asp;RTLessorCmtyLineFaqDrop.asp;RTLessorCmtyLineFaqDropC.asp;RTLessorCmtyLineFaqLogK.asp"
  ...
  sqlDelete="SELECT  RTLessorCmtyLineFaqH.comq1,RTLessorCmtyLineFaqH.lineq1, RTLessorCmtyLineFaqH.FAQNO, RTLessorCmtyLineFaqH.FAQNO,RTLessorCmtyLineFaqH.comq1,rtrim(convert(char(6),RTLessorCmtyLineFaqH.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorCmtyLineFaqH.lineQ1)),RTLessorCmtyH.comn, RTLessorCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorCmtyLineFaqH.MEMO, 12) AS Expr6, RTLessorCmtyLineFaqH.CONTACTTEL, RTLessorCmtyLineFaqH.MOBILE,  " _
                      ...
                      &"  RTLessorCmtyLineFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorCmtyLineFaqH.comq1=0 "
  dataTable="RTLessorCmtyLineFaqH"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorCmtyLineFaqD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCmtyLineFaqtots.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCmtyLineFaqH.comq1<>0 and  RTLessorCmtyLineFaqH.canceldat is null and RTLessorCmtyLineFaqH.finishdat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCmtyLineFaqH.comq1,RTLessorCmtyLineFaqH.lineq1, RTLessorCmtyLineFaqH.FAQNO, RTLessorCmtyLineFaqH.FAQNO,RTLessorCmtyLineFaqH.comq1,rtrim(convert(char(6),RTLessorCmtyLineFaqH.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorCmtyLineFaqH.lineQ1)),RTLessorCmtyH.comn, RTLessorCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorCmtyLineFaqH.MEMO, 15) AS Expr6,RTLessorCmtyLineFaqH.CONTACTTEL, RTLessorCmtyLineFaqH.MOBILE,  " _
                      &"  RTLessorCmtyLineFaqH.EMAIL,  " _
                      &"  RTLessorCmtyLineFaqH.SNDWORK, RTObj_4.CUSNC,  " _
                      &"  RTLessorCmtyLineFaqH.SNDPRTNO, RTLessorCmtyLineFaqH.PRTDAT, RTLessorCmtyLineFaqH.SNDCLOSEDAT,  " _
                      &"  RTLessorCmtyLineFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                      ...
                      &"  RTLessorCmtyLineFaqH.CANCELDAT, RTObj_1.CUSNC AS Expr3,  " _
                      &"   RTObj_2.CUSNC AS Expr4,  " _
                      &"  RTObj_3.CUSNC AS Expr5,case when RTLessorCmtyLineFaqH.finishdat is null then datediff(dd,RTLessorCmtyLineFaqH.rcvdat,getdate())+1 else datediff(dd,RTLessorCmtyLineFaqH.rcvdat,RTLessorCmtyLineFaqH.finishdat)+1 end " _
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      &"  RTObj RTObj_5 ON RTEmployee_5.CUSID = RTObj_5.CUSID RIGHT OUTER JOIN " _
                      &"  RTLessorCmtyLineFaqH ON  " _
                      &"  RTEmployee_5.EMPLY = RTLessorCmtyLineFaqH.CALLBACKUSR LEFT OUTER JOIN " _
                      ...
                      &"  RTLessorCmtyLineFaqH.FUSR = RTEmployee_6.EMPLY LEFT OUTER JOIN " _
                      &"  RTCode ON RTLessorCmtyLineFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4' left outer join rtlessorcmtyh on "  _
                      &"  RTLessorCmtyLineFaqH.comq1=rtlessorcmtyh.comq1 left outer join RTLessorCmtyLine on " _
                      &"  RTLessorCmtyLineFaqH.comq1=RTLessorCmtyLine.comq1 and RTLessorCmtyLineFaqH.lineq1=RTLessorCmtyLine.lineq1 " _
                      &"  where RTLessorCmtyLineFaqH.comq1<>0 AND " & searchqry
