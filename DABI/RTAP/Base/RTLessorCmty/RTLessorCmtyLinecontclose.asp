 ...
 '  RESPONSE.END
  ...
  '此主線之主檔資料尚未測通，不可執行續約結案作業
   ...
   ELSE
      ...
      strSP="usp_RTLessorCMTYLINEcontCLOSE " & key(0) & "," & key(1) & "," & key(2) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=rtlessorCMTYLINEcontCLOSE.asp ID="Form1">
