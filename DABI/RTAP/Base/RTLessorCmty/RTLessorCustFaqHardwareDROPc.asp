...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   ...
   sqlyy="select * FROM RTLessorCustFaqsndwork WHERE  cusid='" & key(0) & "' and FAQNO='" & key(1) & "' and prtno='" & key(2) & "' "
   sqlxx="select * FROM RTLessorCustFaqhardware WHERE cusid='" & key(0) & "'  and FAQNO='" & key(1) & "' and prtno='" & key(2) & "' and seq=" & key(3)
   ...
   rsyy.Open sqlyy,conn
     ...
     ELSE
        ...
        strSP="usp_RTLessorCustFaqHardwareDropC " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "'," & key(3) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorCustFaqhardwaredropc.asp ID="Form1">
