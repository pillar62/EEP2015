...
Sub SrEnvironment()
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTlessorCmtyLineFaqHARDWARE.comq1=" & aryparmkey(0) & " and RTlessorCmtyLineFaqHARDWARE.lineq1=" & aryparmkey(1) & " and RTlessorCmtyLineFaqHARDWARE.faqno='" & aryparmkey(2) & "' and RTlessorCmtyLineFaqHARDWARE.prtno='" & aryparmkey(3) & "' "
