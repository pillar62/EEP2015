...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustARClearRTN.asp"
  functionOptPrompt="Y"
  functionoptopen="1"
  If V(1)="Y" then
     accessMode="U"
  ...
  sqlDelete="SELECT CUSID, BATCHNO, SEQ,REALAMT,MDAT,RTOBJ.CUSNC , CANCELDAT, RTOBJ_1.CUSNC AS CUSNC1 " _
           ...
           &"RIGHT OUTER JOIN RTLessorCustARClear ON RTEmployee_1.EMPLY = RTLessorCustARClear.CANCELUSR LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustARClear.MUSR = RTEmployee.EMPLY " _
           &"where RTLessorCustARClear.cusid='' "
  dataTable="RTLessorCustARClear"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustARClear.CUSID='" & ARYPARMKEY(0) & "' AND RTLessorCustARClear.BATCHNO='" & ARYPARMKEY(1) & "'"
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31  then DAreaID="<>'*'"
         ...
         sqlList="SELECT  " _
                &"RTLessorCustARClear.CUSID, RTLessorCustARClear.BATCHNO, " _
                &"RTLessorCustARClear.SEQ, RTLessorCustARClear.REALAMT, " _
                &"RTLessorCustARClear.MDAT, RTObj_2.SHORTNC, " _
                &"RTLessorCustARClear.CANCELDAT, RTObj_1.SHORTNC AS Expr1 " _
                &"FROM    RTLessorCustARClear LEFT OUTER JOIN " _
                &"RTObj RTObj_1 INNER JOIN " _
                &"RTEmployee RTEmployee_1 ON RTObj_1.CUSID = RTEmployee_1.CUSID ON " _
                &"RTLessorCustARClear.CANCELUSR = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
                &"RTObj RTObj_2 INNER JOIN " _
                &"RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON " _
                &"RTLessorCustARClear.MUSR = RTEmployee_2.EMPLY " _
                &"where " & searchqry & " ORDER BY RTLessorCustARCLEAR.SEQ "
