...
Sub SrEnvironment()
  ...
  sqlDelete="SELECT  RTLessorCustRTNHardware.RCVPRTNO AS RCVPRTNO, " _
                       &" CASE WHEN RTLessorCustRTNHardware.DATASRC ='01' THEN '裝機派工領用'  WHEN  RTLessorCustRTNHardware.DATASRC ='02'  THEN '續約收款派工領用' WHEN RTLessorCustRTNHardware.DATASRC = '03' THEN '復機收款派工領用' ELSE '' END, " _
