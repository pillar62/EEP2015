...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   if endpgm="" then
      ...
      strSP="usp_RTLessorCustReturnTRNFR " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "','" & BATCHNOXX & "'"
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "ET-City用戶復機返轉應收結案作業成功",0
...
<form name=frm1 method=post action=RTLessorCustReturnTRNFR.asp ID="Form1">
