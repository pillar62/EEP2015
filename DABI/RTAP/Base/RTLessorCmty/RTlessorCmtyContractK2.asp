...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCmtyContractMonthlyScaleK.asp;RTLessorCmtyContractContK.asp;RTLessorCmtyContractF.asp;RTLessorCmtyContractFR.asp;RTLessorCmtyContractCancel.asp;RTLessorCmtyContractCancelRTN.asp;RTLessorCmtyContractLogK.asp"
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCmtyContractS2.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCmtyContract.ComQ1<>0 AND RTLessorCmtyContract.CANCELDAT IS NULL "
     searchShow="全部未作廢"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 then DAreaID="<>'*'"
         sqlList="SELECT  RTLessorCmtyContract.COMQ1, RTLessorCmtyContract.CONTRACTNO,RTLessorCmtyh.comn, RTLessorCmtyContract.STRDAT, " _
                &"RTLessorCmtyContract.CONTDAT,RTLessorCmtyContract.CONTCNT, RTLessorCmtyContract.ENDDAT, " _
                &"RTLessorCmtyContract.CONTRACTOBJ, RTLessorCmtyContract.OBJTEL, RTLessorCmtyContract.OBJMOBILE, " _
                &"RTDept.DEPTN4, RTObj_3.CUSNC,  case when RTLessorCmtyContract.REMITBANK1 <> '' then RTLessorCmtyContract.REMITBANK1 else '' end + case when  RTLessorCmtyContract.REMITBANK1 <> '' and RTLessorCmtyContract.REMITBANK2<>'' then '-' + RTLessorCmtyContract.REMITBANK2 else '' end + case when RTLessorCmtyContract.REMITBANK1 <> '' or RTLessorCmtyContract.REMITBANK2<>'' then '-' + RTLessorCmtyContract.ACNO else '' end, " _
                &"RTLessorCmtyContract.AC, RTCode_2.CODENC, RTCode_1.CODENC AS Expr1, RTLessorCmtyContract.SCALEAMT, " _
                ...
                &"RTLessorCmtyContract.REMITBANK2 = RTBankNo.BRANCHNO LEFT OUTER JOIN RTBank ON " _
                &"RTLessorCmtyContract.REMITBANK1 = RTBank.HEADNO LEFT OUTER JOIN RTDept ON " _
                &"RTLessorCmtyContract.SIGNDEPT = RTDept.DEPT left outer join RTLessorCmtyh on RTLessorCmtyContract.comq1=RTLessorCmtyh.comq1 " _
                &"WHERE RTLessorCmtyContract.COMQ1<>0 AND " & SEARCHQRY & " ORDER BY RTLessorCmtyContract.CONTRACTNO" 
