...
Sub SrEnvironment()
  ...
  system="ET-City管理系統"
  title="ET-City用戶退租作業"
  buttonName=" 新　增 ; 刪　除 ; 結　束 ;重新整理; 頁　數 ;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="轉拆機單;派工單查詢;退租結案;結案返轉;作　　廢;作廢返轉;歷史異動"
  functionOptProgram="RTLessorCustDropTRNsndwork.asp;RTLessorCustDropsndworkK.asp;RTLessorCustDropF.asp;RTLessorCustDropFR.asp;RTLessorCustDropDrop.asp;RTLessorCustDropDropC.asp;RTLessorCustDropLogK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;退租項次;退租種類;退租申請日;預定退租日;退租結案日;結案人員;拆機工單;轉拆機單日期;拆機結案日;轉應付帳款日;應付帳款編號;作廢日;作廢人員;none;none"
  sqlDelete="SELECT  RTLessorCustDrop.CUSID,RTLessorCustDrop.ENTRYNO,RTCODE.CODENC,RTLessorCustDrop.APPLYDAT,RTLessorCustDrop.ENDDAT, " _
                   &"RTLessorCustDrop.FINISHDAT, RTObj.CUSNC, RTLessorCustDrop.SNDPRTNO, RTLessorCustDrop.SNDWORK,RTLessorCustDrop.SNDWORKCLOSE, RTLessorCustDrop.CANCELDAT, " _
                   &"RTObj_1.CUSNC AS Expr1, RTObj_2.CUSNC AS Expr2, RTObj_3.CUSNC AS Expr3 " _
           ...
           &"     where RTLessorCustDrop.cusid='' "

  dataTable="RTLessorCustDrop"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorCustDropD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustDrops.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustDrop.cusid='" & aryparmkey(0) & "' AND RTLessorCustDrop.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCustDrop.CUSID,RTLessorCustDrop.ENTRYNO,RTCODE.CODENC,RTLessorCustDrop.APPLYDAT,RTLessorCustDrop.ENDDAT, " _
                   &"RTLessorCustDrop.FINISHDAT, RTObj.CUSNC, RTLessorCustDrop.SNDPRTNO, RTLessorCustDrop.SNDWORK,RTLessorCustDrop.SNDWORKCLOSE,RTLessorCustDrop.tardat,RTLessorCustDrop.batchno, RTLessorCustDrop.CANCELDAT, " _
                   &"RTObj_1.CUSNC AS Expr1, RTObj_2.CUSNC AS Expr2, RTObj_3.CUSNC AS Expr3 " _
           &"FROM RTEmployee RTEmployee_3 INNER JOIN RTObj RTObj_3 ON RTEmployee_3.CUSID = RTObj_3.CUSID RIGHT OUTER JOIN " _
           &"     RTLessorCustDrop ON RTEmployee_3.EMPLY = RTLessorCustDrop.UUSR LEFT OUTER JOIN " _
           &"     RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_2 ON RTEmployee_2.CUSID = RTObj_2.CUSID ON " _
           ...
           &"     RTEmployee_1.EMPLY LEFT OUTER JOIN RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON " _
           &"     RTLessorCustDrop.FUSR = RTEmployee.EMPLY  LEFT OUTER JOIN RTCODE ON RTLessorCustDrop.DROPKIND=RTCODE.CODE AND RTCODE.KIND='N7' " _
           &"where RTLessorCustDrop.cusid='" & aryparmkey(0) & "' and " & searchqry
  'end if
