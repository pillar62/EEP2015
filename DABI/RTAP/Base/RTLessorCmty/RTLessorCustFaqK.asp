...
Sub SrEnvironment()
  ...
  sqlDelete="SELECT  RTLessorCustFaqH.CUSID, RTLessorCustFaqH.FAQNO, RTLessorCustFaqH.RCVDAT, RTCode.CODENC, " _
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustFaqs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustFaqH.cusid='" & aryparmkey(2) & "' and  RTLessorCustFaqH.canceldat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCustFaqH.CUSID, RTLessorCustFaqH.FAQNO, RTLessorCustFaqH.RCVDAT, RTCode.CODENC, " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTCode ON RTLessorCustFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorCustFaqH.cusid='" & aryparmkey(2) & "' AND " & searchqry
