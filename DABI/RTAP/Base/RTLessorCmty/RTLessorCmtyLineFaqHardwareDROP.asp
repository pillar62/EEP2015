   ...
   rsyy.Open sqlyy,conn
    ...
    '已轉應收帳款不可作廢
     ...
     ELSE
      ...
      strSP="usp_RTLessorCmtylineFaqHardwareDrop " & key(0) & "," & key(1) & ",'" & key(2) & "','" & key(3) & "'," & key(4)& ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorCmtylineFaqhardwaredrop.asp ID="Form1">
