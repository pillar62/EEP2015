...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustContsndworkk.asp;RTLessorCustContTRNAR.asp;RTLessorCustContTRNFR.asp;RTLessorCustARK2.asp;RTLessorCustContDROP.asp;RTLessorCustContDROPC.asp;RTLessorCustContLOGK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;用戶名稱;續約序號;續約申請日;開始計費日;繳費週期;繳費方式;可用期別;第二戶;應收金額;實收金額;轉應收<br>帳款日;帳款編號;結案日;作廢日"
  sqlDelete="SELECT  RTLessorCustCont.CUSID, RTLessorCustCont.ENTRYNO, " _
                        &"RTLessorCust.CUSNC, RTLessorCustCont.ENTRYNO, RTLessorCustCont.APPLYDAT, RTLessorCustCont.strbillingDAT, RTCode_2.CODENC, " _
                        &"RTCode_1.CODENC AS Expr1, RTLessorCustCont.PERIOD, " _
                        &"RTLessorCustCont.SECONDCASE, RTLessorCustCont.AMT, " _
                        &"RTLessorCustCont.REALAMT, RTLessorCustCont.TARDAT, " _
                        &"RTLessorCustCont.BATCHNO, RTLessorCustCont.FINISHDAT, " _
                        &"RTLessorCustCont.CANCELDAT " _
                &"FROM    RTLessorCustCont LEFT OUTER JOIN " _
                        &"RTCode RTCode_1 ON RTLessorCustCont.PAYTYPE = RTCode_1.CODE AND " _
                        &"RTCode_1.KIND = 'M9' LEFT OUTER JOIN " _
                        &"RTLessorCust ON " _
                        &"RTLessorCustCont.CUSID = RTLessorCust.CUSID LEFT OUTER JOIN " _
                        &"RTCode RTCode_2 ON RTLessorCustCont.PAYCYCLE = RTCode_2.CODE AND " _
                        &"RTCode_2.KIND = 'M8'" _
                &"where RTLessorCustCont.cusid='' "

  dataTable="RTLessorCustCont"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorCustContD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorcustconts.asp"
  '========================================================================================================
  '========================================================================================================
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustCont.cusid='" & aryparmkey(0) & "' AND RTLessorCustCont.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCustCont.CUSID, RTLessorCustCont.ENTRYNO, " _
                        &"RTLessorCust.CUSNC, RTLessorCustCont.ENTRYNO, RTLessorCustCont.APPLYDAT, RTLessorCustCont.strbillingDAT, RTCode_2.CODENC, " _
                        &"RTCode_1.CODENC AS Expr1, RTLessorCustCont.PERIOD, " _
                        &"RTLessorCustCont.SECONDCASE, RTLessorCustCont.AMT, " _
                        &"RTLessorCustCont.REALAMT, RTLessorCustCont.TARDAT, " _
                ...
                &"FROM    RTLessorCustCont LEFT OUTER JOIN " _
                        ...
                        &"RTCode RTCode_2 ON RTLessorCustCont.PAYCYCLE = RTCode_2.CODE AND " _
                        &"RTCode_2.KIND = 'M8' " _
                &"where RTLessorCustCont.cusid='" & aryparmkey(0) & "' and " & searchqry 
  'end if
