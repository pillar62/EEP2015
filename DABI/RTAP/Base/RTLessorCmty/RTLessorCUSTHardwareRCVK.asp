...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  sqlYY="select * from RTCounty RIGHT OUTER JOIN RTLessorCmtyH ON " _
       ...
       &"where RTLessorCmtyH.COMQ1=" & ARYPARMKEY(2) 
  connYY.Open dsnYY
 ' response.write sqlyy
  ...
  sqlYY="select * from RTCounty RIGHT OUTER JOIN RTLessorCmtyLine ON  " _
       ...
       &"where RTLessorCmtyLine.COMQ1=" & ARYPARMKEY(2) & " AND RTLessorCmtyLine.LINEQ1=" & ARYPARMKEY(3)
  rsYY.Open sqlYY,connYY
  if not rsYY.EOF then
     comaddr=""
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustrcvhardware.prtno='" & aryparmkey(2) & "' AND RTLessorCustrcvhardware.CANCELDAT IS NULL "
...
&"  FROM             RTEmployee RTEmployee_4 INNER JOIN RTObj RTObj_6 ON RTEmployee_4.CUSID = RTObj_6.CUSID RIGHT OUTER JOIN " _
                       ...
                       &" rtcode rtcode_1 on RTLessorCustRCVHardware.datasrc=rtcode_1.code and rtcode_1.kind='N8' " _
                       &" where RTLessorCustrcvhardware.prtno='" & aryparmkey(2) & "' AND " & searchqry & " " _
                       &" GROUP BY  RTLessorCustRCVHardware.RCVPRTNO , " _
                       &" RTCODE_1.CODENC, " _
                       &" RTLessorCustRCVHardware.APPLYDAT , " _
                       &" CASE WHEN RTObj_7.CUSNC='' OR RTObj_7.CUSNC IS NULL THEN RTObj_2.SHORTNC ELSE  RTObj_7.CUSNC END , " _
