...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   ...
   sqlyy="select * FROM RTlessorcustcontsndwork WHERE  cusid='" & key(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' "
   ...
   rsxx.Open sqlxx,conn
    rsyy.Open sqlyy,conn 
     ...
     ELSE
        ...
        strSP="usp_RTLessorCustcontHardwareDropC " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "'," & key(3) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=rtlessorcustconthardwaredropc.asp ID="Form1">
