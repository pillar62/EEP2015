...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustHardwareRCVK.ASP;RTLessorCmtyLineSNDWORKPV.asp;RTLessorCmtyLineSNDWORKF.asp;RTLessorCmtyLineSNDWORKUF.asp;RTLessorCmtyLineSNDWORKFR.asp;RTLessorCmtyLineSNDWORKdrop.asp;RTLessorCmtyLineSNDWORKdropC.asp;RTLessorCMTYLINEhardwareK.asp;RTLessorCmtyLineSNDWORKLOGK.asp"
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCmtyLineSNDWORKs2.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCmtyLineSNDWORK.dropdat is null AND RTLessorCmtyLineSNDWORK.UNCLOSEDAT IS NULL AND RTLessorCmtyLineSNDWORK.CLOSEDAT IS NULL "
     searchShow="全部未完工"
  ELSE
     SEARCHFIRST=FALSE
  End If
