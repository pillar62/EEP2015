...
Sub SrEnvironment()
  ...
  system="ET-City管理系統"
  title="ET-City物品移轉單資料維護"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="列印移轉單;移轉明細"
  functionOptProgram="RTLessorCustHardwareRTNP.asp;RTLessorCustHardwareRTNDTLK.ASP"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="移轉單號;移轉類別;移轉申請日;移轉申請人;實際移轉人;移轉結案日;結案人員;作廢日;作廢人員;派工單號;轉移轉單人員;移轉數量"
...
&"  FROM             RTEmployee RTEmployee_4 INNER JOIN RTObj RTObj_6 ON RTEmployee_4.CUSID = RTObj_6.CUSID RIGHT OUTER JOIN " _
                       ...
                       &" RTLessorCustRTNHardware.RCVPRTNO=RTLessorCustRTNHardwareDTL.RCVPRTNO left outer join rtcode rtcode_1 on " _
                       &" RTLessorCustRTNHardware.datasrc=rtcode_1.code and rtcode_1.kind='O1' " _
                       &" where RTLessorCustRTNHardware.prtno='' " _
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustHardwareRtnS.ASP"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustRTNHardware.prtno='" & aryparmkey(3) & "' AND RTLessorCustRTNHardware.CANCELDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
          ...
          sqlList="SELECT  RTLessorCustRTNHardware.RCVPRTNO AS RCVPRTNO, " _
                       &" rtcode_1.codenc, " _
                       &" RTLessorCustRTNHardware.APPLYDAT AS APPLYDAT, " _
                       &" CASE WHEN RTObj_7.CUSNC='' OR RTObj_7.CUSNC IS NULL THEN RTObj_2.SHORTNC ELSE  RTObj_7.CUSNC END , " _
                       &" CASE WHEN RTObj_1.CUSNC='' OR RTObj_1.CUSNC IS NULL THEN RTObj_3.SHORTNC ELSE RTObj_1.CUSNC END, " _
...
&"  FROM             RTEmployee RTEmployee_4 INNER JOIN RTObj RTObj_6 ON RTEmployee_4.CUSID = RTObj_6.CUSID RIGHT OUTER JOIN " _
                       ...
                       &" RTLessorCustRTNHardware.RCVPRTNO=RTLessorCustRTNHardwareDTL.RCVPRTNO left outer join rtcode rtcode_1 on " _
                       &" RTLessorCustRTNHardware.datasrc=rtcode_1.code and rtcode_1.kind='O1' " _
                       &" where RTLessorCustRTNHardware.prtno='" & aryparmkey(3) & "' AND " & searchqry & " " _
                       &" GROUP BY  RTLessorCustRTNHardware.RCVPRTNO , " _
                       &" rtcode_1.codenc, " _
                       &" RTLessorCustRTNHardware.APPLYDAT , " _
                       &" CASE WHEN RTObj_7.CUSNC='' OR RTObj_7.CUSNC IS NULL THEN RTObj_2.SHORTNC ELSE  RTObj_7.CUSNC END , " _
