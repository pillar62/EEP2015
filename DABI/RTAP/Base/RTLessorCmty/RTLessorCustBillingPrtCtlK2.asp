...
Sub SrEnvironment()
  ...
  functionOptProgram="/REPORT/Common/RTLessorCustBillingPrtCtlP2.asp;/Report/ETCity/RTLessorCustBillingPrtEnvP2.asp;/REPORT/ETCity/Report4.asp"
  ...
  sqlDelete="SELECT	a.noticeid, a.batch, c.consignee, c.salesid, " &_
			...
			"inner join RTLessorCust b on a.comq1 = b.comq1 and a.lineq1 = b.lineq1 and a.cusid = b.cusid " &_
			"inner join RTLessorCmtyLine c on c.comq1 = b.comq1 and c.lineq1 = b.lineq1 " &_
			"inner join RTLessorCmtyH d on d.comq1 = c.comq1 " &_
			...
			"left outer join RTLessorCustCont i on i.cusid = a.cusid and i.canceldat is null " &_
			"	and i.strbillingdat = dateadd(d, 1, a.duedat) " &_
			"left outer join rtcode j on j.code = i.paytype and j.kind ='M9' " &_
			"WHERE d.comq1=0 " &_
  dataTable="RTLessorCustBillingPrtSub"
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustBillingPrtCtlS.asp"
