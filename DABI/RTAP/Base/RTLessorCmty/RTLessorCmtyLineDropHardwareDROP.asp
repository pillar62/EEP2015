...
<% KEY=SPLIT(REQUEST("KEY"),";")
  ...
  '當所屬派工單已計算庫存後，不可作廢之(stockcloseym<>'')
   ...
   sqlyy="select * FROM RTLessorCmtyLineDropsndwork WHERE comq1=" & key(0) & " and lineq1=" & key(1) & "  and ENTRYNO=" & key(2) & " and prtno='" & key(3) & "' "
   ...
   rsyy.Open sqlyy,conn
    ...
    '已轉應收帳款不可作廢
     ...
     ELSE
      ...
      strSP="usp_RTLessorCmtyLineDropHardwareDrop " & key(0) & "," & key(1) & "," & key(2) & ",'" & key(3) & "'," & key(4)& ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorCmtyLineDrophardwaredrop.asp ID="Form1">
