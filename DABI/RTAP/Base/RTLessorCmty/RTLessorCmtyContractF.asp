 ...
 '  RESPONSE.END
   ...
   ELSE
     '呼叫store procedure更新相關檔案
      strSP="usp_RTLessorCmtyContractCancel " & key(0) & ",'" & key(1) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorCmtyContractCANCEL.asp ID="Form1">
