...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlzz="select count(*) as cnt FROM RTLessorCustRCVHardware WHERE prtno='" & KEY(3) & "' and canceldat is null "
   ...
   ELSE
      ...
      strSP="usp_RTLessorCmtylineFaqSndworkDrop " & key(0) & "," & key(1) & ",'" & key(2) & "','" & key(3) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorCmtylineFAQsndworkdrop.asp ID="Form1">
