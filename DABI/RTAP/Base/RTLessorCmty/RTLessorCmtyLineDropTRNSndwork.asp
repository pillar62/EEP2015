...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlYY="select COUNT(*) AS CNT FROM RTLessorCMTYLINEHardware WHERE COMQ1=" & KEY(0) & " AND LINEQ1=" & KEY(1) & " and dropdat is null and rcvfinishdat is not null and qty > 0 "
   sqlzz="select COUNT(*) AS CNT FROM RTLessorCMTYLINEfaqHardware WHERE COMQ1=" & KEY(0) & " AND LINEQ1=" & KEY(1) & " and dropdat is null and rcvfinishdat is not null and qty > 0 "
 ...
 '     endpgm="6"      
   ELSE
      ...
      strSP="usp_RTLessorCmtyLineDropTRNSndwork "  & key(0) & "," & key(1) & "," & key(2) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorcmtylinedropTRNSndwork.asp ID="Form1">
