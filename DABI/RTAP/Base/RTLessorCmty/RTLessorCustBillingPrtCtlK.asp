...
Sub SrEnvironment()
  ...
  system="ET-City管理系統"
  title="ET-City每月續約帳單列印查詢<BR><font color=white>廠商編號：BPIS0334<BR>廠商密碼：yyvu7knt</font><BR><font color=red size=4><B>續約文字檔請於下午 1:00 前上傳</B></font>"
  buttonName=" 新  增 ; 刪  除 ; 結  束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="0.產生續約單;1.匯出續約文字檔;2.上傳續約文字檔;3.匯入條碼檔;4.列印續約單;5.列印信封;用戶明細"
  functionOptProgram="RTLessorCustBillingPrtCtlTRNK.asp;RTLessorCustBillSeednetBatch.asp;https://service.seed.net.tw/proxy_portal.htm;RTLessorCustBillBarcode.asp;/REPORT/Common/RTLessorCustBillingPrtCtlP.asp;/Report/ETCity/RTLessorCustBillingPrtEnvP.asp;RTLessorCustBillingPrtCtlk2.asp"
  ...
  sqlDelete="SELECT BATCH, DUEDATSB, DUEDATEB, DUEDATSA, DUEDATEA, CDAT, c.CUSNC, " &_
			...
			"FROM RTLessorCustBillingPrt a " &_
  ...
  dataTable="RTLessorCustBillingPrt"
