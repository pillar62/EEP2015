...
<table width="100%" cellPadding=0 cellSpacing=0 ID="Table3">
 <tr><td width="10%"><input type="button" value="搜尋條件" class=keyListSearch onClick="runSearchOpt" ID="Button12" NAME="Button12"></td>
     <td width="90%" class=keyListSearch2><%=searchShow%><%=countshow%>
         ...
         <input type="text" name="searchQry3" value="<%=searchQry3%>" style="display:none" readonly ID="Text4">
         <input type="text" name="EMAILFIELDNO" value="<%=EMAILFIELDNO%>" style="display:none" readonly ID="Text5"></td>
 </tr>
</table>
<p>
<%End If%>
...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustBillingPrtCtlTRN.asp"
  functionOptPrompt="Y"
  functionoptopen="1"
  If V(1)="Y" then
     accessMode="U"
  ...
  sqlDelete="SELECT a.comq1, a.lineq1, a.cusid, " &_
			...
			"inner join RTLessorCmtyH c on a.COMQ1 = c.COMQ1 " &_
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustBillingPrtCtlTRNS.asp"
