...
Sub SrEnvironment()
  ...
  functionOptProgram="RTlessorCUSTHARDWARERCVK4.ASP;RTlessorCmtyLineFaqSNDWORKPV.asp;RTlessorCmtyLineFaqSNDWORKF.asp;RTlessorCmtyLineFaqSNDWORKUF.asp;RTlessorCmtyLineFaqSNDWORKFR.asp;RTlessorCmtyLineFaqSNDWORKdrop.asp;RTlessorCmtyLineFaqSNDWORKdropC.asp;RTlessorCmtyLinefaqhardwareK.asp;RTlessorCmtyLineFaqSNDWORKLOGK.asp"
  ...
  sqlDelete="SELECT RTlessorCmtyLineFaqSNDWORK.comq1,RTlessorCmtyLineFaqSNDWORK.lineq1,RTlessorCmtyLineFaqSNDWORK.faqno, RTlessorCmtyLineFaqSNDWORK.PRTNO,rtrim(convert(char(6),RTlessorCmtyLine.COMQ1)) +'-'+ rtrim(convert(char(6),RTlessorCmtyLine.lineQ1))  as comqline, RTlessorCmtyLineFaqSNDWORK.PRTNO, RTlessorCmtyLineFaqSNDWORK.SENDWORKDAT, " _
           ...
           &"RTlessorCmtyLineFaqSNDWORK.closedat,RTlessorCmtyLineFaqSNDWORK.unclosedat,RTlessorCmtyLineFaqSNDWORK.BONUSCLOSEYM, RTlessorCmtyLineFaqSNDWORK.BONUSFINCHK,RTlessorCmtyLineFaqSNDWORK.batchno, RTlessorCmtyLineFaqSNDWORK.STOCKCLOSEYM, RTlessorCmtyLineFaqSNDWORK.STOCKFINCHK, " _
           &"RTlessorCmtyLineFaqSNDWORK.DROPDAT FROM RTlessorCmtyLineFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTlessorCmtyLineFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTlessorCmtyLineFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTlessorCmtyLineFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTlessorCmtyLineFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTlessorCmtyLineFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTlessorCmtyLine on RTlessorCmtyLineFaqSNDWORK.comq1=RTlessorCmtyLine.comq1 where RTlessorCmtyLineFaqSNDWORK.comq1=0 "
  dataTable="RTlessorCmtyLineFaqSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=4
  dataProg="RTlessorCmtyLineFaqSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTlessorCmtyLineFaqSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTlessorCmtyLineFaqSNDWORK.comq1=" & aryparmkey(0) & " and RTlessorCmtyLineFaqSNDWORK.lineq1=" & aryparmkey(1) & " and RTlessorCmtyLineFaqSNDWORK.faqno='" & aryparmkey(2) & "' and  RTlessorCmtyLineFaqSNDWORK.dropdat is null and RTlessorCmtyLineFaqSNDWORK.unclosedat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTlessorCmtyLineFaqSNDWORK.comq1,RTlessorCmtyLineFaqSNDWORK.lineq1,RTlessorCmtyLineFaqSNDWORK.faqno, RTlessorCmtyLineFaqSNDWORK.PRTNO,rtrim(convert(char(6),RTlessorCmtyLine.COMQ1)) +'-'+ rtrim(convert(char(6),RTlessorCmtyLine.lineQ1))  as comqline, RTlessorCmtyLineFaqSNDWORK.PRTNO, RTlessorCmtyLineFaqSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTlessorCmtyLineFaqSNDWORK.closedat,RTlessorCmtyLineFaqSNDWORK.unclosedat,RTlessorCmtyLineFaqSNDWORK.BONUSCLOSEYM, RTlessorCmtyLineFaqSNDWORK.BONUSFINCHK,RTlessorCmtyLineFaqSNDWORK.batchno, RTlessorCmtyLineFaqSNDWORK.STOCKCLOSEYM, RTlessorCmtyLineFaqSNDWORK.STOCKFINCHK, " _
           &"RTlessorCmtyLineFaqSNDWORK.DROPDAT ,SUM(CASE WHEN RTlessorCmtyLinefaqHARDWARE.dropdat IS NULL AND RTlessorCmtyLinefaqHARDWARE.QTY > 0 " _
           &"THEN RTlessorCmtyLinefaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTlessorCmtyLinefaqHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTlessorCmtyLinefaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTlessorCmtyLinefaqHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTlessorCmtyLinefaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTlessorCmtyLinefaqHARDWARE.QTY ELSE 0 END), " _
           &"SUM(CASE WHEN RTlessorCmtyLinefaqHARDWARE.dropdat IS NULL AND RTlessorCmtyLinefaqHARDWARE.QTY > 0 THEN RTlessorCmtyLinefaqHARDWARE.QTY ELSE 0 END) - " _
           &"SUM(CASE WHEN RTlessorCmtyLinefaqHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTlessorCmtyLinefaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTlessorCmtyLinefaqHARDWARE.QTY ELSE 0 END) " _
           &"FROM RTlessorCmtyLineFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTlessorCmtyLineFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTlessorCmtyLineFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTlessorCmtyLineFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTlessorCmtyLineFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTlessorCmtyLineFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTlessorCmtyLine on RTlessorCmtyLineFaqSNDWORK.comq1=RTlessorCmtyLine.comq1 and RTlessorCmtyLine.lineq1=RTlessorCmtyLineFaqSNDWORK.lineq1 LEFT OUTER JOIN " _
           &"RTlessorCmtyLinefaqHARDWARE ON RTlessorCmtyLineFaqSNDWORK.comq1 = RTlessorCmtyLinefaqHARDWARE.comq1 and RTlessorCmtyLineFaqSNDWORK.lineq1=RTlessorCmtyLinefaqHARDWARE.lineq1 and RTlessorCmtyLineFaqSNDWORK.faqno=RTlessorCmtyLinefaqHARDWARE.faqno AND " _
           &"RTlessorCmtyLineFaqSNDWORK.PRTNO = RTlessorCmtyLinefaqHARDWARE.PRTNO " _
           &"where RTlessorCmtyLineFaqSNDWORK.comq1=" & aryparmkey(0) & " and RTlessorCmtyLineFaqSNDWORK.lineq1=" & aryparmkey(1) & " and RTlessorCmtyLineFaqSNDWORK.faqno='" & aryparmkey(2) & "' and " & searchqry & " " _
           &"GROUP BY  RTlessorCmtyLineFaqSNDWORK.comq1,RTlessorCmtyLineFaqSNDWORK.lineq1,RTlessorCmtyLineFaqSNDWORK.faqno, RTlessorCmtyLineFaqSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), RTlessorCmtyLine.COMQ1)) + '-' + rtrim(CONVERT(char(6), RTlessorCmtyLine.lineQ1)), " _
           &"RTlessorCmtyLineFaqSNDWORK.PRTNO, RTlessorCmtyLineFaqSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTlessorCmtyLineFaqSNDWORK.closedat, " _
           &"RTlessorCmtyLineFaqSNDWORK.unclosedat, RTlessorCmtyLineFaqSNDWORK.BONUSCLOSEYM, RTlessorCmtyLineFaqSNDWORK.BONUSFINCHK, " _
           &"RTlessorCmtyLineFaqSNDWORK.batchno, RTlessorCmtyLineFaqSNDWORK.STOCKCLOSEYM, RTlessorCmtyLineFaqSNDWORK.STOCKFINCHK, " _
           &"RTlessorCmtyLineFaqSNDWORK.DROPDAT "            
