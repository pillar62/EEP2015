...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlyy="select * FROM RTLessorCustReturnsndwork WHERE  cusid='" & key(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' "
   ...
   RSyy.OPEN SQLyy,conn
     ...
     ELSE
        ...
        strSP="usp_RTLessorCustReturnHardwareDropC " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "'," & key(3) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=rtlessorcustreturnhardwaredropc.asp ID="Form1">
