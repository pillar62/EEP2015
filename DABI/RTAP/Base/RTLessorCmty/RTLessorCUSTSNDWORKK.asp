...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustHardwareRCVK.ASP;/RTAP/REPORT/ETCity/RTLessorCustSNDWORKPV.asp;RTLessorCustsndworkF.asp;RTLessorCustsndworkUF.asp;RTLessorCustsndworkFR.asp;RTLessorCustsndworkdrop.asp;RTLessorCustsndworkdropc.asp;RTLessorCusthardwareK.asp;RTLessorCustsndworkLOGK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;主線;派工單號;完工日期;列印人員;預定施工員;實際施工員;結案日;未完工結案日;none;none;應收帳款編號;none;none;作廢日;設備數量;轉領用單數量;已領數量;待領數量"
  sqlDelete="SELECT RTLessorCustSNDWORK.CUSID, RTLessorCustSNDWORK.PRTNO,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1))  as comqline, RTLessorCustSNDWORK.PRTNO, RTLessorCustSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorCustSNDWORK.closedat,RTLessorCustSNDWORK.unclosedat,RTLessorCustSNDWORK.BONUSCLOSEYM, RTLessorCustSNDWORK.BONUSFINCHK,RTLessorCustSNDWORK.batchno, RTLessorCustSNDWORK.STOCKCLOSEYM, RTLessorCustSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustSNDWORK.DROPDAT FROM RTLessorCustSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorCustSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorCustSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorCustSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorCustSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"rtlessorcust on RTLessorCustSNDWORK.cusid=rtlessorcust.cusid where RTLessorCustSNDWORK.cusid='' "
  dataTable="RTLessorCustSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=4
  dataProg="RTLessorCustSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustSNDWORK.cusid='" & aryparmkey(2) & "' and  RTLessorCustSNDWORK.dropdat is null AND RTLessorCustSNDWORK.UNCLOSEDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorCustSNDWORK.CUSID, RTLessorCustSNDWORK.PRTNO,rtlessorcust.COMQ1,rtlessorcust.lineQ1,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1))  as comqline, RTLessorCustSNDWORK.PRTNO, RTLessorCustSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorCustSNDWORK.closedat,RTLessorCustSNDWORK.unclosedat,RTLessorCustSNDWORK.BONUSCLOSEYM, RTLessorCustSNDWORK.BONUSFINCHK,RTLessorCustSNDWORK.batchno, RTLessorCustSNDWORK.STOCKCLOSEYM, RTLessorCustSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustSNDWORK.DROPDAT,SUM(CASE WHEN RTLessorCustHARDWARE.dropdat IS NULL AND RTLessorCustHARDWARE.QTY > 0 " _
           &"THEN RTLessorCustHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorCustHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTLessorCustHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorCustHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTLessorCustHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorCustHARDWARE.QTY ELSE 0 END), " _
           &"SUM(CASE WHEN RTLessorCustHARDWARE.dropdat IS NULL AND RTLessorCustHARDWARE.QTY > 0 THEN RTLessorCustHARDWARE.QTY ELSE 0 END) - " _
           &"SUM(CASE WHEN RTLessorCustHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTLessorCustHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorCustHARDWARE.QTY ELSE 0 END) " _
           &"FROM RTLessorCustSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorCustSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorCustSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorCustSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorCustSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"rtlessorcust on RTLessorCustSNDWORK.cusid=rtlessorcust.cusid LEFT OUTER JOIN " _
           &"RTLessorCustHARDWARE ON RTLessorCustSNDWORK.cusid = RTLessorCustHARDWARE.CUSID AND " _
           &"RTLessorCustSNDWORK.PRTNO = RTLessorCustHARDWARE.PRTNO " _
           &"where RTLessorCustSNDWORK.cusid='" & aryparmkey(2) & "' and " & searchqry & " " _
           &"GROUP BY  RTLessorCustSNDWORK.CUSID, RTLessorCustSNDWORK.PRTNO,rtlessorcust.COMQ1,rtlessorcust.lineQ1, " _
           &"rtrim(CONVERT(char(6), rtlessorcust.COMQ1)) + '-' + rtrim(CONVERT(char(6), rtlessorcust.lineQ1)), " _
           &"RTLessorCustSNDWORK.PRTNO, RTLessorCustSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorCustSNDWORK.closedat, " _
           &"RTLessorCustSNDWORK.unclosedat, RTLessorCustSNDWORK.BONUSCLOSEYM, RTLessorCustSNDWORK.BONUSFINCHK, " _
           &"RTLessorCustSNDWORK.batchno, RTLessorCustSNDWORK.STOCKCLOSEYM, RTLessorCustSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustSNDWORK.DROPDAT "
