...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlyy="select count(*) as cnt FROM RTLessorCustReturnhardware WHERE CUSID='" & KEY(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' and dropdat is null and RCVPRTNO <> '' "
   ...
   ELSE
      ...
      strSP="usp_RTLessorCustReturnARSndworkUF " & "'" & key(0) & "'" & "," & key(1) & ",'" & key(2) & "','" & V(0) & "'" 
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "ET-City用戶復機收款派工單未完工結案成功",0
...
<form name=frm1 method=post action=RTLessorCustReturnsndworkUf.asp ID="Form1">
