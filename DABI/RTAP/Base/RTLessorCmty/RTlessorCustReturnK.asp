...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustReturnsndworkk.asp;RTLessorCustReturnTRNAR.asp;RTLessorCustReturnTRNFR.asp;RTLessorCustARK2.asp;RTLessorCustReturnDROP.asp;RTLessorCustReturnDROPC.asp;RTLessorCustReturnLOGK.asp"
  ...
  sqlDelete="SELECT  RTLessorCustReturn.CUSID, RTLessorCustReturn.ENTRYNO, " _
                        &"RTLessorCust.CUSNC, RTLessorCustReturn.ENTRYNO, RTLessorCustReturn.APPLYDAT, RTLessorCustReturn.strbillingDAT, RTCode_2.CODENC, " _
                        &"RTCode_1.CODENC AS Expr1, RTLessorCustReturn.PERIOD, " _
                        &"RTLessorCustReturn.SECONDCASE, RTLessorCustReturn.AMT, " _
                        &"RTLessorCustReturn.REALAMT, RTLessorCustReturn.TARDAT, " _
                        &"RTLessorCustReturn.BATCHNO, RTLessorCustReturn.FINISHDAT, " _
                        &"RTLessorCustReturn.CANCELDAT " _
                &"FROM    RTLessorCustReturn LEFT OUTER JOIN " _
                        &"RTCode RTCode_1 ON RTLessorCustReturn.PAYTYPE = RTCode_1.CODE AND " _
                        &"RTCode_1.KIND = 'M9' LEFT OUTER JOIN " _
                        &"RTLessorCust ON " _
                        &"RTLessorCustReturn.CUSID = RTLessorCust.CUSID LEFT OUTER JOIN " _
                        &"RTCode RTCode_2 ON RTLessorCustReturn.PAYCYCLE = RTCode_2.CODE AND " _
                        &"RTCode_2.KIND = 'M8'" _
                &"where RTLessorCustReturn.cusid='' "

  dataTable="RTLessorCustReturn"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorCustReturnD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustReturns.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustReturn.cusid='" & aryparmkey(0) & "' AND RTLessorCustReturn.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCustReturn.CUSID, RTLessorCustReturn.ENTRYNO, " _
                        &"RTLessorCust.CUSNC, RTLessorCustReturn.ENTRYNO, RTLessorCustReturn.APPLYDAT, RTLessorCustReturn.strbillingDAT, RTCode_2.CODENC, " _
                        &"RTCode_1.CODENC AS Expr1, RTLessorCustReturn.PERIOD, " _
                        &"RTLessorCustReturn.SECONDCASE, RTLessorCustReturn.AMT, " _
                        &"RTLessorCustReturn.REALAMT, RTLessorCustReturn.TARDAT, " _
                ...
                &"FROM    RTLessorCustReturn LEFT OUTER JOIN " _
                        ...
                        &"RTCode RTCode_2 ON RTLessorCustReturn.PAYCYCLE = RTCode_2.CODE AND " _
                        &"RTCode_2.KIND = 'M8' " _
                &"where RTLessorCustReturn.cusid='" & aryparmkey(0) & "' and " & searchqry 
  'end if
