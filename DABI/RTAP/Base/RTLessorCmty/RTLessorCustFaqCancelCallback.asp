...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   ELSE
      ...
      strSP="usp_RTLessorCustFaqCancelCallback " & "'" & key(0) & "'" & ",'" & key(1) & "','" & V(0) & "'" 
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "ET-City用戶客服單取消客服CALLBACK日期成功",0
...
<form name=frm1 method=post action=RTLessorcustFaqCancelCallBack.asp ID="Form1">
