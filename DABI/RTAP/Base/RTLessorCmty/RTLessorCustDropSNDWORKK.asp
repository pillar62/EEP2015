...
Sub SrEnvironment()
  ...
  functionOptProgram="/RTAP/REPORT/ETCity/RTLessorCustDropSNDWORKPV.asp;RTLessorCustDropSNDWORKF.asp;RTLessorCustDropSNDWORKUF.asp;RTLessorCustDropSNDWORKFR.asp;RTLessorCustDropSNDWORKdrop.asp;RTLessorCustDropSNDWORKdropC.asp;RTLessorCustDropSNDWORKLOGK.asp"
  ...
  sqlDelete="SELECT RTLessorCustDropSNDWORK.CUSID,RTLessorCustDropSNDWORK.entryno, RTLessorCustDropSNDWORK.PRTNO,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1))  as comqline, RTLessorCustDropSNDWORK.PRTNO, RTLessorCustDropSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorCustDropSNDWORK.closedat,RTLessorCustDropSNDWORK.unclosedat,RTLessorCustDropSNDWORK.BONUSCLOSEYM, RTLessorCustDropSNDWORK.BONUSFINCHK,RTLessorCustDropSNDWORK.batchno, RTLessorCustDropSNDWORK.STOCKCLOSEYM, RTLessorCustDropSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustDropSNDWORK.DROPDAT FROM RTLessorCustDropSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorCustDropSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorCustDropSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorCustDropSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorCustDropSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustDropSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"rtlessorcust on RTLessorCustDropSNDWORK.cusid=rtlessorcust.cusid where RTLessorCustDropSNDWORK.cusid='' "
  dataTable="RTLessorCustDropSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorCustDropSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustDropSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustDropSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorCustDropSNDWORK.entryno=" & aryparmkey(1) & " and  RTLessorCustDropSNDWORK.dropdat is null AND RTLessorCustDropSNDWORK.UNCLOSEDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorCustDropSNDWORK.CUSID,RTLessorCustDropSNDWORK.entryno, RTLessorCustDropSNDWORK.PRTNO,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1))  as comqline, RTLessorCustDropSNDWORK.PRTNO, RTLessorCustDropSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorCustDropSNDWORK.closedat,RTLessorCustDropSNDWORK.unclosedat,RTLessorCustDropSNDWORK.BONUSCLOSEYM, RTLessorCustDropSNDWORK.BONUSFINCHK,RTLessorCustDropSNDWORK.batchno, RTLessorCustDropSNDWORK.STOCKCLOSEYM, RTLessorCustDropSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustDropSNDWORK.DROPDAT  " _
           &"FROM RTLessorCustDropSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorCustDropSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorCustDropSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorCustDropSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorCustDropSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustDropSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"rtlessorcust on RTLessorCustDropSNDWORK.cusid=rtlessorcust.cusid " _
           &"where RTLessorCustDropSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorCustDropSNDWORK.ENTRYNO=" & aryparmkey(1) & " and " & searchqry & " " _
           &"GROUP BY  RTLessorCustDropSNDWORK.CUSID,RTLessorCustDropSNDWORK.ENTRYNO, RTLessorCustDropSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), rtlessorcust.COMQ1)) + '-' + rtrim(CONVERT(char(6), rtlessorcust.lineQ1)), " _
           &"RTLessorCustDropSNDWORK.PRTNO, RTLessorCustDropSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorCustDropSNDWORK.closedat, " _
           &"RTLessorCustDropSNDWORK.unclosedat, RTLessorCustDropSNDWORK.BONUSCLOSEYM, RTLessorCustDropSNDWORK.BONUSFINCHK, " _
           &"RTLessorCustDropSNDWORK.batchno, RTLessorCustDropSNDWORK.STOCKCLOSEYM, RTLessorCustDropSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustDropSNDWORK.DROPDAT "            
