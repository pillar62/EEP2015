...
Sub SrEnvironment()
  ...
  system="ET-City管理系統"
  title="ET-City用戶調整到期日資料維護"
  buttonName=" 新  增 ; 刪  除 ; 結  束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="結　　案;結案返轉;作　　廢;作廢返轉;歷史異動"
  functionOptProgram="RTLessorCustAdjDayF.ASP;RTLessorCustAdjDayFR.ASP;RTLessorCustAdjDayCANCEL.asp;RTLessorCustAdjDayCANCELRTN.asp;RTLessorCustAdjDayLOGK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;項次;調整<br>期數;調整<br>日數;　　調　整　原　因　　;結案日;結案員;作廢日;作廢員"
  sqlDelete="SELECT  RTLessorCustAdjDay.CUSID, RTLessorCustAdjDay.ENTRYNO, " _
                &"          RTLessorCustAdjDay.ADJPERIOD, RTLessorCustAdjDay.ADJDAY,  " _
                &"          RTLessorCustAdjDay.ADJCLOSEDAT, RTObj_2.CUSNC,  " _
                &"          RTLessorCustAdjDay.CANCELDAT, RTObj_1.CUSNC AS Expr1 " _
                &"FROM      RTEmployee RTEmployee_1 LEFT OUTER JOIN " _
                &"          RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID RIGHT OUTER JOIN " _
                &"          RTLessorCustAdjDay ON  " _
                &"          RTEmployee_1.EMPLY = RTLessorCustAdjDay.CANCELUSR LEFT OUTER JOIN " _
                &"          RTObj RTObj_2 RIGHT OUTER JOIN " _
                &"          RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON  " _
                &"          RTLessorCustAdjDay.ADJCLOSEUSR = RTEmployee_2.EMPLY " _
                &"where RTLessorCustAdjDay.CUSID='' "

  dataTable="RTLessorCustAdjDay"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorCustAdjDayD.asp"
  datawindowFeature=""
  ...
  colSplit=2
  keyListPageSize=50
  searchProg="RTLessorCustAdjDays.asp"
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" and RTLessorCustAdjDay.cusid='" & ARYPARMKEY(0) & "' AND RTLessorCustAdjDay.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCustAdjDay.CUSID, RTLessorCustAdjDay.ENTRYNO, " _
                &"          RTLessorCustAdjDay.ADJPERIOD, RTLessorCustAdjDay.ADJDAY,substring(RTLessorCustAdjDay.memo,1,10),  " _
                &"          RTLessorCustAdjDay.ADJCLOSEDAT, RTObj_2.CUSNC,  " _
                &"          RTLessorCustAdjDay.CANCELDAT, RTObj_1.CUSNC AS Expr1 " _
                &"FROM      RTEmployee RTEmployee_1 LEFT OUTER JOIN " _
                &"          RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID RIGHT OUTER JOIN " _
                ...
                &"          RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON  " _
                &"          RTLessorCustAdjDay.ADJCLOSEUSR = RTEmployee_2.EMPLY " _
                &"where RTLessorCustAdjDay.CUSID='" & ARYPARMKEY(0) & "' "
  'end if
