...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   ELSE
      ...
      strSP="usp_RTLessorCmtyLineFaqTRNSndwork "  & key(0) & "," & key(1) & ",'" & key(2) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorcmtylineFaqTRNSndwork.asp ID="Form1">
