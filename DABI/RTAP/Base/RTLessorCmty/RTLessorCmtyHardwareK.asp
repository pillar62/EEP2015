...
Sub runAUDI(accessMode,key)
    ...
    '其它未定義的就由RTLESSORCMTYHARDWAREK.ASP的欄位變數來決定
    ELSE
       prog="RTLessorCmtyLineHARDWARED.asp"
    END IF        
...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCmtyLineHARDWARELOGK.ASP;RTLessorCmtyLineFAQHARDWARELOGK"
  ...
  sqlDelete="SELECT RTLessorCmtyLineHARDWARE.comq1,RTLessorCmtyLineHARDWARE.lineq1, " _
         ...
         &"HBwarehouse.WARENAME,RTLessorCmtyLineHARDWARE.rcvprtno,RTLessorCmtyLineHARDWARE.rcvfinishdat, RTLessorCmtyLineHARDWARE.DROPDAT, RTLessorCmtyLineHARDWARE.DROPREASON, RTObj.CUSNC,RTLessorCmtyLineHARDWARE.BATCHNO,RTLessorCmtyLineHARDWARE.TARDAT " _
         ...
         &"WHERE RTLessorCmtyLineHARDWARE.COMQ1=0 "
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCmtyLinehardware.comq1=" & aryparmkey(0) & " and RTLessorCmtyLineHARDWARE.dropdat is null"
  ...
  sqlList="SELECT RTLessorCmtyLineHARDWARE.comq1,RTLessorCmtyLineHARDWARE.lineq1, " _
         &"'',RTLessorCmtyLineHARDWARE.PRTNO, RTLessorCmtyLineHARDWARE.seq,RTLessorCmtyLineHARDWARE.PRTNO, RTLessorCmtyLineHARDWARE.seq,RTLessorCmtyLinesndwork.SENDWORKDAT, " _
         &"RTProdH.PRODNC + '--' + RTProdD1.itemnc + '('+ RTProdD1.SPEC+')', RTLessorCmtyLineHARDWARE.QTY, RTLessorCmtyLineHARDWARE.amt, " _
         &"HBwarehouse.WARENAME,RTLessorCmtyLineHARDWARE.rcvprtno,RTLessorCmtyLineHARDWARE.rcvfinishdat,RTLessorCmtyLineHARDWARE.hostno,RTLessorCmtyLineHARDWARE.prelevelhostno,RTLessorCmtyLineHARDWARE.prelevelportno, RTLessorCmtyLineHARDWARE.DROPDAT, RTLessorCmtyLineHARDWARE.DROPREASON, RTObj.CUSNC,RTLessorCmtyLineHARDWARE.BATCHNO,RTLessorCmtyLineHARDWARE.TARDAT  " _
         &"FROM RTProdH RIGHT OUTER JOIN RTLessorCmtyLineHARDWARE LEFT OUTER JOIN " _
         &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON " _
         &"RTLessorCmtyLineHARDWARE.DROPUSR = RTEmployee.EMPLY LEFT OUTER JOIN " _
         &"HBwarehouse ON RTLessorCmtyLineHARDWARE.WAREHOUSE = HBwarehouse.WAREHOUSE LEFT OUTER " _
         ...
         &"WHERE RTLessorCmtyLinehardware.comq1=" & aryparmkey(0) & " and " &searchQry & " " _
         &"union " _
         &"SELECT RTLessorCmtyLineFAQHARDWARE.comq1,RTLessorCmtyLineFAQHARDWARE.lineq1,RTLessorCmtyLineFAQHARDWARE.faqno,RTLessorCmtyLineFAQHARDWARE.PRTNO," _
         &"RTLessorCmtyLineFAQHARDWARE.seq,RTLessorCmtyLineFAQHARDWARE.prtno,RTLessorCmtyLineFAQHARDWARE.seq, RTLessorCmtyLineFAQsndwork.SENDWORKDAT, RTProdH.PRODNC + '--' + RTProdD1.itemnc + '(' + RTProdD1.SPEC + ')', " _
         &"RTLessorCmtyLineFAQHARDWARE.QTY,RTLessorCmtyLineFAQHARDWARE.amt, HBwarehouse.WARENAME, RTLessorCmtyLineFAQHARDWARE.rcvprtno,RTLessorCmtyLineFAQHARDWARE.rcvfinishdat,RTLessorCmtyLinefaqHARDWARE.hostno,RTLessorCmtyLinefaqHARDWARE.prelevelhostno,RTLessorCmtyLinefaqHARDWARE.prelevelportno,RTLessorCmtyLineFAQHARDWARE.DROPDAT, " _
         &"RTLessorCmtyLineFAQHARDWARE.DROPREASON, RTObj.CUSNC, RTLessorCmtyLineFAQHARDWARE.BATCHNO, " _
         &"RTLessorCmtyLineFAQHARDWARE.TARDAT " _
         &"FROM RTProdH RIGHT OUTER JOIN RTLessorCmtyLineFAQHARDWARE LEFT OUTER JOIN RTObj INNER JOIN RTEmployee ON " _
         &"RTObj.CUSID = RTEmployee.CUSID ON RTLessorCmtyLineFAQHARDWARE.DROPUSR = RTEmployee.EMPLY LEFT OUTER JOIN " _
         &"HBwarehouse ON RTLessorCmtyLineFAQHARDWARE.WAREHOUSE = HBwarehouse.WAREHOUSE LEFT OUTER JOIN RTProdD1 ON " _
         &"RTLessorCmtyLineFAQHARDWARE.PRODNO = RTProdD1.PRODNO AND RTLessorCmtyLineFAQHARDWARE.ITEMNO = RTProdD1.ITEMNO ON " _
         &"RTProdH.PRODNO = RTLessorCmtyLineFAQHARDWARE.PRODNO LEFT OUTER JOIN RTLessorCmtyLineFAQsndwork ON " _
         &"RTLessorCmtyLineFAQHARDWARE.comq1 = RTLessorCmtyLineFAQsndwork.comq1 AND RTLessorCmtyLineFAQHARDWARE.lineq1 = RTLessorCmtyLineFAQsndwork.lineq1 " _
         &"AND RTLessorCmtyLineFAQHARDWARE.FAQNO = RTLessorCmtyLineFAQsndwork.FAQNO AND " _
         &"RTLessorCmtyLineFAQHARDWARE.prtno = RTLessorCmtyLineFAQsndwork.prtno " _
         &"wHERE RTLessorCmtyLineFAQHARDWARE.comq1 =" & aryparmkey(0) & " AND RTLessorCmtyLineFAQHARDWARE.dropdat IS NULL " _
