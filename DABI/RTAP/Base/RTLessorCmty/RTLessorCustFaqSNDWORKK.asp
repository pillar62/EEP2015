...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorCustHARDWARERCVK3.ASP;/REPORT/RTFaq/RTLessorCustFaqSNDWORKPV.asp;RTLessorCustFaqSNDWORKF.asp;RTLessorCustFaqSNDWORKUF.asp;RTLessorCustFaqSNDWORKFR.asp;RTLessorCustFaqSNDWORKdrop.asp;RTLessorCustFaqSNDWORKdropC.asp;RTLessorCustfaqhardwareK.asp;RTLessorCustFaqSNDWORKLOGK.asp"
  ...
  sqlDelete="SELECT RTLessorCustFaqSNDWORK.CUSID,RTLessorCustFaqSNDWORK.faqno, RTLessorCustFaqSNDWORK.PRTNO,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1))  as comqline, RTLessorCustFaqSNDWORK.PRTNO, RTLessorCustFaqSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorCustFaqSNDWORK.closedat,RTLessorCustFaqSNDWORK.unclosedat,RTLessorCustFaqSNDWORK.BONUSCLOSEYM, RTLessorCustFaqSNDWORK.BONUSFINCHK,RTLessorCustFaqSNDWORK.batchno, RTLessorCustFaqSNDWORK.STOCKCLOSEYM, RTLessorCustFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustFaqSNDWORK.DROPDAT FROM RTLessorCustFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorCustFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorCustFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorCustFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorCustFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"rtlessorcust on RTLessorCustFaqSNDWORK.cusid=rtlessorcust.cusid where RTLessorCustFaqSNDWORK.cusid='' "
  dataTable="RTLessorCustFaqSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorCustFaqSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCustFaqSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCustFaqSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorCustFaqSNDWORK.faqno='" & aryparmkey(1) & "' and  RTLessorCustFaqSNDWORK.dropdat is null and RTLessorCustFaqSNDWORK.unclosedat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorCustFaqSNDWORK.CUSID,RTLessorCustFaqSNDWORK.faqno, RTLessorCustFaqSNDWORK.PRTNO,rtrim(convert(char(6),rtlessorcust.COMQ1)) +'-'+ rtrim(convert(char(6),rtlessorcust.lineQ1))  as comqline, RTLessorCustFaqSNDWORK.PRTNO, RTLessorCustFaqSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorCustFaqSNDWORK.closedat,RTLessorCustFaqSNDWORK.unclosedat,RTLessorCustFaqSNDWORK.BONUSCLOSEYM, RTLessorCustFaqSNDWORK.BONUSFINCHK,RTLessorCustFaqSNDWORK.batchno, RTLessorCustFaqSNDWORK.STOCKCLOSEYM, RTLessorCustFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustFaqSNDWORK.DROPDAT ,SUM(CASE WHEN RTLessorCustfaqHARDWARE.dropdat IS NULL AND RTLessorCustfaqHARDWARE.QTY > 0 " _
           &"THEN RTLessorCustfaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorCustfaqHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTLessorCustfaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorCustfaqHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTLessorCustfaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorCustfaqHARDWARE.QTY ELSE 0 END), " _
           &"SUM(CASE WHEN RTLessorCustfaqHARDWARE.dropdat IS NULL AND RTLessorCustfaqHARDWARE.QTY > 0 THEN RTLessorCustfaqHARDWARE.QTY ELSE 0 END) - " _
           &"SUM(CASE WHEN RTLessorCustfaqHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTLessorCustfaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorCustfaqHARDWARE.QTY ELSE 0 END) " _
           &"FROM RTLessorCustFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorCustFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorCustFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorCustFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorCustFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorCustFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"rtlessorcust on RTLessorCustFaqSNDWORK.cusid=rtlessorcust.cusid LEFT OUTER JOIN " _
           &"RTLessorCustfaqHARDWARE ON RTLessorCustFaqSNDWORK.cusid = RTLessorCustfaqHARDWARE.CUSID AND " _
           &"RTLessorCustFaqSNDWORK.PRTNO = RTLessorCustfaqHARDWARE.PRTNO " _
           &"where RTLessorCustFaqSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorCustFaqSNDWORK.faqno='" & aryparmkey(1) & "' and " & searchqry & " " _
           &"GROUP BY  RTLessorCustFaqSNDWORK.CUSID,RTLessorCustFaqSNDWORK.faqno, RTLessorCustFaqSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), rtlessorcust.COMQ1)) + '-' + rtrim(CONVERT(char(6), rtlessorcust.lineQ1)), " _
           &"RTLessorCustFaqSNDWORK.PRTNO, RTLessorCustFaqSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorCustFaqSNDWORK.closedat, " _
           &"RTLessorCustFaqSNDWORK.unclosedat, RTLessorCustFaqSNDWORK.BONUSCLOSEYM, RTLessorCustFaqSNDWORK.BONUSFINCHK, " _
           &"RTLessorCustFaqSNDWORK.batchno, RTLessorCustFaqSNDWORK.STOCKCLOSEYM, RTLessorCustFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorCustFaqSNDWORK.DROPDAT "            
