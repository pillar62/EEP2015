 ...
 '  RESPONSE.END
   ...
   ELSE
     '呼叫store procedure更新相關檔案
      strSP="usp_RTLessorCmtylineDropClose "  & key(0) & "," & key(1) & "," & key(2) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=rtlessorcmtylinedropclose.asp ID="Form1">
