...
Sub SrEnvironment()
  ...
  sqlDelete="SELECT  RTLessorCmtyLineFaqH.comq1,RTLessorCmtyLineFaqH.lineq1, RTLessorCmtyLineFaqH.FAQNO, RTLessorCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorCmtyLineFaqs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorCmtyLineFaqH.comq1=" & aryparmkey(0) & " and RTLessorCmtyLineFaqH.lineq1=" & aryparmkey(1) & " and  RTLessorCmtyLineFaqH.canceldat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorCmtyLineFaqH.comq1,RTLessorCmtyLineFaqH.lineq1, RTLessorCmtyLineFaqH.FAQNO, RTLessorCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTCode ON RTLessorCmtyLineFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorCmtyLineFaqH.comq1=" & aryparmkey(0) & " and lineq1=" & aryparmkey(1) & " AND " & searchqry
