...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   ELSE
      ...
      strSP="usp_RTLessorCustdropTRNSndwork " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorcustdropTRNSndwork.asp ID="Form1">
