...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      'strSP="usp_RTPrjCustCancelrtn " & key(0) & "," & key(1) & ",'" & key(2) & "','" & V(0) & "'" 
      strSP ="update RTPrjCust set canceldat=null,cancelusr='' where comq1=" & key(0) & " and lineq1=" & key(1) &" and cusid ='"& key(2) &"' "
...
<form name=frm1 method=post action=RTPrjcustcancelrtn.asp ID="Form1">
