...
Sub SrEnvironment()
  ...
  functionOptProgram="RTPrjCustARClearRTN.asp"
  functionOptPrompt="Y"
  functionoptopen="1"
  If V(1)="Y" then
     accessMode="U"
  ...
  sqlDelete="SELECT CUSID, BATCHNO, SEQ,REALAMT,MDAT,RTOBJ.CUSNC , CANCELDAT, RTOBJ_1.CUSNC AS CUSNC1 " _
           ...
           &"RIGHT OUTER JOIN RTPrjCustARClear ON RTEmployee_1.EMPLY = RTPrjCustARClear.CANCELUSR LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTPrjCustARClear.MUSR = RTEmployee.EMPLY " _
           &"where RTPrjCustARClear.cusid='' "
  dataTable="RTPrjCustARClear"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTPrjCustARClear.CUSID='" & ARYPARMKEY(0) & "' AND RTPrjCustARClear.BATCHNO='" & ARYPARMKEY(1) & "'"
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31  then DAreaID="<>'*'"
         ...
         sqlList="SELECT  " _
                &"RTPrjCustARClear.CUSID, RTPrjCustARClear.BATCHNO, " _
                &"RTPrjCustARClear.SEQ, RTPrjCustARClear.REALAMT, " _
                &"RTPrjCustARClear.MDAT, RTObj_2.SHORTNC, " _
                &"RTPrjCustARClear.CANCELDAT, RTObj_1.SHORTNC AS Expr1 " _
                &"FROM    RTPrjCustARClear LEFT OUTER JOIN " _
                &"RTObj RTObj_1 INNER JOIN " _
                &"RTEmployee RTEmployee_1 ON RTObj_1.CUSID = RTEmployee_1.CUSID ON " _
                &"RTPrjCustARClear.CANCELUSR = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
                &"RTObj RTObj_2 INNER JOIN " _
                &"RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON " _
                &"RTPrjCustARClear.MUSR = RTEmployee_2.EMPLY " _
                &"where " & searchqry & " ORDER BY RTPrjCustARCLEAR.SEQ "
