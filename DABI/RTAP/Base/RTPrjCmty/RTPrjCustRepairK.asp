...
Sub SrEnvironment()
  ...
  functionOptProgram="RTPrjCustRepairTRNAR.asp;RTPrjCustRepairTRNFR.asp;RTPrjCustARK2.asp;RTPrjCustRepairDROP.asp;RTPrjCustRepairDROPC.asp"
  ...
  sqlDelete="SELECT  a.CUSID, a.ENTRYNO, c.CUSNC, a.ENTRYNO, a.APPLYDAT, b.CODENC, a.SETAMT, a.MOVEAMT, " &_
			...
			"FROM    RTPrjCustRepair a " &_
					"LEFT OUTER JOIN RTCode b ON a.PAYTYPE = b.CODE AND b.KIND = 'M9' " &_
					"LEFT OUTER JOIN RTPrjCust c ON a.CUSID = c.CUSID " &_
			"WHERE	a.cusid='' "

  dataTable="RTPrjCustRepair"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTPrjCustRepairD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTPrjcustRepairS.asp"
  '========================================================================================================
