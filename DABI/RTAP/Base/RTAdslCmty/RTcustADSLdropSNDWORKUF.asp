   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTcustADSLdropsndwork set UNCLOSEdat=getdate() ,CLOSEUSR='" & V(0) & "' where cusid='" & KEY(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' "
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "中華ADSL399退租戶拆機工單未完工結案成功",0
...
<form name=frm1 method=post action=RTcustADSLdropsndworkuf.asp ID="Form1">
