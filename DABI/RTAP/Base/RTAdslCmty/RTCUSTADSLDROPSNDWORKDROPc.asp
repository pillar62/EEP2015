   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTcustADSLdropsndwork set dropdat=null,dropdesc='退租拆機工單作廢返轉' where cusid='" & KEY(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' "
...
<form name=frm1 method=post action=RTcustADSLdropsndworkDROPC.asp ID="Form1">
