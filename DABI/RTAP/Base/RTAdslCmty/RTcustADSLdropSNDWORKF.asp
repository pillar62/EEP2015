   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTcustADSLdropsndwork set finishdat=getdate() ,CLOSEUSR='" & V(0) & "' where cusid='" & KEY(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' "
...
<form name=frm1 method=post action=RTcustADSLdropsndworkf.asp ID="Form1">
