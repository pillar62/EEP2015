...
'Session("oRpt").ParameterFields.GetItemByName("@bonusym").AddCurrentValue(CStr("200204"))
'Session("oRpt").ParameterFields.GetItemByName("@groupid").AddCurrentValue(CStr("%"))
