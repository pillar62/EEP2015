...
Session("oRpt").ParameterFields.GetItemByName("@batch").AddCurrentValue(CInt(V(0)))
Session("oRpt").ParameterFields.GetItemByName("@sdate").AddCurrentValue(CDate(V(1)))
Session("oRpt").ParameterFields.GetItemByName("@edate").AddCurrentValue(CDate(V(2)))
'Session("oRpt").ParameterFields.GetItemByName("@invno").AddCurrentValue(CStr(V(1)))
