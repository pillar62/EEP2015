...
Session("oRpt").ParameterFields.GetItemByName("@invdats").AddCurrentValue(Cdate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@invdate").AddCurrentValue(Cdate(v(1)))
Session("oRpt").ParameterFields.GetItemByName("@applydate").AddCurrentValue(Cdate(v(2)))
