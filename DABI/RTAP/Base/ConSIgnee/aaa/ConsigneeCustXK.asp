...
Sub SrEnvironment()
  ...
  'End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;客戶;申請單號;申請日;完工日;報竣日;撤銷日;裝機地址;聯絡電話;經銷商"
   sqlDelete="SELECT rtsparqaDslCustx.COMQ1,rtsparqaDslCustx.CUSID, rtsparqaDslCustx.ENTRYNO, RTObj_1.SHORTNC,rtsparqaDslCustx.orderno, " _
         &"rtsparqaDslCustx.formaldat, " _
         &"rtsparqaDslCustx.finishdat,rtsparqaDslCustx.Docketdat, " _
         &"rtsparqaDslCustx.dropdat, " _
         &"RTCOUNTY.CUTNC + rtsparqaDslCustx.TOWNSHIP2 + rtsparqaDslCustx.RADDR2, " _         
         &"rtsparqaDslCustx.HOME,RTObj_2.SHORTNC   " _ 
         &"FROM rtsparqaDslCustx LEFT OUTER JOIN " _
         &"RTObj RTObj_3 ON rtsparqaDslCustx.BUSSMAN = RTObj_3.CUSID LEFT OUTER JOIN " _
         &"RTObj RTObj_1 ON rtsparqaDslCustx.CUSID = RTObj_1.CUSID LEFT OUTER JOIN " _
         &"RTObj RTObj_2 ON rtsparqaDslCustx.STOCKID = RTObj_2.CUSID LEFT OUTER JOIN " _
         &"RTCounty ON rtsparqaDslCustx.CUTID2 = RTCounty.CUTID LEFT OUTER JOIN " _
         &"RTCode RTCode1 ON rtsparqaDslCustx.ISP = RTCode1.CODE AND " _
         &"RTCode1.KIND = 'C3' LEFT OUTER JOIN " _
         &"RTCode RTCode_1 ON rtsparqaDslCustx.SETTYPE = RTCode1.CODE AND " _
         &"RTCode1.KIND = 'A7'" _
         &"WHERE rtsparqaDslCustx.cusid='*' " _
         &"ORDER BY RTCOUNTY.CUTNC, rtsparqaDslCustx.TOWNSHIP2, rtsparqaDslCustx.RADDR2,rtobj_1.shortnc "
  ...
  searchQry="rtsparqaDslCustx.comq1 =" & aryparmkey(0)
  searchProg="self"
 ...
 ' ELSE
  sqllist="SELECT  rtsparqaDslCustx.comq1,rtsparqaDslCustx.CUSID, rtsparqaDslCustx.ENTRYNO, RTObj_1.SHORTNC,rtsparqaDslCustx.orderno, " _
         &"rtsparqaDslCustx.formaldat, " _
         &"rtsparqaDslCustx.finishdat,rtsparqaDslCustx.Docketdat, " _
         &"rtsparqaDslCustx.dropdat, " _         
         &"RTCOUNTY.CUTNC + rtsparqaDslCustx.TOWNSHIP2 + rtsparqaDslCustx.RADDR2, " _         
 ...
 ' Response.Write "sql=" & SQLLIST
  ...
  dsnxx="DSN=RTLib"
  sqlxx="select COMN from rtsparqaDslCMTYx where cutyid=" & session("COMQ1")
  connxx.Open dsnxx
