...
Sub SrEnvironment()
  ...
  formatName="none;none;社區名稱;客戶;對帳代碼;申請單號;申請日;完工日;報竣日;撤銷日;裝機地址;聯絡電話"
   sqlDelete="SELECT tsparqadslcust.CUSID, rtsparqadslcust.ENTRYNO, RTSparqAdslCmty.comn, "_
...
'         &"RTCOUNTY.CUTNC + SINGLECUSTADSL.TOWNSHIP2 + SINGLECUSTADSL.RADDR2, " _         
 ...
 '        &"ORDER BY RTCOUNTY.CUTNC, SINGLECUSTADSL.TOWNSHIP2, SINGLECUSTADSL.RADDR2,rtobj.shortnc "
  ...
  If searchQry="" Then
     searchShow="全部"
     searchQry=" rtsparqadslcust.CUSID<>'*' and RTSparqAdslCmty.Consignee ='" &Session("UserID")& "' "
  ELSE
     SEARCHFIRST=FALSE
  End If  
