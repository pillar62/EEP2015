...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   elseif isnull(RSXX("finishdat")) then
      endpgm="5"	'未完工
   ELSE
      strSP ="update RTSparqWagalySndWrk set closedat=null,closeusr='' WHERE workno='" & KEY(0) & "' "
      strSP =strSP & " update RTSparqWagalyCust set finishdat=null WHERE cusid='" & key(1) & "' "
...
<form name=frm1 method=post action=RTSparqWagalySndWrkFR.asp ID="Form1">
