...
<Fieldset STYLE="HEIGHT: 390px; LEFT: 16px; POSITION: absolute; TOP: 15px; WIDTH: 550px" ID=select0>
<LEGEND>轄區業務員選擇清單</LEGEND> 

	<FIELDSET STYLE="HEIGHT: 308px; LEFT: 16px; POSITION: absolute; TOP: 20px; WIDTH: 125px" ID=select1>
		<LEGEND>業務員</LEGEND>
		<SELECT id=lstOrder1 size=5 style="HEIGHT: 269px; LEFT: 10px; POSITION: absolute; TOP: 26px; WIDTH: 100px" >
			<%=s1%>
		</SELECT>
	</FIELDSET>&nbsp;
</Fieldset>
