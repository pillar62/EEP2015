...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT CUSID, ENTRYNO,STOCKID,BRANCH,BUSSMAN,BUSSID,SEX,BIRTHDAY, " _
             ...
             &"SETFEEDESC,orderno,ss365,REPLYDATE,Lookdat,formaldat,deliverdat,socialid,agree,haveroom,homestat,LOOKDESC,CHTSIGNDAT,SENDWORKING,WORKINGREPLY,cusno " _
...
<%  dim sexd1, sexd2
  ...
  <%s=""
   ...
   %>
        ...
        <td width="16%" height="25" bgcolor="silver"><input type="text" name="key11" size="10" value="<%=dspkey(11)%>" maxlength="5" <%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListdata" readonly></td>                                 
      </tr>                                 
      <tr>                                 
...
<%
   ...
   &nbsp;社區名稱<input type="text" name="key26" size="15" MAXLENGTH="30" value="<%=dspKey(26)%>" <%=fieldpa%><%=FIELDROLE(3)%><%=dataProtect%> class="dataListEntry">
