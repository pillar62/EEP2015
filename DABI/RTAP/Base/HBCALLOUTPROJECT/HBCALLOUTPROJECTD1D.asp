...
Sub SrEnvironment()
  DSN="DSN=RTLib"
  numberOfKey=2
  title="客服CALLOUT專案回覆類別資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT  SRVITEM, STAT,STATDESC FROM HBCALLOUTPROJECTd1 WHERE SRVITEM='*' "
  sqlList="SELECT  SRVITEM, STAT,STATDESC FROM HBCALLOUTPROJECTd1 WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="80%" bgcolor="#C0C0C0" colspan=3>
     <input CLASS=DATALISTENTRY name="KEY2" <%=dataprotect%> maxlength=100 size=70 style="TEXT-ALIGN: left" value
            ="<%=DSPKEY(2)%>"></td>
  </tr>
</table>
<%
