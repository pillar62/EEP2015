...
Sub SrEnvironment()
  ...
  functionOptName="作廢;作廢返轉"
  functionOptProgram="HBCotCustAddDrop.asp;HBCotCustAddDropC.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="單號;項次;客戶名稱;追件日;追件人員;　摘　　　　　　　　　　要;作廢日"
  sqlDelete="select a.caseno,a.entryno, d.cusnc, a.adddat, c.cusnc, a.addmemo, a.canceldat " &_
			"from RTPotCustD a " &_
			"left outer join RTEmployee b inner join RTObj c on c.cusid = b.cusid on b.emply = a.addusr " &_
			"inner join RTPotCustH d on d.caseno = a.caseno " &_
			"where a.caseno ='' "  

  dataTable="RTPotCustD"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="HBPotCustAddD.asp"
  datawindowFeature=""
...
'  End If
  ...
  sqlList=	"select a.caseno,a.entryno, d.cusnc, a.adddat, c.cusnc, a.addmemo, a.canceldat " &_
			"from RTPotCustD a " &_
			"left outer join RTEmployee b inner join RTObj c on c.cusid = b.cusid on b.emply = a.addusr " &_
			"inner join RTPotCustH d on d.caseno = a.caseno " &_
			"where a.caseno='" & aryparmkey(0) &"' "
