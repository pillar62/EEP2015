...
Sub SrEnvironment()
 ...
 ' buttonEnable="Y;Y;Y;Y;Y;Y"
  ...
  DSN="DSN=RTLib"
  debug36=false
  formatName="none;none;none;項次;客戶名稱;專案名稱;連絡日期;回覆狀態"
  sqlDelete="SELECT   HBCALLOUTH.COMQ1, HBCALLOUTH.COMTYPE, HBCALLOUTH.CUSID, " _
           &"HBCALLOUTH.ENTRYNO, RTObj.SHORTNC, HBCALLOUTPROJECT.SRVNAME,HBCALLOUTH.CONTACTDAT, " _
           &"HBCALLOUTPROJECTD1.STATDESC " _
           &"FROM             HBCALLOUTH INNER JOIN " _
           &"RTObj ON HBCALLOUTH.CUSID = RTObj.CUSID INNER JOIN " _
           &"HBCALLOUTPROJECT ON " _
           &"HBCALLOUTH.SRVITEM = HBCALLOUTPROJECT.SRVITEM INNER JOIN " _
           &"HBCALLOUTPROJECTD1 ON " _
           &"HBCALLOUTH.SRVITEM = HBCALLOUTPROJECTD1.SRVITEM AND " _
           &"HBCALLOUTH.STAT = HBCALLOUTPROJECTD1.STAT WHERE HBCALLOUTH.COMQ1=0 "
  dataTable="HBCALLOUTH"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  searchFirst=false
  If searchQry="" Then
     searchQry=" AND HBCALLOUTH.COMQ1=" & KEYXX(0) & " AND HBCALLOUTH.COMTYPE='" & KEYXX(1) & "' AND HBCALLOUTH.CUSID='" & KEYXX(2) & "' "
     searchShow="全部"
  End If
  sqllist="SELECT   HBCALLOUTH.COMQ1, HBCALLOUTH.COMTYPE, HBCALLOUTH.CUSID, " _
           &"HBCALLOUTH.ENTRYNO, RTObj.SHORTNC, HBCALLOUTPROJECT.SRVNAME,HBCALLOUTH.CONTACTDAT, " _
           &"HBCALLOUTPROJECTD1.STATDESC " _
           &"FROM             HBCALLOUTH INNER JOIN " _
           &"RTObj ON HBCALLOUTH.CUSID = RTObj.CUSID INNER JOIN " _
           ...
           &"HBCALLOUTPROJECTD1 ON " _
           &"HBCALLOUTH.SRVITEM = HBCALLOUTPROJECTD1.SRVITEM AND " _
           &"HBCALLOUTH.STAT = HBCALLOUTPROJECTD1.STAT WHERE HBCALLOUTH.COMQ1 <> 0 " & searchqry
