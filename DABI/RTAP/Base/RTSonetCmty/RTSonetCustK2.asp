...
Sub SrEnvironment()
  ...
  functionOptName="派工作業;設備保管收據列印;作　　廢;作廢返轉"
  functionOptProgram="RTSonetCustSndWrkK.asp;/RTAP/REPORT/Common/RTStorageReceiptSonet.asp;RTSonetCustCANCEL.asp;RTSonetCustCANCELRTN.asp"
  ...
  dataTable="RTSonetCust"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTSonetCustD.asp"
  datawindowFeature=""
  ...
  '-------------------------------------------------------------------------------------------
	sqlList="select a.comq1, a.lineq1, a.cusid, isnull(f.shortnc, e.cusnc), convert(varchar(6), a.comq1) +'-'+ convert(varchar(3),a.lineq1), c.comn, " &_
			...
			"	inner join RTSonetCmtyH c on b.comq1 = c.comq1 " &_
			...
			"	left outer join RTCode g on g.code = a.userrate and g.kind ='R3' " &_
