...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   'sqlYY="select COUNT(*) AS CNT FROM RTSonetCUST WHERE comq1=" & KEY(0) & " and lineq1=" & key(1) & " AND CANCELDAT IS NULL AND DROPDAT IS NULL AND STRBILLINGDAT IS NOT NULL "
   ...
   ELSE
      ...
      if wrktyp ="10" then
			strSP = strSP & " update RTSonetCmtyLine set hardwaredat='" & workingdat &"' where comq1=" &key(1)&" and lineq1 = " &key(2)
      elseif wrktyp ="07" then
			strSP = strSP & " update RTSonetCmtyLine set dropdat='" & workingdat &"', dropkind='" & linedroptyp &"' where comq1=" &key(1)&" and lineq1 = " &key(2)
	  end if
