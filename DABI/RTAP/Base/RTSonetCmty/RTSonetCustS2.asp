...
'----------經銷商
    S7=""
    rs.Open "select a.consignee, b.shortnc from RTSonetCmtyH a inner join RTObj b on a.consignee = b.cusid group by a.consignee, b.shortnc ",CONN
...
<body>
<table width="100%">
  <tr class=dataListTitle align=center>So-net用戶資料搜尋條件</td><tr>
</table>
