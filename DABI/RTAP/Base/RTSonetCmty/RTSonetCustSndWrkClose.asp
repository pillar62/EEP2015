...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   sqlYY="select * FROM RTSonetCUST WHERE comq1=" & KEY(1) & " and lineq1=" & key(2) & " and cusid='" & key(3) & "' "
   ...
   ELSE
      ...
      strSP="update RTSonetSndWrk set closedat=getdate(),closeusr='" &V(0)& "' where wrkno='" &key(0)&"' "
      if wrktyp ="02" then
			strSP = strSP & " update RTSonetCust set finishdat='" & finishdat &"' where comq1=" &key(1)&" and lineq1 = " &key(2)&" and cusid = '" &key(3) &"' "
      elseif wrktyp ="03" then
			strSP = strSP & " update RTSonetCust set overduedat='" & workingdat &"' where comq1=" &key(1)&" and lineq1 = " &key(2)&" and cusid = '" &key(3) &"' "
      elseif wrktyp ="04" then
			strSP = strSP & " update RTSonetCust set dropdat='" & workingdat &"' where comq1=" &key(1)&" and lineq1 = " &key(2)&" and cusid = '" &key(3) &"' "
      elseif wrktyp ="05" then
			strSP = strSP & " update RTSonetCust set overduedat=null, dropdat = null where comq1=" &key(1)&" and lineq1 = " &key(2)&" and cusid = '" &key(3) &"' "
	  end if
