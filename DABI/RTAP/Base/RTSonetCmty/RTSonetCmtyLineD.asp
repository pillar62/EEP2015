...
Sub SrEnvironment()
  ...
  sqlFormatDB=	"SELECT COMQ1, LINEQ1, CUTID, TOWNSHIP, RADDR, SUPPLYRANGE, ADDROTHER, " &_
				...
				"FROM RTSonetCmtyLine WHERE COMQ1=0 "
...
' -------------------------------------------------------------------------------------------- 
  ...
  -->
  <span id="tags1" class="dataListTagsOn">So-net主線資訊</span>
...
<table width="100%" border=1 cellPadding=0 cellSpacing=0 id="tag1">
	...
	<tr><td width="15%" class=dataListHEAD>申請人姓名</td>
	    <td width="35%" bgcolor="silver" >
	    	<% if len(trim(dspKey(21)))=0 and accessmode="A" then dspkey(21)="台灣碩網網路娛樂股份有限公司" %>
