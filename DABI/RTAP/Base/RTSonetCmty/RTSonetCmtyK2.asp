...
Sub SrEnvironment()
  ...
  functionOptProgram="RTSonetContractK2.asp;RTSonetcmtylineK2.asp;RTSonetCUSTK2.ASP"
  ...
  sqlDelete="select i_smallint, c_varchar, c_varchar, c_varchar, i_smallint, c_varchar, c_varchar, c_varchar, c_varchar, i_tinyint, i_tinyint, d_datetime " &_
  			" from RTTemplate"
  dataTable="RTSonetCmtyH"
  userDefineDelete="Yes"
  numberOfKey=1
  dataProg="RTSonetCmtyD.asp"
  datawindowFeature=""
...
' Open search program when first entry this keylist
  ...
  sqlList=	"select a.comq1, a.comn, b.cutnc, a.township, a.comcnt, isnull(c.shortnc, e.cusnc), " &_
			...
			"	from RTSonetCmtyH u inner join RTSonetCmtyLine v on u.comq1 = v.comq1 " &_
			...
			"	from RTSonetCmtyH o inner join RTSonetCust p on o.comq1 = p.comq1 " &_
