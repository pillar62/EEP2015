   ...
   if STOCKCLOSE <> "" then
     ...
     ELSE
      ...
      sqlyy="insert into RTSPARQADSLCMTYhardwarelog " _
           &"SELECT  CUTYID, PRTNO, ENTRYNO," & SEQ & ", GETDATE(),'D','" & V(0) & "', PRODNO, ITEMNO, QTY, DROPDAT, '設備作廢', WAREHOUSE, ASSETNO,DROPUSR, UNIT " _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTSPARQADSLCMTYHARDWARE set dropdat=getdate(),dropREASON='設備作廢' where CUTYID=" & KEY(0) & " and prtno='" & key(1) & "' and entryno=" & key(2)
