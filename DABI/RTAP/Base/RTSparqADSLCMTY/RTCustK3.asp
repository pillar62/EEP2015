...
Sub SrEnvironment()
  ...
  functionOptName="客訴處理;附加服務;繳款記錄;CALL-OUT"
  functionOptProgram="RTFaqK.ASP;RTSparqADSLcustextk.ASP;\WEBAP\RTAP\BASE\RTSPARQFINANCE\RTSparqFinanceK.ASP;/WEBAP/RTAP/BASE/HBCALLOUTPROJECT/RTCUSTOPTK.ASP"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;客戶;對帳代碼;申請單號;申請日;完工日;報竣日;撤銷日;裝機地址;聯絡電話;經銷商;COT;MDF1;MDF2"
   sqlDelete="SELECT rtsparqadslcust.COMQ1,rtsparqadslcust.CUSID, rtsparqadslcust.ENTRYNO, RTObj_1.SHORTNC, rtsparqadslcust.EXTTEL+'-'+rtsparqadslcust.SPHNNO,rtsparqadslcust.orderno, " _
         ...
         &"rtsparqadslcust.HOME,RTObj_2.SHORTNC,RTSparqADSLCust.COTPORT, RTSparqADSLCust.ANO, RTSparqADSLCust.BNO " _ 
