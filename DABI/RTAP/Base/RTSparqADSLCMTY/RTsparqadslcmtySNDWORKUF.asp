 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      sqlyy="insert into RTsparqadslcmtysndworklog " _ 
           &"SELECT   cutyid, PRTNO, " & ENTRYNO & ", GETDATE() ,'UF','" & V(0) & "',SENDWORKDAT, PRTUSR, ASSIGNENGINEER1, ASSIGNENGINEER2, " _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTsparqadslcmtysndwork set UNCLOSEdat=getdate() ,CLOSEUSR='" & V(0) & "' where cutyid=" & KEY(0) & " and prtno='" & key(1) & "' "
