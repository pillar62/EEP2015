...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   sqlxx="UPDATE RTSparqadslcust SET TCOMQ1=0  FROM RTSparqadslcust WHERE rtsparqadslcust.COMQ1='" & KEY(0) & "' AND rtsparqadslcust.CUSID='" & KEY(1) & "' and rtsparqadslcust.ENTRYNO=" & key(2) & " "
...
<form name=frm1 method=post action="RTCUSTLINEADJFLGCLR.asp" ID="Form1">
