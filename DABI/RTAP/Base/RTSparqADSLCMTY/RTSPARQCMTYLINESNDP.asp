...
<%
  reportname = "RTSPARQCMTYLINESNDP.rpt"
...
Session("oRpt").ParameterFields.GetItemByName("@prtno").AddCurrentValue(Cstr(keyary(1)))
Session("oRpt").ParameterFields.GetItemByName("@prtusr").AddCurrentValue(Cstr(keyary(2)))
