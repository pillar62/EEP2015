 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      sqlyy="insert into RTsparqadslcmtysndworklog " _
           &"SELECT   cutyid, PRTNO, " & ENTRYNO & ", getdate(), 'R','" &  v(0) & "', " _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTsparqadslcmtysndwork set dropdat=null,dropdesc='主線派工單作廢返轉' where cutyid=" & KEY(0)  & " and prtno='" & key(1) & "' "
   ...
   IF ENDPGM="1" THEN
      ...
      jmail.Subject =  "ADSL主線派工單︰" & KEY(1) & "，作廢返轉通知"
      jmail.priority = 1  
      body="<html><body><table border=1 width=""50%""><tr><td colspan=2>" _
      &"<H3  align=center>速博ADSL主線派工單作廢返轉通知</h3></td></tr>" _
