    ...
    select case exist(1)
      case "1"
         if Domain="T" or Domain="P" then
            usr=usr & " and rtemployee.tran2<>'10' and ((rtemployee.authlevel in('2','17') and rtemployee.dept in ('B100','B401','B600','B701','B108','B106','B107','B109')) or (rtemployee.authlevel in ('1','2') and rtemployee.dept in ('B700')))"
         ...
         elseif Domain="K" then
            usr=usr & " and rtemployee.authlevel in ('1','2') and rtemployee.tran2<>'10' and rtemployee.areaid='C4' "  
         else
            usr=usr & " and rtemployee.authlevel in ('2') and rtemployee.tran2<>'10' and rtemployee.dept='*' "           
         end if                  
      case "2"
         if Domain="T" then
            usr=usr & " and rtemployee.tran2<>'10' and rtemployee.dept='B500'  "
         else
