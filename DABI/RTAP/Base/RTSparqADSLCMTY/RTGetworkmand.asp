...
<% 'sales(0)="業務轄區" sales(1)="業務群組"
  ...
  DSN="DSN=RTLib"
  Conn.Open DSN
 '  &"WHERE RTSalesGroupREF.AREAID = '" &  sales(0) & "' AND RTSalesGroupREF.GROUPID = '" & sales(1) & "' " _
  sql="SELECT RTObj.CUSNC, RTSalesGroupREF.EMPLY " _
...
style="HEIGHT: 269px; LEFT: 10px; POSITION: absolute; TOP: 26px; WIDTH: 125px" >
<%=s1%>
</SELECT>
</FIELDSET>&nbsp; 
