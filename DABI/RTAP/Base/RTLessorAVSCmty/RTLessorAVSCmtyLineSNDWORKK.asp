...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustHardwareRCVK.ASP;/RTAP/REPORT/AvsCity/RTLessorAVSCmtyLineSNDWORKPV.asp;RTLessorAVSCmtyLineSNDWORKF.asp;RTLessorAVSCmtyLineSNDWORKUF.asp;RTLessorAVSCmtyLineSNDWORKFR.asp;RTLessorAVSCmtyLineSNDWORKdrop.asp;RTLessorAVSCmtyLineSNDWORKdropC.asp;RTLessorAVSCMTYLINEhardwareK.asp;RTLessorAVSCmtyLineSNDWORKLOGK.asp"
  ...
  sqlDelete="SELECT RTLessorAVSCmtyLineSNDWORK.comq1,RTLessorAVSCmtyLineSNDWORK.lineq1, RTLessorAVSCmtyLineSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVSCmtyLineSNDWORK.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVSCmtyLineSNDWORK.lineQ1))  as comqline, RTLessorAVSCmtyLineSNDWORK.PRTNO, RTLessorAVSCmtyLineSNDWORK.SENDWORKDAT, " _
           ...
           &"THEN RTLessorAVSCmtyLineHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCmtyLineHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTLessorAVSCmtyLineHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCmtyLineHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTLessorAVSCmtyLineHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCmtyLineHARDWARE.QTY ELSE 0 END), " _
           ...
           &"SUM(CASE WHEN RTLessorAVSCmtyLineHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTLessorAVSCmtyLineHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCmtyLineHARDWARE.QTY ELSE 0 END)  " _
           ...
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCmtyLineSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCmtyLineSNDWORK.cusid=RTLessorAVScust.cusid where RTLessorAVSCmtyLineSNDWORK.cusid='' "
  dataTable="RTLessorAVSCmtyLineSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorAVSCmtyLineSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCmtyLineSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  sqlYY="select * from RTCounty RIGHT OUTER JOIN RTLessorAVSCmtyLine ON  " _
       ...
       &"where RTLessorAVSCmtyLine.comq1=" & ARYPARMKEY(0) & " and lineq1=" & ARYPARMKEY(1)
  rsYY.Open sqlYY,connYY
  if not rsYY.EOF then
     comaddr=""
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLineSNDWORK.comq1='" & aryparmkey(0) & "' and RTLessorAVSCmtyLineSNDWORK.lineq1=" & aryparmkey(1) & " and  RTLessorAVSCmtyLineSNDWORK.dropdat is null AND RTLessorAVSCmtyLineSNDWORK.UNCLOSEDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorAVSCmtyLineSNDWORK.comq1,RTLessorAVSCmtyLineSNDWORK.lineq1, RTLessorAVSCmtyLineSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVSCmtyLineSNDWORK.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVSCmtyLineSNDWORK.lineQ1))  as comqline, RTLessorAVSCmtyLineSNDWORK.PRTNO,RTCODE_9.CODENC, RTLessorAVSCmtyLineSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorAVSCmtyLineSNDWORK.closedat,RTLessorAVSCmtyLineSNDWORK.unclosedat,RTLessorAVSCmtyLineSNDWORK.BONUSCLOSEYM, RTLessorAVSCmtyLineSNDWORK.BONUSFINCHK,RTLessorAVSCmtyLineSNDWORK.batchno, RTLessorAVSCmtyLineSNDWORK.STOCKCLOSEYM, RTLessorAVSCmtyLineSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCmtyLineSNDWORK.DROPDAT ,SUM(CASE WHEN RTLessorAVSCmtyLineHARDWARE.dropdat IS NULL AND RTLessorAVSCmtyLineHARDWARE.QTY > 0 " _
           &"THEN RTLessorAVSCmtyLineHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCmtyLineHARDWARE.dropdat IS NULL AND " _
           ...
           &"where RTLessorAVSCmtyLineSNDWORK.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineSNDWORK.lineq1=" & aryparmkey(1) & " and " & searchqry & " " _
           ...
           &"RTLessorAVSCmtyLineSNDWORK.DROPDAT "            
