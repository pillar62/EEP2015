...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustHardwareRCVK.ASP;RTLessorAVSCmtyLineSNDWORKPV.asp;RTLessorAVSCmtyLineSNDWORKF.asp;RTLessorAVSCmtyLineSNDWORKUF.asp;RTLessorAVSCmtyLineSNDWORKFR.asp;RTLessorAVSCmtyLineSNDWORKdrop.asp;RTLessorAVSCmtyLineSNDWORKdropC.asp;RTLessorAVSCMTYLINEhardwareK.asp;RTLessorAVSCmtyLineSNDWORKLOGK.asp"
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCmtyLineSNDWORKs2.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  '----
   searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLineSNDWORK.dropdat is null AND RTLessorAVSCmtyLineSNDWORK.UNCLOSEDAT IS NULL AND RTLessorAVSCmtyLineSNDWORK.CLOSEDAT IS NULL "
     searchShow="全部未完工"
  ELSE
     SEARCHFIRST=FALSE
  End If
