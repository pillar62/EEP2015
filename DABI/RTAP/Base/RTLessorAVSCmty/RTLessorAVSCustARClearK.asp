...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustARClearRTN.asp"
  functionOptPrompt="Y"
  functionoptopen="1"
  If V(1)="Y" then
     accessMode="U"
  ...
  sqlDelete="SELECT CUSID, BATCHNO, SEQ,REALAMT,MDAT,RTOBJ.CUSNC , CANCELDAT, RTOBJ_1.CUSNC AS CUSNC1 " _
           ...
           &"RIGHT OUTER JOIN RTLessorAVSCustARClear ON RTEmployee_1.EMPLY = RTLessorAVSCustARClear.CANCELUSR LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustARClear.MUSR = RTEmployee.EMPLY " _
           &"where RTLessorAVSCustARClear.cusid='' "
  dataTable="RTLessorAVSCustARClear"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustARClear.CUSID='" & ARYPARMKEY(0) & "' AND RTLessorAVSCustARClear.BATCHNO='" & ARYPARMKEY(1) & "'"
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31  then DAreaID="<>'*'"
         ...
         sqlList="SELECT  " _
                &"RTLessorAVSCustARClear.CUSID, RTLessorAVSCustARClear.BATCHNO, " _
                &"RTLessorAVSCustARClear.SEQ, RTLessorAVSCustARClear.REALAMT, " _
                &"RTLessorAVSCustARClear.MDAT, RTObj_2.SHORTNC, " _
                &"RTLessorAVSCustARClear.CANCELDAT, RTObj_1.SHORTNC AS Expr1 " _
                &"FROM    RTLessorAVSCustARClear LEFT OUTER JOIN " _
                &"RTObj RTObj_1 INNER JOIN " _
                &"RTEmployee RTEmployee_1 ON RTObj_1.CUSID = RTEmployee_1.CUSID ON " _
                &"RTLessorAVSCustARClear.CANCELUSR = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
                &"RTObj RTObj_2 INNER JOIN " _
                &"RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON " _
                &"RTLessorAVSCustARClear.MUSR = RTEmployee_2.EMPLY " _
                &"where " & searchqry & " ORDER BY RTLessorAVSCustARCLEAR.SEQ "
