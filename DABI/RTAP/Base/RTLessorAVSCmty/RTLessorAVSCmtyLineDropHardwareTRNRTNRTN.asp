...
if endpgm="" then
   ...
   strSP="usp_RTLessorAVSCmtyLineDropHardwareTRNRTNRTNExe " & "'" & XXRCVPRTNO & "','" & V(0) & "'" 
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City主線派工設備返轉物品移轉單作業成功",0
...
<form name=frm1 method=post action=RTLessorAVSCmtyLineDrophardwaretrnrTNrtn.asp ID="Form1">
