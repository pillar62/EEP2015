...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustFaqTRNSndwork " & "'" & key(0) & "'" & ",'" & key(1) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVScustFaqTRNSndwork.asp ID="Form1">
