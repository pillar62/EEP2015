...
<% KEY=SPLIT(REQUEST("KEY"),";")
  ...
  '當所屬派工單已計算庫存後，不可作廢之(stockcloseym<>'')
   sqlxx="select * FROM RTLessorAVSCmtylineFaqhardware WHERE comq1=" & key(0) & " and lineq1=" & key(1) & "  and FAQNO='" & key(2) & "' and prtno='" & key(3) & "' and seq=" & key(4)
   sqlyy="select * FROM RTLessorAVSCmtylineFaqsndwork WHERE comq1=" & key(0) & " and lineq1=" & key(1) & "  and FAQNO='" & key(2) & "' and prtno='" & key(3) & "' "
   ...
   rsyy.Open sqlyy,conn
    ...
    '已轉應收帳款不可作廢
     ...
     ELSE
      ...
      strSP="usp_RTLessorAVSCmtylineFaqHardwareDrop " & key(0) & "," & key(1) & ",'" & key(2) & "','" & key(3) & "'," & key(4)& ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVSCmtylineFaqhardwaredrop.asp ID="Form1">
