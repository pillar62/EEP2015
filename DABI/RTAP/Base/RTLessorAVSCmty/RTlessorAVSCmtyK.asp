...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCmtyLineK.asp;RTLessorAVSCUSTK1.ASP;RTLessorAVSCmtyHARDWAREK.asp;RTLessorAVSCmtyContractk.asp"
  ...
  sqlDelete="SELECT * FROM (SELECT        RTLessorAVSCmtyH.COMQ1, RTLessorAVSCmtyH.COMN, " _
           &"RTCounty.CUTNC , RTLessorAVSCmtyH.TOWNSHIP  " _
           &", RTLessorAVSCmtyH.COMCNT, " _
           &"RTLessorAVSCmtyH.UPDEBTDAT,SUM(CASE WHEN RTLessorAVSCmtyLine.COMQ1 IS NOT NULL " _
           &"THEN 1 ELSE 0 END) AS LINECNT,SUM(CASE WHEN RTLessorAVSCmtyLine.ADSLAPPLYDAT IS NOT NULL THEN 1 ELSE 0 END) AS APPLYCNT " _
           &"FROM RTLessorAVSCust INNER JOIN  RTLessorAVSCmtyLine ON RTLessorAVSCust.COMQ1 = RTLessorAVSCmtyLine.COMQ1 AND " _
           &"RTLessorAVSCust.LINEQ1 = RTLessorAVSCmtyLine.LINEQ1 RIGHT OUTER JOIN RTLessorAVSCmtyH ON RTLessorAVSCmtyLine.COMQ1 = RTLessorAVSCmtyH.COMQ1 LEFT OUTER JOIN " _
           &"RTCounty ON RTLessorAVSCmtyH.CUTID = RTCounty.CUTID GROUP BY  RTLessorAVSCmtyH.COMQ1,RTLessorAVSCmtyH.COMN, " _
           &"RTCounty.CUTNC, RTLessorAVSCmtyH.TOWNSHIP , RTLessorAVSCmtyH.COMCNT, RTLessorAVSCmtyH.AGREEDAT, " _
           &"RTLessorAVSCmtyH.UPDEBTDAT) a, " _
           &"(SELECT RTLessorAVSCmtyH.COMQ1,SUM(CASE WHEN RTLessorAVSCust.COMQ1 IS NOT NULL " _
           ...
           &"SUM(CASE WHEN RTLessorAVSCust.COMQ1 IS NOT NULL THEN 1 ELSE 0 END) - SUM(CASE WHEN dropdat IS NOT NULL and docketdat is null THEN 1 ELSE 0 END) - " _
           ...
           &"FROM RTLessorAVSCmtyH LEFT OUTER JOIN RTLessorAVSCust ON RTLessorAVSCmtyH.COMQ1=RTLessorAVSCust.COMQ1 " _
           &"GROUP BY RTLessorAVSCmtyH.COMQ1) B " _
           &"WHERE A.COMQ1 =B.COMQ1 "            
  dataTable="RTLessorAVSCmtyH"
  userDefineDelete="Yes"
  numberOfKey=1
  dataProg="RTLessorAVSCmtyD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCmtyS.asp"
  searchFirst=FALSE
  If searchQry="" AND searchQry2="" AND searchQry3="" Then
     searchQry=" RTLessorAVSCmtyH.ComQ1<>0 "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 if userlevel=31 then DAreaID="<>'*'"  
         sqlList="SELECT  a.comq1,a.comn,a.cutnc,a.township,a.comcnt,a.UPDEBTDAT,b.linecnt,b.applycnt,c.comq1,c.cuscnt,c.cancelcnt,c.dropcnt,c.finishcnt,c.docketcnt,c.diffcnt " _
           &"FROM (SELECT RTLessorAVSCmtyH.COMQ1, RTLessorAVSCmtyH.COMN, RTCounty.CUTNC, " _
           &"RTLessorAVSCmtyH.TOWNSHIP, RTLessorAVSCmtyH.COMCNT, RTLessorAVSCmtyH.UPDEBTDAT " _
           &"from RTLessorAVSCmtyLine RIGHT OUTER JOIN RTLessorAVSCmtyH ON RTLessorAVSCmtyLine.COMQ1 = RTLessorAVSCmtyH.COMQ1 LEFT OUTER JOIN " _
           &"RTCounty ON RTLessorAVSCmtyH.CUTID = RTCounty.CUTID INNER JOIN RTAREATOWNSHIP ON RTLessorAVSCmtyH.CUTID=RTAREATOWNSHIP.CUTID AND " _
           &"RTLessorAVSCmtyH.TOWNSHIP=RTAREATOWNSHiP.TOWNSHIP WHERE " & searchqry & " AND RTAREATOWNSHIP.AREAID " & DAREAID & " GROUP BY   RTLessorAVSCmtyH.COMQ1, " _
           &"RTLessorAVSCmtyH.COMN, RTCounty.CUTNC, RTLessorAVSCmtyH.TOWNSHIP, RTLessorAVSCmtyH.COMCNT, " _
           &"RTLessorAVSCmtyH.AGREEDAT, RTLessorAVSCmtyH.UPDEBTDAT " & SEARCHQRY2 & " ) a LEFT OUTER JOIN " _
           &"(SELECT RTLessorAVSCmtyH.COMQ1, RTLessorAVSCmtyH.COMN, RTCounty.CUTNC, " _
           &"RTLessorAVSCmtyH.TOWNSHIP, RTLessorAVSCmtyH.COMCNT, RTLessorAVSCmtyH.UPDEBTDAT, " _
           &"SUM(CASE WHEN RTLessorAVSCmtyLine.COMQ1 IS NOT NULL THEN 1 ELSE 0 END) AS LINECNT, " _
           &"SUM(CASE WHEN RTLessorAVSCmtyLine.ADSLAPPLYDAT IS NOT NULL THEN 1 ELSE 0 END) AS APPLYCNT " _
           &"from RTLessorAVSCmtyLine RIGHT OUTER JOIN RTLessorAVSCmtyH ON RTLessorAVSCmtyLine.COMQ1 = RTLessorAVSCmtyH.COMQ1 LEFT OUTER JOIN " _
           &"RTCounty ON RTLessorAVSCmtyH.CUTID = RTCounty.CUTID  WHERE " & searchqry & " GROUP BY   RTLessorAVSCmtyH.COMQ1, " _
           &"RTLessorAVSCmtyH.COMN, RTCounty.CUTNC, RTLessorAVSCmtyH.TOWNSHIP, RTLessorAVSCmtyH.COMCNT, " _
           &"RTLessorAVSCmtyH.AGREEDAT, RTLessorAVSCmtyH.UPDEBTDAT " & SEARCHQRY2 & " ) B ON A.COMQ1=B.COMQ1 LEFT OUTER JOIN " _
           &"(SELECT RTLessorAVSCmtyH.COMQ1,SUM(CASE WHEN RTLessorAVSCust.COMQ1 IS NOT NULL " _
           &"THEN 1 ELSE 0 END) AS cuscnt, SUM(CASE WHEN dropdat IS NOT NULL and docketdat is null THEN 1 ELSE 0 END) AS cancelCNT, " _
           &"SUM(CASE WHEN dropdat IS NOT NULL and docketdat is not null THEN 1 ELSE 0 END) AS dropCNT, " _
           &"SUM(CASE WHEN FINISHDAT IS NOT NULL THEN 1 ELSE 0 END) AS FINISHCNT, " _
           ...
           &"SUM(CASE WHEN DOCKETDAT IS NOT NULL THEN 1 ELSE 0 END) AS DIFFCNT " _
           &"FROM RTLessorAVSCmtyH LEFT OUTER JOIN RTLessorAVSCust ON RTLessorAVSCmtyH.COMQ1=RTLessorAVSCust.COMQ1 " _
           &"GROUP BY RTLessorAVSCmtyH.COMQ1 " & SEARCHQRY3 & " ) C ON A.COMQ1=C.COMQ1 " _
           &"ORDER BY A.COMQ1 "        
  '  End If  
  'end if
