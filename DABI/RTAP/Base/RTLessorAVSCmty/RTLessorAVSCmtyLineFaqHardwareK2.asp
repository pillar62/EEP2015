...
Sub SrEnvironment()
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLineFaqHARDWARE.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineFaqHARDWARE.lineq1=" & aryparmkey(1) & " and RTLessorAVSCmtyLineFaqHARDWARE.faqno='" & aryparmkey(2) & "' "
