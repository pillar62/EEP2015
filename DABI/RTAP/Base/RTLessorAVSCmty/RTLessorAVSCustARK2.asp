...
Sub SrEnvironment()
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVScustARS2.ASP"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
 ...
 set connYY=server.CreateObject("ADODB.connection")
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry="  RTLessorAVSCustAR.CUSID='" & ARYPARMKEY(0) & "' AND RTLessorAVSCustAR.CANCELDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31  then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCustAR.CUSID, " _
                ...
                &"RTCode ON RTLessorAVSCustAR.ARTYPE = RTCode.CODE AND " _
                &"RTCode.KIND = 'N2' " _
                &"where  RTLessorAVSCustAR.CUSID='" & ARYPARMKEY(0) & "' AND " & searchqry & " ORDER BY RTLessorAVSCustAR.cdat "
