...
Sub SrEnvironment()
  ...
  functionOptProgram="/RTAP/REPORT/AvsCity/RTLessorAVSCustDropSNDWORKPV.asp;RTLessorAVSCustDropSNDWORKF.asp;RTLessorAVSCustDropSNDWORKUF.asp;RTLessorAVSCustDropSNDWORKFR.asp;RTLessorAVSCustDropSNDWORKdrop.asp;RTLessorAVSCustDropSNDWORKdropC.asp;RTLessorAVSCustDropSNDWORKLOGK.asp"
  functionOptPrompt="Y;Y;Y;Y;Y;Y;N"
  If V(1)="Y" then
     accessMode="U"
  Else
     accessMode="I"
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;主線;派工單號;派工日期;列印人員;預定拆機員;實際拆機員;結案日;未完工結案日;none;none;應收帳款編號;none;none;作廢日"
  sqlDelete="SELECT RTLessorAVSCustDropSNDWORK.CUSID,RTLessorAVSCustDropSNDWORK.entryno, RTLessorAVSCustDropSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1))  as comqline, RTLessorAVSCustDropSNDWORK.PRTNO, RTLessorAVSCustDropSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorAVSCustDropSNDWORK.closedat,RTLessorAVSCustDropSNDWORK.unclosedat,RTLessorAVSCustDropSNDWORK.BONUSCLOSEYM, RTLessorAVSCustDropSNDWORK.BONUSFINCHK,RTLessorAVSCustDropSNDWORK.batchno, RTLessorAVSCustDropSNDWORK.STOCKCLOSEYM, RTLessorAVSCustDropSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustDropSNDWORK.DROPDAT FROM RTLessorAVSCustDropSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCustDropSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCustDropSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCustDropSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCustDropSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustDropSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCustDropSNDWORK.cusid=RTLessorAVScust.cusid where RTLessorAVSCustDropSNDWORK.cusid='' "
  dataTable="RTLessorAVSCustDropSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorAVSCustDropSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustDropSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustDropSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorAVSCustDropSNDWORK.entryno=" & aryparmkey(1) & " and  RTLessorAVSCustDropSNDWORK.dropdat is null AND RTLessorAVSCustDropSNDWORK.UNCLOSEDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorAVSCustDropSNDWORK.CUSID,RTLessorAVSCustDropSNDWORK.entryno, RTLessorAVSCustDropSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1))  as comqline, RTLessorAVSCustDropSNDWORK.PRTNO, RTLessorAVSCustDropSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorAVSCustDropSNDWORK.closedat,RTLessorAVSCustDropSNDWORK.unclosedat,RTLessorAVSCustDropSNDWORK.BONUSCLOSEYM, RTLessorAVSCustDropSNDWORK.BONUSFINCHK,RTLessorAVSCustDropSNDWORK.batchno, RTLessorAVSCustDropSNDWORK.STOCKCLOSEYM, RTLessorAVSCustDropSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustDropSNDWORK.DROPDAT  " _
           &"FROM RTLessorAVSCustDropSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCustDropSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCustDropSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCustDropSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCustDropSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustDropSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCustDropSNDWORK.cusid=RTLessorAVScust.cusid " _
           &"where RTLessorAVSCustDropSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorAVSCustDropSNDWORK.ENTRYNO=" & aryparmkey(1) & " and " & searchqry & " " _
           &"GROUP BY  RTLessorAVSCustDropSNDWORK.CUSID,RTLessorAVSCustDropSNDWORK.ENTRYNO, RTLessorAVSCustDropSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), RTLessorAVScust.COMQ1)) + '-' + rtrim(CONVERT(char(6), RTLessorAVScust.lineQ1)), " _
           &"RTLessorAVSCustDropSNDWORK.PRTNO, RTLessorAVSCustDropSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorAVSCustDropSNDWORK.closedat, " _
           &"RTLessorAVSCustDropSNDWORK.unclosedat, RTLessorAVSCustDropSNDWORK.BONUSCLOSEYM, RTLessorAVSCustDropSNDWORK.BONUSFINCHK, " _
           &"RTLessorAVSCustDropSNDWORK.batchno, RTLessorAVSCustDropSNDWORK.STOCKCLOSEYM, RTLessorAVSCustDropSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustDropSNDWORK.DROPDAT "            
