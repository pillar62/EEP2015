...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;客服單號;來電日;類型;　摘　　　　　　　　　　要;連絡電話;行動電話;none;派工日期;none;派工單號;列印日;派工結案;客服回覆;回覆人員;客服結案;結案員;作廢日;none;none;none;處理<br>天數"
  sqlDelete="SELECT  RTLessorAVSCustFaqH.CUSID, RTLessorAVSCustFaqH.FAQNO, RTLessorAVSCustFaqH.RCVDAT, RTCode.CODENC, " _
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustFaqs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustFaqH.cusid='" & aryparmkey(2) & "' and  RTLessorAVSCustFaqH.canceldat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCustFaqH.CUSID, RTLessorAVSCustFaqH.FAQNO, RTLessorAVSCustFaqH.RCVDAT, RTCode.CODENC, " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTCode ON RTLessorAVSCustFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorAVSCustFaqH.cusid='" & aryparmkey(2) & "' AND " & searchqry
