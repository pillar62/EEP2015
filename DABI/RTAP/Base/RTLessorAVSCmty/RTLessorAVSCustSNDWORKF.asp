...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   END IF
   RSXX.CLOSE
   '檢查該派工單下的設備是否皆已辦妥物品領用程序(先暫不檢查940217by edson)
...
if endpgm="" then
 ...
 '     endpgm="18"                
   ...
   ELSE
      ...
      'strSP="usp_RTLessorAVSCustARSndWorkF " & "'" & key(0) & "'" & ",'" & key(1) & "','" & V(0) & "'" & "," & tempperiod & "," & temprcvmoney & ",'" & temppaytype & "','" & tempcardno & "','"& key(2) & "','"& key(3) & "' "
