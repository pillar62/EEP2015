...
if endpgm="" then
   ...
   strSP="usp_RTLessorAVSCustHardwareTRNRCVRTNExe " & "'" & XXRCVPRTNO & "','" & V(0) & "'" 
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City主線派工設備返轉物品領用單作業成功",0
    ...
    elseIF frm1.htmlfld.value="10" then
       ...
       msgbox "無法執行主線派工設備返轉物品領用單作業,錯誤訊息" & "  " & frm1.htmlfld1.value
       Set winP=window.Opener
       winP.focus()
       window.close
    end if
...
<form name=frm1 method=post action=RTLessorAVSCmtylineFaqhardwaretrnrcvrtn.asp ID="Form1">
