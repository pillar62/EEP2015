...
' -------------------------------------------------------------------------------------------- 
  Sub SrSaveData(message)
   ...
   ' RESPONSE.WRITE SQL
          ...
          For i = 0 To numberOfField-1
              ...
              '   On Error Resume Next
                ...
                select case ucase(runpgm)   
                   ...
                   case ucase("/webap/rtap/base/RTLessorAVScmty/RTLessorAVSCustAdjdayd.asp")
                    'response.write "I=" & i & ";VALUE=" & dspkey(i) & "<BR>"
                       if i <> 1 then rs.Fields(i).Value=dspKey(i)    
                       if i=1 then
                         Set rsc=Server.CreateObject("ADODB.Recordset")
                         rsc.open "select max(entryno) AS entryno from RTLessorAVSCustAdjday where  CUSID='" & DSPKEY(0) & "' " ,conn
    ...
    if accessmode ="A" then
       runpgm=Request.ServerVariables("PATH_INFO")
       if ucase(runpgm)=ucase("/webap/rtap/base/RTLessorAVScmty/RTLessorAVSCustAdjdayd.asp") then
          rsc.open "select max(entryno) AS ENTRYNO from RTLessorAVSCustAdjday where  CUSID='" & DSPKEY(0) & "' " ,conn
          if not rsC.eof then
...
Sub SrCheckData(message,formValid)
  ...
  if accessmode="A" AND formValid=true then
     ...
     connxx.open DSN
     sqlxx="select count(*) as cnt from RTLessorAVScustadjday where cusid='" & dspkey(0) & "' and canceldat is null and ADJclosedat is null "
...
' -------------------------------------------------------------------------------------------- 
  ...
  -->
  <span id="tags1" class="dataListTagsOn">AVS-City用戶調整到期日資訊</span>
