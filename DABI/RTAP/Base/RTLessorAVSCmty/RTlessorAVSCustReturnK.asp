...
Sub SrEnvironment()
  ...
  system="AVS-City管理系統"
  title="AVS-City用戶復機作業"
  buttonName=" 新  增 ; 刪  除 ; 結  束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="收款派工;轉應收結案;返轉應收結案;應收應付; 作　廢 ;作廢返轉;歷史異動"
  functionOptProgram="RTLessorAVSCustReturnsndworkk.asp;RTLessorAVSCustReturnTRNAR.asp;RTLessorAVSCustReturnTRNFR.asp;RTLessorAVSCustARK2.asp;RTLessorAVSCustReturnDROP.asp;RTLessorAVSCustReturnDROPC.asp;RTLessorAVSCustReturnLOGK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;用戶名稱;復機序號;復機申請日;開始計費日;繳費週期;繳費方式;可用期別;第二戶;應收金額;實收金額;轉應收<br>帳款日;帳款編號;結案日;作廢日"
  sqlDelete="SELECT  RTLessorAVSCustReturn.CUSID, RTLessorAVSCustReturn.ENTRYNO, " _
                        &"RTLessorAVSCust.CUSNC, RTLessorAVSCustReturn.ENTRYNO, RTLessorAVSCustReturn.APPLYDAT, RTLessorAVSCustReturn.strbillingDAT, RTCode_2.CODENC, " _
                        &"RTCode_1.CODENC AS Expr1, RTLessorAVSCustReturn.PERIOD, " _
                        &"RTLessorAVSCustReturn.SECONDCASE, RTLessorAVSCustReturn.AMT, " _
                        &"RTLessorAVSCustReturn.REALAMT, RTLessorAVSCustReturn.TARDAT, " _
                        &"RTLessorAVSCustReturn.BATCHNO, RTLessorAVSCustReturn.FINISHDAT, " _
                        &"RTLessorAVSCustReturn.CANCELDAT " _
                &"FROM    RTLessorAVSCustReturn LEFT OUTER JOIN " _
                        &"RTCode RTCode_1 ON RTLessorAVSCustReturn.PAYTYPE = RTCode_1.CODE AND " _
                        &"RTCode_1.KIND = 'M9' LEFT OUTER JOIN " _
                        &"RTLessorAVSCust ON " _
                        &"RTLessorAVSCustReturn.CUSID = RTLessorAVSCust.CUSID LEFT OUTER JOIN " _
                        &"RTCode RTCode_2 ON RTLessorAVSCustReturn.PAYCYCLE = RTCode_2.CODE AND " _
                        &"RTCode_2.KIND = 'M8'" _
                &"where RTLessorAVSCustReturn.cusid='' "

  dataTable="RTLessorAVSCustReturn"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorAVSCustReturnD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustReturns.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustReturn.cusid='" & aryparmkey(0) & "' AND RTLessorAVSCustReturn.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCustReturn.CUSID, RTLessorAVSCustReturn.ENTRYNO, " _
                        &"RTLessorAVSCust.CUSNC, RTLessorAVSCustReturn.ENTRYNO, RTLessorAVSCustReturn.APPLYDAT, RTLessorAVSCustReturn.strbillingDAT, RTCode_2.CODENC, " _
                        &"RTCode_1.CODENC AS Expr1, RTLessorAVSCustReturn.PERIOD, " _
                        &"RTLessorAVSCustReturn.SECONDCASE, RTLessorAVSCustReturn.AMT, " _
                        &"RTLessorAVSCustReturn.REALAMT, RTLessorAVSCustReturn.TARDAT, " _
                ...
                &"FROM    RTLessorAVSCustReturn LEFT OUTER JOIN " _
                        ...
                        &"RTCode RTCode_2 ON RTLessorAVSCustReturn.PAYCYCLE = RTCode_2.CODE AND " _
                        &"RTCode_2.KIND = 'M8' " _
                &"where RTLessorAVSCustReturn.cusid='" & aryparmkey(0) & "' and " & searchqry 
  'end if
