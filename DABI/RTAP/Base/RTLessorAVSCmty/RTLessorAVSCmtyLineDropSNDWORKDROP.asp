...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlzz="select count(*) as cnt FROM RTLessorAVSCustRTNHardware WHERE prtno='" & KEY(3) & "' and canceldat is null "
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCmtylinedropSndworkDrop " & key(0) & "," & key(1) & "," & key(2) & ",'" & key(3) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVSCmtylinedropsndworkdrop.asp ID="Form1">
