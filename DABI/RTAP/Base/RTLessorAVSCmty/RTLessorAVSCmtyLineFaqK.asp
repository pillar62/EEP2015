...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;客服單號;來電日;類型;　摘　　　　　　　　　　要;none;none;none;派工日期;none;派工單號;列印日;派工結案;客服回覆;回覆人員;客服結案;結案員;作廢日;none;none;none;處理<br>天數"
  sqlDelete="SELECT  RTLessorAVSCmtyLineFaqH.comq1,RTLessorAVSCmtyLineFaqH.lineq1, RTLessorAVSCmtyLineFaqH.FAQNO, RTLessorAVSCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCmtyLineFaqs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLineFaqH.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineFaqH.lineq1=" & aryparmkey(1) & " and  RTLessorAVSCmtyLineFaqH.canceldat is null "
     searchShow="主線︰"& aryparmkey(0)& "-" & aryparmkey(1) & ",社區名稱︰" & COMN & ",主線位址︰" & COMADDR
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCmtyLineFaqH.comq1,RTLessorAVSCmtyLineFaqH.lineq1, RTLessorAVSCmtyLineFaqH.FAQNO, RTLessorAVSCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
                      ...
                      &"  RTCode ON RTLessorAVSCmtyLineFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorAVSCmtyLineFaqH.comq1=" & aryparmkey(0) & " and lineq1=" & aryparmkey(1) & " AND " & searchqry
