...
if endpgm="" then
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustDROPSndworkUF " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "','" & V(0) & "'"
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City用戶拆機派工單未完工結案成功",0
...
<form name=frm1 method=post action=RTLessorAVSCustDROPsndworkUf.asp ID="Form1">
