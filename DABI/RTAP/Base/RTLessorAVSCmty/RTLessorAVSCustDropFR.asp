...
'response.write sqlxx
   ...
   if LEN(TRIM(rsxx("batchno"))) = 0 THEN 
      ...
      strSP="usp_RTLessorAVSCustDROPFR " & "'" & key(0) & "'," & key(1) & ",'" & V(0) & "'" 
   ...
   ELSE
   sqlzz="select * FROM RTLessorAVSCUSTar WHERE CUSID='" & KEY(0) & "' and batchno='" & rsxx("batchno") & "' "
...
<form name=frm1 method=post action=RTLessorAVScustDROPfr.asp ID="Form1">
