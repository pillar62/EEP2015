...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   ...
   sqlyy="select count(*) as cnt FROM RTLessorAVSCustADJDAY WHERE  CUSID='" & KEY(0) & "' AND ENTRYNO >" & KEY(1) & " and canceldat is null "
 ...
 '  RESPONSE.END
   ...
   ELSE
     '呼叫store procedure更新相關檔案
      strSP="usp_RTLessorAVSCustAdjDayCancelrtn " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "'" 
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City用戶調整到期日數資料作廢返轉成功",0
...
<form name=frm1 method=post action=RTLessorAVSCustADJDAYCANCELrtn.asp ID="Form1">
