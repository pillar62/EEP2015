...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCUSTHARDWARERCVK4.ASP;RTLessorAVSCmtyLineFaqSNDWORKPV.asp;RTLessorAVSCmtyLineFaqSNDWORKF.asp;RTLessorAVSCmtyLineFaqSNDWORKUF.asp;RTLessorAVSCmtyLineFaqSNDWORKFR.asp;RTLessorAVSCmtyLineFaqSNDWORKdrop.asp;RTLessorAVSCmtyLineFaqSNDWORKdropC.asp;RTLessorAVSCmtyLinefaqhardwareK.asp;RTLessorAVSCmtyLineFaqSNDWORKLOGK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;主線;派工單號;派工日期;列印人員;預定施工員;實際施工員;結案日;未完工結案日;none;none;應收帳款編號;none;none;作廢日;設備數量;轉領用單數量;已領數量;待領數量"
  sqlDelete="SELECT RTLessorAVSCmtyLineFaqSNDWORK.comq1,RTLessorAVSCmtyLineFaqSNDWORK.lineq1,RTLessorAVSCmtyLineFaqSNDWORK.faqno, RTLessorAVSCmtyLineFaqSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVSCmtyLine.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVSCmtyLine.lineQ1))  as comqline, RTLessorAVSCmtyLineFaqSNDWORK.PRTNO, RTLessorAVSCmtyLineFaqSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorAVSCmtyLineFaqSNDWORK.closedat,RTLessorAVSCmtyLineFaqSNDWORK.unclosedat,RTLessorAVSCmtyLineFaqSNDWORK.BONUSCLOSEYM, RTLessorAVSCmtyLineFaqSNDWORK.BONUSFINCHK,RTLessorAVSCmtyLineFaqSNDWORK.batchno, RTLessorAVSCmtyLineFaqSNDWORK.STOCKCLOSEYM, RTLessorAVSCmtyLineFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.DROPDAT FROM RTLessorAVSCmtyLineFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCmtyLineFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCmtyLineFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCmtyLineFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCmtyLineFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCmtyLineFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVSCmtyLine on RTLessorAVSCmtyLineFaqSNDWORK.comq1=RTLessorAVSCmtyLine.comq1 where RTLessorAVSCmtyLineFaqSNDWORK.comq1=0 "
  dataTable="RTLessorAVSCmtyLineFaqSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=4
  dataProg="RTLessorAVSCmtyLineFaqSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCmtyLineFaqSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLineFaqSNDWORK.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineFaqSNDWORK.lineq1=" & aryparmkey(1) & " and RTLessorAVSCmtyLineFaqSNDWORK.faqno='" & aryparmkey(2) & "' and  RTLessorAVSCmtyLineFaqSNDWORK.dropdat is null and RTLessorAVSCmtyLineFaqSNDWORK.unclosedat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorAVSCmtyLineFaqSNDWORK.comq1,RTLessorAVSCmtyLineFaqSNDWORK.lineq1,RTLessorAVSCmtyLineFaqSNDWORK.faqno, RTLessorAVSCmtyLineFaqSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVSCmtyLine.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVSCmtyLine.lineQ1))  as comqline, RTLessorAVSCmtyLineFaqSNDWORK.PRTNO, RTLessorAVSCmtyLineFaqSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.closedat,RTLessorAVSCmtyLineFaqSNDWORK.unclosedat,RTLessorAVSCmtyLineFaqSNDWORK.BONUSCLOSEYM, RTLessorAVSCmtyLineFaqSNDWORK.BONUSFINCHK,RTLessorAVSCmtyLineFaqSNDWORK.batchno, RTLessorAVSCmtyLineFaqSNDWORK.STOCKCLOSEYM, RTLessorAVSCmtyLineFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.DROPDAT ,SUM(CASE WHEN RTLessorAVSCmtyLinefaqHARDWARE.dropdat IS NULL AND RTLessorAVSCmtyLinefaqHARDWARE.QTY > 0 " _
           &"THEN RTLessorAVSCmtyLinefaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCmtyLinefaqHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTLessorAVSCmtyLinefaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCmtyLinefaqHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTLessorAVSCmtyLinefaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCmtyLinefaqHARDWARE.QTY ELSE 0 END), " _
           &"SUM(CASE WHEN RTLessorAVSCmtyLinefaqHARDWARE.dropdat IS NULL AND RTLessorAVSCmtyLinefaqHARDWARE.QTY > 0 THEN RTLessorAVSCmtyLinefaqHARDWARE.QTY ELSE 0 END) - " _
           &"SUM(CASE WHEN RTLessorAVSCmtyLinefaqHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTLessorAVSCmtyLinefaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCmtyLinefaqHARDWARE.QTY ELSE 0 END) " _
           &"FROM RTLessorAVSCmtyLineFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCmtyLineFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCmtyLineFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCmtyLineFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCmtyLineFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCmtyLineFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVSCmtyLine on RTLessorAVSCmtyLineFaqSNDWORK.comq1=RTLessorAVSCmtyLine.comq1 and RTLessorAVSCmtyLine.lineq1=RTLessorAVSCmtyLineFaqSNDWORK.lineq1 LEFT OUTER JOIN " _
           &"RTLessorAVSCmtyLinefaqHARDWARE ON RTLessorAVSCmtyLineFaqSNDWORK.comq1 = RTLessorAVSCmtyLinefaqHARDWARE.comq1 and RTLessorAVSCmtyLineFaqSNDWORK.lineq1=RTLessorAVSCmtyLinefaqHARDWARE.lineq1 and RTLessorAVSCmtyLineFaqSNDWORK.faqno=RTLessorAVSCmtyLinefaqHARDWARE.faqno AND " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.PRTNO = RTLessorAVSCmtyLinefaqHARDWARE.PRTNO " _
           &"where RTLessorAVSCmtyLineFaqSNDWORK.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineFaqSNDWORK.lineq1=" & aryparmkey(1) & " and RTLessorAVSCmtyLineFaqSNDWORK.faqno='" & aryparmkey(2) & "' and " & searchqry & " " _
           &"GROUP BY  RTLessorAVSCmtyLineFaqSNDWORK.comq1,RTLessorAVSCmtyLineFaqSNDWORK.lineq1,RTLessorAVSCmtyLineFaqSNDWORK.faqno, RTLessorAVSCmtyLineFaqSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), RTLessorAVSCmtyLine.COMQ1)) + '-' + rtrim(CONVERT(char(6), RTLessorAVSCmtyLine.lineQ1)), " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.PRTNO, RTLessorAVSCmtyLineFaqSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorAVSCmtyLineFaqSNDWORK.closedat, " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.unclosedat, RTLessorAVSCmtyLineFaqSNDWORK.BONUSCLOSEYM, RTLessorAVSCmtyLineFaqSNDWORK.BONUSFINCHK, " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.batchno, RTLessorAVSCmtyLineFaqSNDWORK.STOCKCLOSEYM, RTLessorAVSCmtyLineFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCmtyLineFaqSNDWORK.DROPDAT "            
