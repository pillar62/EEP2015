...
if endpgm="" then
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCmtylinedropSndworkFR " & key(0) & "," & key(1) & "," & key(2) & ",'" & key(3) & "','" & V(0) & "'"
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City主線撤線派工單結案返轉成功",0
...
<form name=frm1 method=post action=RTLessorAVSCmtylinedropsndworkfr.asp ID="Form1">
