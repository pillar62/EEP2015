          ...
          For i = 0 To numberOfField-1
              ...
              '   On Error Resume Next
                ...
                select case ucase(runpgm)   
                   ...
                   case ucase("/webap/rtap/base/RTLessorAVScmty/RTLessorAVSCUSTHardwareRtnD.asp")
...
Sub SrEnvironment()
  ...
  sqlFormatDB="select RCVPRTNO,DATASRC,APPLYDAT,ASSIGNENGINEER,ASSIGNCONSIGNEE,REALENGINEER,REALCONSIGNEE,CLOSEDAT," _
             ...
             &"FROM RTLessorAVSCustRTNHardware WHERE RCVPRTNO='' "
  sqlList="select RCVPRTNO,DATASRC,APPLYDAT,ASSIGNENGINEER,ASSIGNCONSIGNEE,REALENGINEER,REALCONSIGNEE,CLOSEDAT," _
             &"CLOSEUSR, PRTNO, CANCELDAT, CANCELUSR, RCVUSR  FROM RTLessorAVSCustRTNHardware where " 
  userDefineKey="Yes"
  userDefineData="Yes"
  extDBField=0
