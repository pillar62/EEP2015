...
<% KEY=SPLIT(REQUEST("KEY"),";")
  ...
  ' response.write sqlyy
   ...
   sqlxx="select count(*) as CNT FROM RTLessorAVSCustReturnHardware WHERE CUSID='" & KEY(0) & "' AND entryno=" & key(1) & " and prtno='" & key(2) & "' and dropdat is null and rcvfinishdat is null "
...
if endpgm="" then
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustReturnARSndworkF " & "'" & key(0) & "'" & "," & key(1) & ",'" & key(2) & "','" & V(0) & "'" & "," & tempperiod & "," & temprcvmoney & ",'" & temppaytype & "','" & tempcardno & "'"
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City用戶收款派工單完工結案成功",0
