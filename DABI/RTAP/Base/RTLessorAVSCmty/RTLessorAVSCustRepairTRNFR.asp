...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   if endpgm="" then
      ...
      strSP="usp_RTLessorAVSCustRepairAR " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "', 'MR', '" & BATCHNOXX & "'"
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City用戶維修收款返轉應收結案作業成功",0
...
<form name=frm1 method=post action=RTLessorAVSCustRepairTRNFR.asp ID="Form1">
