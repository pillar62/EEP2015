...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlyy="select * FROM RTLessorAVSCUSTcont WHERE  CUSID='" & KEY(0) & "' and entryno=" & key(1)
  ' response.write sqlyy
   ...
   sqlxx="select count(*) as CNT FROM RTLessorAVSCUSTCONTHardware WHERE CUSID='" & KEY(0) & "' AND entryno=" & key(1) & " and prtno='" & key(2) & "' and dropdat is null and rcvfinishdat is null "
...
if endpgm="" then
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustContARSndworkF " & "'" & key(0) & "'" & "," & key(1) & ",'" & key(2) & "','" & V(0) & "'" & "," & tempperiod & "," & temprcvmoney & ",'" & temppaytype & "','" & tempcardno & "'"
...
<form name=frm1 method=post action=RTLessorAVScustContsndworkf.asp ID="Form1">
