...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustRepairTRNAR.asp;RTLessorAVSCustRepairTRNFR.asp;RTLessorAVSCustARK2.asp;RTLessorAVSCustRepairDROP.asp;RTLessorAVSCustRepairDROPC.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;用戶名稱;項次;派單日期;繳費方式;設定費;移機費;設備費;轉應收帳款日;帳款編號;結案日;作廢日"
  sqlDelete="SELECT  a.CUSID, a.ENTRYNO, c.CUSNC, a.ENTRYNO, a.APPLYDAT, b.CODENC, a.SETAMT, a.MOVEAMT, " &_
					"a.EQUIPAMT, a.TARDAT, a.BATCHNO, a.FINISHDAT, a.CANCELDAT " &_
			"FROM    RTLessorAVSCustRepair a " &_
					"LEFT OUTER JOIN RTCode b ON a.PAYTYPE = b.CODE AND b.KIND = 'M9' " &_
					"LEFT OUTER JOIN RTLessorAVSCust c ON a.CUSID = c.CUSID " &_
			"WHERE	a.cusid='' "

  dataTable="RTLessorAVSCustRepair"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorAVSCustRepairD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVScustRepairS.asp"
  '========================================================================================================
  ...
  '-------------------------------------------------------------------------------------------
   sqlList=	"SELECT  a.CUSID, a.ENTRYNO, c.CUSNC, a.ENTRYNO, a.APPLYDAT, b.CODENC, a.SETAMT, a.MOVEAMT, " &_
					"a.EQUIPAMT, a.TARDAT, a.BATCHNO, a.FINISHDAT, a.CANCELDAT " &_
			"FROM    RTLessorAVSCustRepair a " &_
					"LEFT OUTER JOIN RTCode b ON a.PAYTYPE = b.CODE AND b.KIND = 'M9' " &_
					"LEFT OUTER JOIN RTLessorAVSCust c ON a.CUSID = c.CUSID " &_
