...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   ...
   sqlxx="select * FROM RTLessorAVScusthardware WHERE cusid='" & key(0) & "'  and prtno='" & key(1) & "' and entryno=" & key(2)
   sqlyy="select * FROM RTLessorAVScustsndwork WHERE cusid='" & key(0) & "' and prtno='" & key(1) & "' "
   ...
   rsyy.Open sqlyy,conn
    endpgm="1"
     ...
     ELSE
        ...
        strSP="usp_RTLessorAVSCustHardwareDropC " & "'" & key(0) & "'" & ",'" & key(1) & "'," & key(2) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVScusthardwaredropc.asp ID="Form1">
