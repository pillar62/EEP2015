...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlyy="select count(*) as cnt FROM RTLessorAVSCUSThardware WHERE CUSID='" & KEY(0) & "' and prtno='" & key(1) & "' and dropdat is null and RCVPRTNO <> '' "
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustARSndworkUF " & "'" & key(0) & "'" & ",'" & key(1) & "','" & V(0) & "'" 
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City用戶裝機派工單未完工結案成功",0
...
<form name=frm1 method=post action=RTLessorAVScustsndworkUf.asp ID="Form1">
