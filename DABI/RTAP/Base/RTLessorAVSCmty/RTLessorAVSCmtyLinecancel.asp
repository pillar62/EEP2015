...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  On Error Resume Next
   ...
   sqlYY="select COUNT(*) AS CNT FROM RTLessorAVSCUST WHERE comq1=" & KEY(0) & " and lineq1=" & key(1) & " AND CANCELDAT IS NULL AND DROPDAT IS NULL AND (STRBILLINGDAT IS NOT NULL OR NEWBILLINGDAT IS NOT NULL OR DOCKETDAT IS NOT NULL OR FINISHDAT IS NOT NULL ) "
 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCMTYLINECANCEL " & key(0) & "," & key(1) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVSCMTYLINEDROP.asp ID="Form1">
