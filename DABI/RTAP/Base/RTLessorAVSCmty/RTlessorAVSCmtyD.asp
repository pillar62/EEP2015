...
' -------------------------------------------------------------------------------------------- 
  Sub SrSaveData(message)
          ...
          For i = 0 To numberOfField-1
              ...
              '   On Error Resume Next
                ...
                select case ucase(runpgm)   
                   ...
                   case ucase("/webap/rtap/base/RTLessorAVScmty/RTLessorAVSCmtyd.asp")
    ...
    if accessmode ="A" then
       runpgm=Request.ServerVariables("PATH_INFO")
       if ucase(runpgm)=ucase("/webap/rtap/base/RTLessorAVScmty/RTLessorAVSCmtyd.asp") then
          rs.open "select max(comq1) AS comq1 from RTLessorAVSCmtyH",conn
          if not rs.eof then
            dspkey(0)=rs("comq1")
          end if
          rs.close
...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT COMQ1, COMN, CUTID, TOWNSHIP,RADDR,RZONE,CUTID2,TOWNSHIP2,RADDR2,CUTID3,TOWNSHIP3,RADDR3,CUTID4,TOWNSHIP4,RADDR4, " _
             ...
             &"FROM RTLessorAVSCmtyH WHERE COMQ1=0 "
