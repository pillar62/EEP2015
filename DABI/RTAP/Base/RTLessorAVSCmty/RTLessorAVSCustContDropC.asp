 ...
 '  RESPONSE.END
  ...
  ELSE
     '呼叫store procedure更新相關檔案
      strSP="usp_RTLessorAVSCustContDropC " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVScustcontdropc.asp ID="Form1">
