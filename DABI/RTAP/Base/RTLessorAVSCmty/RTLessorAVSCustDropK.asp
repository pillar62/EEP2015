...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustDropTRNsndwork.asp;RTLessorAVSCustDropsndworkK.asp;RTLessorAVSCustDropF.asp;RTLessorAVSCustDropFR.asp;RTLessorAVSCustDropDrop.asp;RTLessorAVSCustDropDropC.asp;RTLessorAVSCustDropLogK.asp"
  ...
  sqlDelete="SELECT  RTLessorAVSCustDrop.CUSID,RTLessorAVSCustDrop.ENTRYNO,RTCODE.CODENC,RTLessorAVSCustDrop.APPLYDAT,RTLessorAVSCustDrop.ENDDAT, " _
                   &"RTLessorAVSCustDrop.FINISHDAT, RTObj.CUSNC, RTLessorAVSCustDrop.SNDPRTNO, RTLessorAVSCustDrop.SNDWORK,RTLessorAVSCustDrop.SNDWORKCLOSE, RTLessorAVSCustDrop.CANCELDAT, " _
           ...
           &"     where RTLessorAVSCustDrop.cusid='' "

  dataTable="RTLessorAVSCustDrop"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorAVSCustDropD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustDrops.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustDrop.cusid='" & aryparmkey(0) & "' AND RTLessorAVSCustDrop.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCustDrop.CUSID,RTLessorAVSCustDrop.ENTRYNO,RTCODE.CODENC,RTLessorAVSCustDrop.APPLYDAT,RTLessorAVSCustDrop.ENDDAT, " _
                   &"RTLessorAVSCustDrop.FINISHDAT, RTObj.CUSNC, RTLessorAVSCustDrop.SNDPRTNO, RTLessorAVSCustDrop.SNDWORK,RTLessorAVSCustDrop.SNDWORKCLOSE,RTLessorAVSCustDrop.tardat,RTLessorAVSCustDrop.batchno, RTLessorAVSCustDrop.CANCELDAT, " _
                   &"RTObj_1.CUSNC AS Expr1, RTObj_2.CUSNC AS Expr2, RTObj_3.CUSNC AS Expr3 " _
           &"FROM RTEmployee RTEmployee_3 INNER JOIN RTObj RTObj_3 ON RTEmployee_3.CUSID = RTObj_3.CUSID RIGHT OUTER JOIN " _
           &"     RTLessorAVSCustDrop ON RTEmployee_3.EMPLY = RTLessorAVSCustDrop.UUSR LEFT OUTER JOIN " _
           &"     RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_2 ON RTEmployee_2.CUSID = RTObj_2.CUSID ON " _
           ...
           &"     RTEmployee_1.EMPLY LEFT OUTER JOIN RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON " _
           &"     RTLessorAVSCustDrop.FUSR = RTEmployee.EMPLY  LEFT OUTER JOIN RTCODE ON RTLessorAVSCustDrop.DROPKIND=RTCODE.CODE AND RTCODE.KIND='N7' " _
           &"where RTLessorAVSCustDrop.cusid='" & aryparmkey(0) & "' and " & searchqry
  'end if
