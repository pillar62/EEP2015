...
<% KEY=SPLIT(REQUEST("KEY"),";")
  ...
  '已作廢
     ...
     ELSE
      ...
      strSP="usp_RTLessorAVSCustReturnHardwareDrop " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "'," & key(3) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVScustRETURNhardwaredrop.asp ID="Form1">
