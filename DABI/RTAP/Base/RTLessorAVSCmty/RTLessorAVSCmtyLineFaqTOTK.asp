...
Sub SrEnvironment()
  ...
  system="AVS-City管理系統"
  title="AVS-City主線客服單資料查詢"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="轉派工單;派工查詢;客服結案;結案返轉;客服作廢;作廢返轉;歷史異動"
  functionOptProgram="RTLessorAVSCmtyLineFaqTRNSndwork.ASP;RTLessorAVSCmtyLineFaqSndworkK.asp;RTLessorAVSCmtyLineFaqF.asp;RTLessorAVSCmtyLineFaqFR.asp;RTLessorAVSCmtyLineFaqDrop.asp;RTLessorAVSCmtyLineFaqDropC.asp;RTLessorAVSCmtyLineFaqLogK.asp"
  functionOptPrompt="Y;N;Y;Y;Y;Y;N"
  If V(1)="Y" then
     accessMode="U"
  Else
     accessMode="I"
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;客服單號;社區;主線;社區名稱;來電日;類型;　摘　　　　　　　　　　要;none;none;none;派工日期;none;派工單號;none;派工結案;客服回覆;none;客服結案;none;作廢日;none;none;none;處理<br>天數"
  sqlDelete="SELECT  RTLessorAVSCmtyLineFaqH.comq1,RTLessorAVSCmtyLineFaqH.lineq1, RTLessorAVSCmtyLineFaqH.FAQNO, RTLessorAVSCmtyLineFaqH.FAQNO,RTLessorAVSCmtyLineFaqH.comq1,rtrim(convert(char(6),RTLessorAVSCmtyLineFaqH.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVSCmtyLineFaqH.lineQ1)),RTLessorAVSCmtyH.comn, RTLessorAVSCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorAVSCmtyLineFaqH.MEMO, 12) AS Expr6, RTLessorAVSCmtyLineFaqH.CONTACTTEL, RTLessorAVSCmtyLineFaqH.MOBILE,  " _
                      ...
                      &"  RTLessorAVSCmtyLineFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorAVSCmtyLineFaqH.comq1=0 "
  dataTable="RTLessorAVSCmtyLineFaqH"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorAVSCmtyLineFaqD.asp"
  datawindowFeature=""
  searchWindowFeature="width=350,height=200,scrollbars=yes"
  optionWindowFeature=""
  detailWindowFeature=""
  diaWidth=""
  diaHeight=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCmtyLineFaqtots.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLineFaqH.comq1<>0 and  RTLessorAVSCmtyLineFaqH.canceldat is null and RTLessorAVSCmtyLineFaqH.finishdat is null "
     searchShow="全部未結案主線客服資料"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCmtyLineFaqH.comq1,RTLessorAVSCmtyLineFaqH.lineq1, RTLessorAVSCmtyLineFaqH.FAQNO, RTLessorAVSCmtyLineFaqH.FAQNO,RTLessorAVSCmtyLineFaqH.comq1,rtrim(convert(char(6),RTLessorAVSCmtyLineFaqH.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVSCmtyLineFaqH.lineQ1)),RTLessorAVSCmtyH.comn, RTLessorAVSCmtyLineFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorAVSCmtyLineFaqH.MEMO, 15) AS Expr6,RTLessorAVSCmtyLineFaqH.CONTACTTEL, RTLessorAVSCmtyLineFaqH.MOBILE,  " _
                      &"  RTLessorAVSCmtyLineFaqH.EMAIL,  " _
                      &"  RTLessorAVSCmtyLineFaqH.SNDWORK, RTObj_4.CUSNC,  " _
                      &"  RTLessorAVSCmtyLineFaqH.SNDPRTNO, RTLessorAVSCmtyLineFaqH.PRTDAT, RTLessorAVSCmtyLineFaqH.SNDCLOSEDAT,  " _
                      &"  RTLessorAVSCmtyLineFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                      ...
                      &"  RTLessorAVSCmtyLineFaqH.CANCELDAT, RTObj_1.CUSNC AS Expr3,  " _
                      &"   RTObj_2.CUSNC AS Expr4,  " _
                      &"  RTObj_3.CUSNC AS Expr5,case when RTLessorAVSCmtyLineFaqH.finishdat is null then datediff(dd,RTLessorAVSCmtyLineFaqH.rcvdat,getdate())+1 else datediff(dd,RTLessorAVSCmtyLineFaqH.rcvdat,RTLessorAVSCmtyLineFaqH.finishdat)+1 end " _
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      &"  RTObj RTObj_5 ON RTEmployee_5.CUSID = RTObj_5.CUSID RIGHT OUTER JOIN " _
                      &"  RTLessorAVSCmtyLineFaqH ON  " _
                      &"  RTEmployee_5.EMPLY = RTLessorAVSCmtyLineFaqH.CALLBACKUSR LEFT OUTER JOIN " _
                      ...
                      &"  RTLessorAVSCmtyLineFaqH.FUSR = RTEmployee_6.EMPLY LEFT OUTER JOIN " _
                      &"  RTCode ON RTLessorAVSCmtyLineFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4' left outer join RTLessorAVScmtyh on "  _
                      &"  RTLessorAVSCmtyLineFaqH.comq1=RTLessorAVScmtyh.comq1 left outer join RTLessorAVSCmtyLine on " _
                      &"  RTLessorAVSCmtyLineFaqH.comq1=RTLessorAVSCmtyLine.comq1 and RTLessorAVSCmtyLineFaqH.lineq1=RTLessorAVSCmtyLine.lineq1 " _
                      &"  where RTLessorAVSCmtyLineFaqH.comq1<>0 AND " & searchqry
