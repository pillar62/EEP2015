...
Sub SrEnvironment()
  ...
  system="AVS-City管理系統"
  title="AVS-City用戶維修派工單資料維護"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="物品領用單;列　　印;完工結案;結案返轉;作　　廢;作廢返轉;設備明細;歷史異動"
  functionOptProgram="RTLessorAVSCustHARDWARERCVK3.ASP;/REPORT/RTFaq/RTLessorAVSCustFaqSNDWORKPV.asp;RTLessorAVSCustFaqSNDWORKF.asp;RTLessorAVSCustFaqSNDWORKFR.asp;RTLessorAVSCustFaqSNDWORKdrop.asp;RTLessorAVSCustFaqSNDWORKdropC.asp;RTLessorAVSCustfaqhardwareK.asp;RTLessorAVSCustFaqSNDWORKLOGK.asp"
  ...
  sqlDelete="SELECT RTLessorAVSCustFaqSNDWORK.CUSID,RTLessorAVSCustFaqSNDWORK.faqno, RTLessorAVSCustFaqSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1))  as comqline, RTLessorAVSCustFaqSNDWORK.PRTNO, RTLessorAVSCustFaqSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorAVSCustFaqSNDWORK.closedat,RTLessorAVSCustFaqSNDWORK.unclosedat,RTLessorAVSCustFaqSNDWORK.BONUSCLOSEYM, RTLessorAVSCustFaqSNDWORK.BONUSFINCHK,RTLessorAVSCustFaqSNDWORK.batchno, RTLessorAVSCustFaqSNDWORK.STOCKCLOSEYM, RTLessorAVSCustFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustFaqSNDWORK.DROPDAT FROM RTLessorAVSCustFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCustFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCustFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCustFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCustFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCustFaqSNDWORK.cusid=RTLessorAVScust.cusid where RTLessorAVSCustFaqSNDWORK.cusid='' "
  dataTable="RTLessorAVSCustFaqSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="RTLessorAVSCustFaqSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustFaqSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustFaqSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorAVSCustFaqSNDWORK.faqno='" & aryparmkey(1) & "' and  RTLessorAVSCustFaqSNDWORK.dropdat is null and RTLessorAVSCustFaqSNDWORK.unclosedat is null "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorAVSCustFaqSNDWORK.CUSID,RTLessorAVSCustFaqSNDWORK.faqno, RTLessorAVSCustFaqSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1))  as comqline, RTLessorAVSCustFaqSNDWORK.PRTNO, RTLessorAVSCustFaqSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorAVSCustFaqSNDWORK.closedat,RTLessorAVSCustFaqSNDWORK.unclosedat,RTLessorAVSCustFaqSNDWORK.BONUSCLOSEYM, RTLessorAVSCustFaqSNDWORK.BONUSFINCHK,RTLessorAVSCustFaqSNDWORK.batchno, RTLessorAVSCustFaqSNDWORK.STOCKCLOSEYM, RTLessorAVSCustFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustFaqSNDWORK.DROPDAT ,SUM(CASE WHEN RTLessorAVSCustfaqHARDWARE.dropdat IS NULL AND RTLessorAVSCustfaqHARDWARE.QTY > 0 " _
           &"THEN RTLessorAVSCustfaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCustfaqHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTLessorAVSCustfaqHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCustfaqHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTLessorAVSCustfaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCustfaqHARDWARE.QTY ELSE 0 END), " _
           &"SUM(CASE WHEN RTLessorAVSCustfaqHARDWARE.dropdat IS NULL AND RTLessorAVSCustfaqHARDWARE.QTY > 0 THEN RTLessorAVSCustfaqHARDWARE.QTY ELSE 0 END) - " _
           &"SUM(CASE WHEN RTLessorAVSCustfaqHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTLessorAVSCustfaqHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCustfaqHARDWARE.QTY ELSE 0 END) " _
           &"FROM RTLessorAVSCustFaqSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCustFaqSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCustFaqSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCustFaqSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCustFaqSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustFaqSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCustFaqSNDWORK.cusid=RTLessorAVScust.cusid LEFT OUTER JOIN " _
           &"RTLessorAVSCustfaqHARDWARE ON RTLessorAVSCustFaqSNDWORK.cusid = RTLessorAVSCustfaqHARDWARE.CUSID AND " _
           &"RTLessorAVSCustFaqSNDWORK.PRTNO = RTLessorAVSCustfaqHARDWARE.PRTNO " _
           &"where RTLessorAVSCustFaqSNDWORK.cusid='" & aryparmkey(0) & "' and RTLessorAVSCustFaqSNDWORK.faqno='" & aryparmkey(1) & "' and " & searchqry & " " _
           &"GROUP BY  RTLessorAVSCustFaqSNDWORK.CUSID,RTLessorAVSCustFaqSNDWORK.faqno, RTLessorAVSCustFaqSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), RTLessorAVScust.COMQ1)) + '-' + rtrim(CONVERT(char(6), RTLessorAVScust.lineQ1)), " _
           &"RTLessorAVSCustFaqSNDWORK.PRTNO, RTLessorAVSCustFaqSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorAVSCustFaqSNDWORK.closedat, " _
           &"RTLessorAVSCustFaqSNDWORK.unclosedat, RTLessorAVSCustFaqSNDWORK.BONUSCLOSEYM, RTLessorAVSCustFaqSNDWORK.BONUSFINCHK, " _
           &"RTLessorAVSCustFaqSNDWORK.batchno, RTLessorAVSCustFaqSNDWORK.STOCKCLOSEYM, RTLessorAVSCustFaqSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustFaqSNDWORK.DROPDAT "            
