...
<% KEY=SPLIT(REQUEST("KEY"),";")
  ...
  elseif LEN(TRIM(RSYY("FINISHDAT"))) <> 0 then
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustDROPSndworkDrop " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVSCUSTDROPsndworkdrop.asp ID="Form1">
