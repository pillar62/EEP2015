...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustAdjDayF.ASP;RTLessorAVSCustAdjDayFR.ASP;RTLessorAVSCustAdjDayCANCEL.asp;RTLessorAVSCustAdjDayCANCELRTN.asp;RTLessorAVSCustAdjDayLOGK.asp"
  ...
  sqlDelete="SELECT  RTLessorAVSCustAdjDay.CUSID, RTLessorAVSCustAdjDay.ENTRYNO, " _
                &"          RTLessorAVSCustAdjDay.ADJPERIOD, RTLessorAVSCustAdjDay.ADJDAY,  " _
                &"          RTLessorAVSCustAdjDay.ADJCLOSEDAT, RTObj_2.CUSNC,  " _
                &"          RTLessorAVSCustAdjDay.CANCELDAT, RTObj_1.CUSNC AS Expr1 " _
                &"FROM      RTEmployee RTEmployee_1 LEFT OUTER JOIN " _
                &"          RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID RIGHT OUTER JOIN " _
                &"          RTLessorAVSCustAdjDay ON  " _
                &"          RTEmployee_1.EMPLY = RTLessorAVSCustAdjDay.CANCELUSR LEFT OUTER JOIN " _
                &"          RTObj RTObj_2 RIGHT OUTER JOIN " _
                &"          RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON  " _
                &"          RTLessorAVSCustAdjDay.ADJCLOSEUSR = RTEmployee_2.EMPLY " _
                &"where RTLessorAVSCustAdjDay.CUSID='' "

  dataTable="RTLessorAVSCustAdjDay"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorAVSCustAdjDayD.asp"
  datawindowFeature=""
  ...
  colSplit=2
  keyListPageSize=50
  searchProg="RTLessorAVSCustAdjDays.asp"
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" and RTLessorAVSCustAdjDay.cusid='" & ARYPARMKEY(0) & "' AND RTLessorAVSCustAdjDay.canceldat is null "
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCustAdjDay.CUSID, RTLessorAVSCustAdjDay.ENTRYNO, " _
                &"          RTLessorAVSCustAdjDay.ADJPERIOD, RTLessorAVSCustAdjDay.ADJDAY,substring(RTLessorAVSCustAdjDay.memo,1,10),  " _
                &"          RTLessorAVSCustAdjDay.ADJCLOSEDAT, RTObj_2.CUSNC,  " _
                &"          RTLessorAVSCustAdjDay.CANCELDAT, RTObj_1.CUSNC AS Expr1 " _
                &"FROM      RTEmployee RTEmployee_1 LEFT OUTER JOIN " _
                &"          RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID RIGHT OUTER JOIN " _
                ...
                &"          RTEmployee RTEmployee_2 ON RTObj_2.CUSID = RTEmployee_2.CUSID ON  " _
                &"          RTLessorAVSCustAdjDay.ADJCLOSEUSR = RTEmployee_2.EMPLY " _
                &"where RTLessorAVSCustAdjDay.CUSID='" & ARYPARMKEY(0) & "' "
  'end if
