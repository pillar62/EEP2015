...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCMTYLINEcontCANCEL " & key(0) & "," & key(1) & "," & key(2) & ",'" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVSCMTYLINEcontDROP.asp ID="Form1">
