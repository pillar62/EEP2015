...
sql="select cusnc from RTLessorAVScust where comq1=" & comq1 & " and lineq1=" & lineq1 & " and cusid='" & cusid & "'"
rs.open sql,conn
if rs.eof then
   cusnc=""
else
...
rs.close
sql="select comn from RTLessorAVScmtyh where comq1=" & comq1 
rs.open sql,conn
if rs.eof then
   comn=""
else
...
rs.close
'社區主線清單，並排除現有的主線序號
SQL="SELECT LINEQ1 FROM RTLessorAVSCmtyLine where comq1=" & comq1 & " and canceldat is null and dropdat is null and lineq1<>" & lineq1
rs.Open sql,CONN
if rs.eof then
...
Sub btn_onClick()
  ...
  if  Len(trim(s18))=0 Or s18="" then
     ...
     prog="RTLessorAVSCustMoveExe.asp" & "?key=" & comq1 & ";" & lineq1 & ";" & cusid & ";" & s18
...
<table ALIGN=CENTER width="80%">
  <tr class=dataListTitle align=center>AVS-City用戶資料移動</td><tr>
</table>
