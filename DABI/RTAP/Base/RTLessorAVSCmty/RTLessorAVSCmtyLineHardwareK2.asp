...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCmtyLineHARDWARELOGK.ASP;RTLessorAVSCmtyLinefaqHARDWARELOGK.ASP"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;none;<center>派工單號</center>;類型;<center>派工日期</center>;<center>設備名稱/規格</center>;<center>數量</center>;<center>金額</center>;<center>出庫別</center>;<center>作廢日期</center>;<center>作廢原因</center>;none;帳款編號;轉應收帳款日;領用單號;領用結案日"
  sqlDelete="SELECT RTLessorAVSCmtyLineHARDWARE.comq1,RTLessorAVSCmtyLineHARDWARE.lineq1, " _
         &"RTLessorAVSCmtyLineHARDWARE.PRTNO, RTLessorAVSCmtyLineHARDWARE.seq,'裝機',RTLessorAVSCmtyLinesndwork.SENDWORKDAT, " _
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCmtyLinehardware.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineHARDWARE.lineq1=" & aryparmkey(1) & " and RTLessorAVSCmtyLineHARDWARE.dropdat is null"
  ...
  sqlList="SELECT RTLessorAVSCmtyLineHARDWARE.comq1,RTLessorAVSCmtyLineHARDWARE.lineq1, " _
         &"'',RTLessorAVSCmtyLineHARDWARE.PRTNO, RTLessorAVSCmtyLineHARDWARE.seq,RTLessorAVSCmtyLineHARDWARE.PRTNO,'裝機',RTLessorAVSCmtyLinesndwork.SENDWORKDAT, " _
         ...
         &"WHERE RTLessorAVSCmtyLinehardware.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLineHARDWARE.lineq1=" & aryparmkey(1) & " and " &searchQry & "" _ 
         &" union " _
         &"SELECT RTLessorAVSCmtyLinefaqHARDWARE.comq1,RTLessorAVSCmtyLinefaqHARDWARE.lineq1, " _
         &"RTLessorAVSCmtyLinefaqHARDWARE.FAQNO,RTLessorAVSCmtyLinefaqHARDWARE.PRTNO, RTLessorAVSCmtyLinefaqHARDWARE.seq,RTLessorAVSCmtyLinefaqHARDWARE.PRTNO,'維修',RTLessorAVSCmtyLinefaqsndwork.SENDWORKDAT, " _
         ...
         &"WHERE RTLessorAVSCmtyLinefaqHARDWARE.comq1=" & aryparmkey(0) & " and RTLessorAVSCmtyLinefaqHARDWARE.lineq1=" & aryparmkey(1) _
