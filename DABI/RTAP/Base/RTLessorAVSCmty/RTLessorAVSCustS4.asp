...
srt1=srt1 &"<option value=""c.comn"">社區名稱</option>"
srt1=srt1 &"<option value=""a.cusnc"">用戶名稱</option>"
srt1=srt1 &"<option value=""addr"">用戶地址</option>"
srt1=srt1 &"<option value=""a.duedat"">到期日</option>"
srt1=srt1 &"<option value=""validdat"">可用日數</option>"
srt2=""
srt2=srt2 &"<option value=""""></option>"
srt2=srt2 &"<option value=""c.comn"">社區名稱</option>"
srt2=srt2 &"<option value=""a.cusnc"">用戶名稱</option>"
srt2=srt2 &"<option value=""addr"">用戶地址</option>"
srt2=srt2 &"<option value=""a.duedat"">到期日</option>"
srt2=srt2 &"<option value=""validdat"">可用日數</option>"
srt3=""
srt3=srt3 &"<option value=""""></option>"
srt3=srt3 &"<option value=""c.comn"">社區名稱</option>"
srt3=srt3 &"<option value=""a.cusnc"">用戶名稱</option>"
srt3=srt3 &"<option value=""addr"">用戶地址</option>"
srt3=srt3 &"<option value=""a.duedat"">到期日</option>"
srt3=srt3 &"<option value=""validdat"">可用日數</option>"
srt4=""
srt4=srt4 &"<option value=""""></option>"
srt4=srt4 &"<option value=""c.comn"">社區名稱</option>"
srt4=srt4 &"<option value=""a.cusnc"">用戶名稱</option>"
srt4=srt4 &"<option value=""addr"">用戶地址</option>"
srt4=srt4 &"<option value=""a.duedat"">到期日</option>"
srt4=srt4 &"<option value=""validdat"">可用日數</option>"
srt5=""
srt5=srt5 &"<option value=""""></option>"
srt5=srt5 &"<option value=""c.comn"">社區名稱</option>"
srt5=srt5 &"<option value=""a.cusnc"">用戶名稱</option>"
srt5=srt5 &"<option value=""addr"">用戶地址</option>"
srt5=srt5 &"<option value=""a.duedat"">到期日</option>"
...
Sub btn_onClick()
  ...
  if  (Len(trim(s14))=0 Or s14="") and (Len(trim(s15))=0 Or s15="") then
     ...
     t=t & " and a.duedat >= '" & s14 & " 00:00.000' and a.duedat  <= '" & s15 & " 23:59.997' "
  end if               
  '----社區序號
 ...
 '未完工
  ...
  ELSEIF s18ARY(0) = "2" THEN
     s=s &"  用戶進度:('" &s18ARY(1) & "') "
     t=t &" AND a.FINISHDAT IS NOT NULL AND  a.strbillingdat IS NULL "               
  '已退租
  ELSEIF s18ARY(0) = "3" THEN
     s=s &"  用戶進度:('" &s18ARY(1) & "') "
     t=t &" AND  a.dropdat IS NOT NULL AND a.strbillingdat IS not NULL "       
  '已作廢
  ELSEIF s18ARY(0) = "4" THEN
     s=s &"  用戶進度:('" &s18ARY(1) & "') "
     t=t &" AND  a.CANCELDAT IS NOT NULL AND a.finishdat IS NULL "                 
  End If              
  '排序
