...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   RSXX.OPEN SQLXX,conn
     ...
     ELSE
        ...
        strSP="usp_RTLessorAVSCustRepairAR " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "', 'MF', '' "
...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       msgbox "AVS-City用戶維修收款轉應收帳款成功",0
...
<form name=frm1 method=post action="RTLessorAVSCustRepairTRNAR.asp" ID="Form1">
