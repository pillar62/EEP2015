...
<table width="100%" cellPadding=0 cellSpacing=0>
 <tr><td width="10%"><input type="button" value="搜尋條件" class=keyListSearch onClick="runSearchOpt"></td>
     <td width="90%" class=keyListSearch2><%=searchShow%><%=countshow%>
         ...
         <input type="text" name="EMAILFIELDNO" value="<%=EMAILFIELDNO%>" style="display:none" readonly>
         </td>
 </tr>
</table>
<p>
...
Sub SrEnvironment()
  ...
  functionOptProgram="RTLessorAVSCustHardwareRCVK.ASP;/RTAP/REPORT/AvsCity/RTLessorAVSCustSNDWORKPV.asp;RTLessorAVSCustsndworkF.asp;RTLessorAVSCustsndworkUF.asp;RTLessorAVSCustsndworkFR.asp;RTLessorAVSCustsndworkdrop.asp;RTLessorAVSCustsndworkdropc.asp;RTLessorAVSCusthardwareK.asp;RTLessorAVSCustsndworkLOGK.asp"
  'functionOptProgram="RTLessorAVSCustHardwareRCVK.ASP;RTLessorAVSCustSNDWORKPV.asp;RTLessorAVSCustSndWorkOPT.asp;RTLessorAVSCustsndworkUF.asp;RTLessorAVSCustsndworkFR.asp;RTLessorAVSCustsndworkdrop.asp;RTLessorAVSCustsndworkdropc.asp;RTLessorAVSCusthardwareK.asp;RTLessorAVSCustsndworkLOGK.asp"
  functionOptPrompt="N;N;N;N;N;N;N;N;N"
  If V(1)="Y" then
     accessMode="U"
  Else
     accessMode="I"
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;主線;派工單號;完工日期;列印人員;預定施工員;實際施工員;結案日;未完工結案日;none;none;應收帳款編號;none;none;作廢日;設備數量;轉領用單數量;已領數量;待領數量"
  sqlDelete="SELECT RTLessorAVSCustSNDWORK.CUSID, RTLessorAVSCustSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1))  as comqline, RTLessorAVSCustSNDWORK.PRTNO, RTLessorAVSCustSNDWORK.SENDWORKDAT, " _
           ...
           &"RTLessorAVSCustSNDWORK.closedat,RTLessorAVSCustSNDWORK.unclosedat,RTLessorAVSCustSNDWORK.BONUSCLOSEYM, RTLessorAVSCustSNDWORK.BONUSFINCHK,RTLessorAVSCustSNDWORK.batchno, RTLessorAVSCustSNDWORK.STOCKCLOSEYM, RTLessorAVSCustSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustSNDWORK.DROPDAT FROM RTLessorAVSCustSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCustSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCustSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCustSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCustSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCustSNDWORK.cusid=RTLessorAVScust.cusid where RTLessorAVSCustSNDWORK.cusid='' "
  dataTable="RTLessorAVSCustSNDWORK"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorAVSCustSNDWORKD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustSNDWORKs.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustSNDWORK.cusid='" & aryparmkey(2) & "' and  RTLessorAVSCustSNDWORK.dropdat is null AND RTLessorAVSCustSNDWORK.UNCLOSEDAT IS NULL "
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT RTLessorAVSCustSNDWORK.CUSID, RTLessorAVSCustSNDWORK.PRTNO,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1))  as comqline, RTLessorAVSCustSNDWORK.PRTNO, RTLessorAVSCustSNDWORK.SENDWORKDAT, " _
           &"RTOBJ.CUSNC,CASE WHEN RTOBJ_2.SHORTNC <>'' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END,CASE WHEN RTOBJ_4.SHORTNC <>'' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, " _
           &"RTLessorAVSCustSNDWORK.closedat,RTLessorAVSCustSNDWORK.unclosedat,RTLessorAVSCustSNDWORK.BONUSCLOSEYM, RTLessorAVSCustSNDWORK.BONUSFINCHK,RTLessorAVSCustSNDWORK.batchno, RTLessorAVSCustSNDWORK.STOCKCLOSEYM, RTLessorAVSCustSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustSNDWORK.DROPDAT,SUM(CASE WHEN RTLessorAVSCustHARDWARE.dropdat IS NULL AND RTLessorAVSCustHARDWARE.QTY > 0 " _
           &"THEN RTLessorAVSCustHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCustHARDWARE.dropdat IS NULL AND " _
           &"RCVPRTNO <> '' THEN RTLessorAVSCustHARDWARE.QTY ELSE 0 END), SUM(CASE WHEN RTLessorAVSCustHARDWARE.dropdat IS NULL " _
           &"AND RCVPRTNO <> '' AND RTLessorAVSCustHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCustHARDWARE.QTY ELSE 0 END), " _
           &"SUM(CASE WHEN RTLessorAVSCustHARDWARE.dropdat IS NULL AND RTLessorAVSCustHARDWARE.QTY > 0 THEN RTLessorAVSCustHARDWARE.QTY ELSE 0 END) - " _
           &"SUM(CASE WHEN RTLessorAVSCustHARDWARE.dropdat IS NULL AND RCVPRTNO <> '' AND RTLessorAVSCustHARDWARE.rcvfinishdat IS NOT NULL THEN RTLessorAVSCustHARDWARE.QTY ELSE 0 END) " _
           &"FROM RTLessorAVSCustSNDWORK LEFT OUTER JOIN RTObj RTObj_4 ON RTLessorAVSCustSNDWORK.REALCONSIGNEE = RTObj_4.CUSID LEFT OUTER JOIN " _
           &"RTEmployee RTEmployee_2 INNER JOIN RTObj RTObj_3 ON RTEmployee_2.CUSID = RTObj_3.CUSID ON RTLessorAVSCustSNDWORK.REALENGINEER = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
           &"RTObj RTObj_2 ON RTLessorAVSCustSNDWORK.ASSIGNCONSIGNEE = RTObj_2.CUSID LEFT OUTER JOIN RTEmployee RTEmployee_1 INNER JOIN " _
           &"RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON RTLessorAVSCustSNDWORK.ASSIGNENGINEER = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
           &"RTObj INNER JOIN RTEmployee ON RTObj.CUSID = RTEmployee.CUSID ON RTLessorAVSCustSNDWORK.PRTUSR = RTEmployee.EMPLY left outer join " _
           &"RTLessorAVScust on RTLessorAVSCustSNDWORK.cusid=RTLessorAVScust.cusid LEFT OUTER JOIN " _
           &"RTLessorAVSCustHARDWARE ON RTLessorAVSCustSNDWORK.cusid = RTLessorAVSCustHARDWARE.CUSID AND " _
           &"RTLessorAVSCustSNDWORK.PRTNO = RTLessorAVSCustHARDWARE.PRTNO " _
           &"where RTLessorAVSCustSNDWORK.cusid='" & aryparmkey(2) & "' and " & searchqry & " " _
           &"GROUP BY  RTLessorAVSCustSNDWORK.CUSID, RTLessorAVSCustSNDWORK.PRTNO, " _
           &"rtrim(CONVERT(char(6), RTLessorAVScust.COMQ1)) + '-' + rtrim(CONVERT(char(6), RTLessorAVScust.lineQ1)), " _
           &"RTLessorAVSCustSNDWORK.PRTNO, RTLessorAVSCustSNDWORK.SENDWORKDAT, RTOBJ.CUSNC, " _
           &"CASE WHEN RTOBJ_2.SHORTNC <> '' THEN RTOBJ_2.SHORTNC ELSE RTOBJ_1.CUSNC END, " _
           &"CASE WHEN RTOBJ_4.SHORTNC <> '' THEN RTOBJ_4.SHORTNC ELSE RTOBJ_3.CUSNC END, RTLessorAVSCustSNDWORK.closedat, " _
           &"RTLessorAVSCustSNDWORK.unclosedat, RTLessorAVSCustSNDWORK.BONUSCLOSEYM, RTLessorAVSCustSNDWORK.BONUSFINCHK, " _
           &"RTLessorAVSCustSNDWORK.batchno, RTLessorAVSCustSNDWORK.STOCKCLOSEYM, RTLessorAVSCustSNDWORK.STOCKFINCHK, " _
           &"RTLessorAVSCustSNDWORK.DROPDAT "
