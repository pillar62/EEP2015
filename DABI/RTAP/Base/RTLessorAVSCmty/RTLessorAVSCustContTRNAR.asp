...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlzz="select count(*) as cnt FROM RTLessorAVSCUSTcontsndwork WHERE CUSID='" & KEY(0) & "' and entryno=" & key(1) & " and dropdat is null and unclosedat is null and closedat is null "
   ...
   RSzz.OPEN SQLzz,conn
    ...
    '不論繳費方式為何，若有存在收款派工單資料，則必須由派工單進行結案產生應收帳款
     ...
     ELSE
        ...
        strSP="usp_RTLessorAVSCustContTRNAR " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "'"
...
<form name=frm1 method=post action="RTLessorAVSCustContTRNAR.asp" ID="Form1">
