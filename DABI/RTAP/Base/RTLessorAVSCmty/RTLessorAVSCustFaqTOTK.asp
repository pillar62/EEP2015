...
Sub SrEnvironment()
  ...
  system="AVS-City管理系統"
  title="AVS-City用戶客服單資料查詢"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  'buttonEnable="Y;Y;Y;Y;Y;Y"
  functionOptName="轉派工單;派工查詢;押回覆日;取消回覆;客服結案;結案返轉;客服作廢;作廢返轉;歷史異動"
  functionOptProgram="RTLessorAVSCustFaqTRNSndwork.ASP;RTLessorAVSCustFaqSndworkK.asp;RTLessorAVSCustFaqCfmCallback.asp;RTLessorAVSCustFaqCancelCallback.asp;RTLessorAVSCustFaqF.asp;RTLessorAVSCustFaqFR.asp;RTLessorAVSCustFaqDrop.asp;RTLessorAVSCustFaqDropC.asp;RTLessorAVSCustFaqLogK.asp"
  functionOptPrompt="Y;N;Y;Y;Y;Y;Y;Y;N"
  If V(1)="Y" then
     accessMode="U"
  Else
     accessMode="I"
  End IF
  DSN="DSN=RTLib"
  formatName="none;客服單號;社區;主線;客戶;來電日;類型;摘　　　　　　　　要;連絡電話;行動電話;none;派工日期;none;派工單號;none;派工結案;客服回覆;none;客服結案;none;作廢日;none;none;none;處理<br>天數"
  sqlDelete="SELECT  RTLessorAVSCustFaqH.CUSID, RTLessorAVSCustFaqH.FAQNO,RTLessorAVSCmtyh.comn,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1)),RTLessorAVScust.cusnc, RTLessorAVSCustFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorAVSCustFaqH.MEMO, 12) AS Expr6, RTLessorAVSCustFaqH.CONTACTTEL, RTLessorAVSCustFaqH.MOBILE,  " _
                      &"  RTLessorAVSCustFaqH.EMAIL,  " _
                      &"  RTLessorAVSCustFaqH.SNDWORK, RTObj_4.CUSNC,  " _
                      &"  RTLessorAVSCustFaqH.SNDPRTNO, RTLessorAVSCustFaqH.PRTDAT, RTLessorAVSCustFaqH.SNDCLOSEDAT,  " _
                      &"  RTLessorAVSCustFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                      &"  RTLessorAVSCustFaqH.FINISHDAT, RTObj_6.CUSNC AS Expr2,  " _
                      &"  RTLessorAVSCustFaqH.CANCELDAT, RTObj_1.CUSNC AS Expr3,  " _
                ...
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      ...
                      &"  RTLessorAVSCustFaqH ON  " _
                      &"  RTEmployee_5.EMPLY = RTLessorAVSCustFaqH.CALLBACKUSR LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_4 INNER JOIN " _
                      &"  RTObj RTObj_4 ON RTEmployee_4.CUSID = RTObj_4.CUSID ON  " _ 
                      &"  RTLessorAVSCustFaqH.SNDUSR = RTEmployee_4.EMPLY LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_3 INNER JOIN " _
                      &"  RTObj RTObj_3 ON RTEmployee_3.CUSID = RTObj_3.CUSID ON  " _
                      &"  RTLessorAVSCustFaqH.UUSR = RTEmployee_3.EMPLY LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_2 INNER JOIN " _
                      &"  RTObj RTObj_2 ON RTEmployee_2.CUSID = RTObj_2.CUSID ON  " _
                      &"  RTLessorAVSCustFaqH.EUSR = RTEmployee_2.EMPLY LEFT OUTER JOIN " _
                      &"  RTEmployee RTEmployee_1 INNER JOIN " _
                      &"  RTObj RTObj_1 ON RTEmployee_1.CUSID = RTObj_1.CUSID ON  " _
                      &"  RTLessorAVSCustFaqH.CANCELUSR = RTEmployee_1.EMPLY LEFT OUTER JOIN " _
                      &"  RTObj RTObj_6 INNER JOIN " _
                      &"  RTEmployee RTEmployee_6 ON RTObj_6.CUSID = RTEmployee_6.CUSID ON  " _
                      &"  RTLessorAVSCustFaqH.FUSR = RTEmployee_6.EMPLY LEFT OUTER JOIN " _
                      &"  RTCode ON RTLessorAVSCustFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4'"  _
                      &"  where RTLessorAVSCustFaqH.cusid='' "
  dataTable="RTLessorAVSCustFaqH"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTLessorAVSCustFaqD.asp"
  datawindowFeature=""
  searchWindowFeature="width=350,height=220,scrollbars=yes"
  optionWindowFeature=""
  detailWindowFeature=""
  diaWidth=""
  diaHeight=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTLessorAVSCustFaqtots.asp"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" RTLessorAVSCustFaqH.cusid<>'' and  RTLessorAVSCustFaqH.canceldat is null and RTLessorAVSCustFaqH.finishdat is null "
     searchShow="全部未結案客服單" 
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  RTLessorAVSCustFaqH.CUSID, RTLessorAVSCustFaqH.FAQNO,RTLessorAVSCmtyh.comn,rtrim(convert(char(6),RTLessorAVScust.COMQ1)) +'-'+ rtrim(convert(char(6),RTLessorAVScust.lineQ1)),RTLessorAVScust.cusnc, RTLessorAVSCustFaqH.RCVDAT, RTCode.CODENC, " _
                      &"  LEFT(RTLessorAVSCustFaqH.MEMO, 15) AS Expr6,RTLessorAVSCustFaqH.CONTACTTEL, RTLessorAVSCustFaqH.MOBILE,  " _
                      &"  RTLessorAVSCustFaqH.EMAIL,  " _
                      &"  RTLessorAVSCustFaqH.SNDWORK, RTObj_4.CUSNC,  " _
                      &"  RTLessorAVSCustFaqH.SNDPRTNO, RTLessorAVSCustFaqH.PRTDAT, RTLessorAVSCustFaqH.SNDCLOSEDAT,  " _
                      &"  RTLessorAVSCustFaqH.CALLBACKDAT, RTObj_5.CUSNC AS Expr1,  " _
                      ...
                      &"  RTLessorAVSCustFaqH.CANCELDAT, RTObj_1.CUSNC AS Expr3,  " _
                      &"   RTObj_2.CUSNC AS Expr4,  " _
                      &"  RTObj_3.CUSNC AS Expr5,case when RTLessorAVSCustFaqH.finishdat is null then datediff(dd,RTLessorAVSCustFaqH.rcvdat,getdate())+1 else datediff(dd,RTLessorAVSCustFaqH.rcvdat,RTLessorAVSCustFaqH.finishdat)+1 end " _
                &"  FROM  RTEmployee RTEmployee_5 INNER JOIN " _
                      &"  RTObj RTObj_5 ON RTEmployee_5.CUSID = RTObj_5.CUSID RIGHT OUTER JOIN " _
                      &"  RTLessorAVSCustFaqH ON  " _
                      &"  RTEmployee_5.EMPLY = RTLessorAVSCustFaqH.CALLBACKUSR LEFT OUTER JOIN " _
                      ...
                      &"  RTLessorAVSCustFaqH.FUSR = RTEmployee_6.EMPLY LEFT OUTER JOIN " _
                      &"  RTCode ON RTLessorAVSCustFaqH.SERVICETYPE = RTCode.CODE AND  " _
                      &"  RTCode.KIND = 'N4' left outer join RTLessorAVScust on "  _
                      &"  RTLessorAVSCustFaqH.cusid=RTLessorAVScust.cusid left outer join RTLessorAVScmtyh on " _
                      &"  RTLessorAVScust.comq1=RTLessorAVScmtyh.comq1 " _
                      &"  where RTLessorAVSCustFaqH.cusid<>'' AND " & searchqry
