...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   sqlZZ="select MAX(prtno) AS XXPRTNO FROM RTLessorAVSCUSTDROPsndwork WHERE CUSID='" & KEY(0) & "' and ENTRYNO=" & key(1) 
   ...
   ELSE
      ...
      strSP="usp_RTLessorAVSCustDROPSndworkDropC " & "'" & key(0) & "'," & key(1) & ",'" & key(2) & "','" & V(0) & "'" 
...
<form name=frm1 method=post action=RTLessorAVScustDROPsndworkdropC.asp ID="Form1">
