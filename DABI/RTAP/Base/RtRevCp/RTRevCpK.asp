...
Sub SrEnvironment()
  ...
  DSN="DSN=RTLIb"
  formatName="none;none;none;社區名稱;客戶;電話;地址;收款金額;收款日;社區工程師;施工廠商;財務確認;列印批號;none"
  sqlDelete="SELECT a.comq1,a.cusid,a.entryno,b.COMN, c.CUSNC, a.HOME, c.RADDR1, a.ACTRCVAMT, a.SCHDAT, e.CUSNC, f.CUSNC, a.finrdfmdat, a.RCVDTLNO, a.rcvdtldat " _
  ...
  If searchQry="" Then
     ...
     searchShow="已列印"
  End If   
  sqlList="SELECT a.comq1,a.cusid,a.entryno,b.COMN, c.CUSNC, a.HOME, c.RADDR1, a.ACTRCVAMT, a.SCHDAT, e.CUSNC, f.CUSNC, a.finrdfmdat, a.rcvdtlno, a.rcvdtldat " _
           & "FROM   RTCust a, RTCmty b, RTObj c, RTCmtySale d, RTObj e, RTObj f " _
           & "WHERE  a.COMQ1 = b.COMQ1 " _
           & "AND a.CUSID = c.CUSID " _
           & "AND a.COMQ1 =d.COMQ1  AND GetDate() Between d.TDAT AND IsNull(d.EXDAT, '9999/12/31') " _
