...
Sub SrEnvironment()
  ...
  title="合約屬性樹資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT propertyid,propertynm FROM HBContractTreeH WHERE propertyid='*' "
  sqlList="SELECT  propertyid,propertynm FROM HBContractTreeH WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
  extDBField=0
...
Sub SrCheckData(message,formValid)
    IF len(trim(dspKey(0))) > 0 THEN DSPKEY(0)=UCASE(DSPKEY(0)) 
   ...
   elseif len(trim(dspKey(1))) = 0 Then
       formValid=False
       message="請輸入合約性質名稱"       
    ELSEIF DSPKEY(0) < "A" OR DSPKEY(0) > "Z" THEN
       formValid=False
       message="合約性質代號必須介於A-Z"
    End If        
End Sub
' -------------------------------------------------------------------------------------------- 
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20%" bgcolor="#008080"><font color="#FFFFFF">性質名稱</font></td>
    <td width="80%" bgcolor="#C0C0C0">
     <input class=dataListEntry name="KEY1" <%=dataprotect%> maxlength=20 size=20 style="TEXT-ALIGN: left" value
            ="<%=DSPKEY(1)%>"></td>
  </tr>
</table>
<%
