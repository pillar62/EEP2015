...
Sub SrEnvironment()
  DSN="DSN=RTLib"
  numberOfKey=3
  title="合約屬性樹(小類別)資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT propertyid,category1,category2,category2nm FROM HBContractTreeL2 WHERE propertyid='*' "
  sqlList="SELECT  propertyid,category1,category2,category2nm FROM HBContractTreeL2 WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  userDefineSave="Yes"  
  extDBField=0
...
Sub SrCheckData(message,formValid)
   ...
   elseif len(trim(dspKey(3))) = 0 Then
       formValid=False
       message="請輸入合約小類別名稱"       
    ELSEIF DSPKEY(2) < "00" OR DSPKEY(2) > "99" THEN
       formValid=False
       message="合約小類別代號必須介於00-99"
    End If        
End Sub
' -------------------------------------------------------------------------------------------- 
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       ...
       <tr><td width="30%" class=dataListHead>大類別代號</td>
       <td width="70%" bgcolor=silver>
           <input class=dataListDATA type="text" name="key1" <%=keyprotect%> size="10" 
           value="<%=dspKey(1)%>" readonly maxlength="2" ID="Text1"></td>
       </tr>       
       <tr><td width="30%" class=dataListHead>小類別代號</td>
       <td width="70%" bgcolor=silver>
           <input class=dataListEntry type="text" name="key2" <%=keyprotect%> size="10" 
           value="<%=dspKey(2)%>"  maxlength="2" ID="Text2"></td>
       </tr>              
      </table>
<%
End Sub
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20%" bgcolor="#008080"><font color="#FFFFFF">小類別名稱</font></td>
