...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;整線派工單號;項次;異動日期;異動類別;異動人員;派工日;作廢日;作廢人員;整線完工日;整線人員"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  If searchQry="" Then
     ...
     searchShow="社區序號︰"& aryparmkey(0) & ",社區名稱︰" & COMN & ",社區類別︰" & COMtype & ",整線派工單號︰" & aryparmkey(2)
  ELSE
     SEARCHFIRST=FALSE
  End If
