...
Sub SrEnvironment()
 ...
 ' buttonEnable="Y;Y;Y;Y;Y;Y"
  ...
  DSN="DSN=RTLib"
  debug36=false
  formatName="none;none;none;none;none;項次;退/欠/復機日;狀態;客戶名稱;專案名稱;連絡日期;回覆狀態"
  sqlDelete="SELECT       HBCustDropcallout.SERNO ,HBCustDropcallout.SEq, HBCustDrop.CUSID, HBCustDrop.ENTRYNO, HBCustDrop.CASETYPE,HBCustDropcallout.SERNO, HBCustDrop.APPLYDATC, " _
           &"             HBCustDrop.STATUS, HBCustDrop.CUSNC, " _
           &"             HBCALLOUTPROJECT.SRVNAME, " _
           &"             HBCUSTDROPCALLOUT.CONTACTDAT, " _
           &"             HBCALLOUTPROJECTD1.STATDESC " _
           &"from         HBCUSTDROPCALLOUT INNER JOIN " _
           &"             HBCALLOUTPROJECT ON " _
           &"             HBCUSTDROPCALLOUT.SRVITEM = HBCALLOUTPROJECT.SRVITEM INNER JOIN " _
           &"             HBCALLOUTPROJECTD1 ON " _
           &"             HBCUSTDROPCALLOUT.SRVITEM = HBCALLOUTPROJECTD1.SRVITEM AND " _
           &"             HBCUSTDROPCALLOUT.STAT = HBCALLOUTPROJECTD1.STAT INNER JOIN " _
           &"             HBCustDrop ON HBCUSTDROPCALLOUT.SERNO = HBCustDrop.SERNO WHERE HBCUSTDROPCALLOUT.serno=0 "
  dataTable="HBCUSTDROPCALLOUT"
  userDefineDelete="Yes"  
  extTable=""
  numberOfKey=2
  dataProg="HBCALLOUTD.asp"
  datawindowFeature=""
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  searchFirst=false
  If searchQry="" Then
     searchQry=" HBCUSTDROPCALLOUT.serno = " & aryparmkey(0)
     searchShow="全部"
  End If
  sqllist="SELECT       HBCustDropcallout.SERNO ,HBCustDropcallout.SEq , HBCustDrop.CUSID, HBCustDrop.ENTRYNO, HBCustDrop.CASETYPE,HBCustDropcallout.SERNO, HBCustDrop.APPLYDATC, " _
           &"             HBCustDrop.STATUS, HBCustDrop.CUSNC , " _
           &"             HBCALLOUTPROJECT.SRVNAME, " _
           &"             HBCUSTDROPCALLOUT.CONTACTDAT AS Expr8, " _
           &"             HBCALLOUTPROJECTD1.STATDESC " _
           &"from         HBCUSTDROPCALLOUT INNER JOIN " _
           &"             HBCALLOUTPROJECT ON " _
           &"             HBCUSTDROPCALLOUT.SRVITEM = HBCALLOUTPROJECT.SRVITEM INNER JOIN " _
           ...
           &"             HBCUSTDROPCALLOUT.SRVITEM = HBCALLOUTPROJECTD1.SRVITEM AND " _
           &"             HBCUSTDROPCALLOUT.STAT = HBCALLOUTPROJECTD1.STAT INNER JOIN " _
           &"             HBCustDrop ON HBCUSTDROPCALLOUT.SERNO = HBCustDrop.SERNO " _
           &"WHERE HBCUSTDROPCALLOUT.serno<> 0 and " & searchqry
