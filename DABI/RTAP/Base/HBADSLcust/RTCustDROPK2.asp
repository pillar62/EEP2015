...
Sub SrEnvironment()
  ...
  title="ADSL+Hi-Building客戶退租/欠拆/復機資料回報作業"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  ButtonEnable="N;N;Y;Y;Y;" & V(3)
  'buttonEnable="Y;Y;Y;Y;Y;N"
  functionOptName="回報確認;撤銷回報"
  functionOptProgram="RTCUSTDROPCFM.ASP;RTCUSTDROPCFMCANCEL.ASP"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;社區名稱;客戶名稱;none;退租日;HN號碼;狀態;更新MIS;欠轉退;CALL<br>OUT;同意繳<BR>款日;欠轉<BR>退日;實際<BR>拆機日;實際<BR>拆機員;回報"
 ...
 '          &"ORDER BY RTCust.CUSID, RTCust.ENTRYNO "
  ...
  datawindowFeature=""
  searchWindowFeature="width=700,height=550,scrollbars=yes"
  optionWindowFeature=""
  detailWindowFeature=""
  diaWidth=""
  diaHeight=""
  ...
  colSplit=1
  keyListPageSize=20
  searchProg="rtcustDROPs2.asp"
  searchFirst=false
  If searchQry="" Then
     searchQry=" HBCustDrop.CUSID <> '*' and hbCUSTDROP.actdrop is not null and hbCUSTDROP.reportback is null" & ";"
     searchqry2=" HBCustDrop.CUSID <> '*' and hbCUSTDROP.actdrop is not null and hbCUSTDROP.reportback is  null" & ";"
     searchShow="未回報客戶"
  ELSE
     searchFirst=False
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  sqllist="SELECT         HBCustDrop.serno,HBCustDrop.CUSID, HBCustDrop.ENTRYNO, HBCustDrop.CASETYPE, " _
         ...
         &"               HBCustDrop.CUSNO, HBCustDrop.STATUS, " _
         &"               HBCustDrop.UPDDATABASE,hbcustdrop.OVERDUEDROP, " _
         &"               SUM(CASE WHEN HBCUSTDROPCALLOUT.SERNO IS NOT NULL THEN 1 ELSE 0 END), HBCustDrop.AGREEPAYDAT, " _
         &"               HBCustDrop.OVERDUETNSDAT, HBCustDrop.ACTDROP, " _
         &"               RTObj.CUSNC AS Expr2,hbcustdrop.REPORTBACK " _
         ...
         &"WHERE          HBCustDrop.ACTDROP is not null AND HBCUSTDROP.CASETYPE  IN ( '1','4') AND flag='' and " & SEARCHQRYary(0) & " AND RTAREA.AREAID " & DAREAID  _
         ...
         &"               HBCustDrop.OVERDUETNSDAT, HBCustDrop.ACTDROP, RTObj.CUSNC,hbcustdrop.REPORTBACK " & searchqryary(1) & " " _
         &" UNION " _
         ...
         &"               + '/' + CONVERT(char(4), DATEPART(day, HBCustDrop.APPLYDAT)) AS applydat, " _
         &"               HBCustDrop.CUSNO, HBCustDrop.STATUS, " _
         &"               HBCustDrop.UPDDATABASE,hbcustdrop.OVERDUEDROP, SUM(CASE WHEN HBCUSTDROPCALLOUT.SERNO IS NOT NULL THEN 1 ELSE 0 END), " _
         &"               HBCustDrop.AGREEPAYDAT, " _
         &"               HBCustDrop.OVERDUETNSDAT, HBCustDrop.ACTDROP, " _
         &"               RTObj.CUSNC AS Expr2,hbcustdrop.REPORTBACK " _
         ...
         &"WHERE          HBCustDrop.ACTDROP is not null and HBCUSTDROP.CASETYPE = '2' AND flag='' and " & SEARCHQRYary2(0) & " AND RTAREA.AREAID " & DAREAID  _
         &" GROUP BY  HBCustDrop.SERNO, HBCustDrop.CUSID, HBCustDrop.ENTRYNO, " _
         ...
         &"               HBCustDrop.UPDDATABASE, HBCustDrop.OVERDUEDROP, " _
         &"               HBCustDrop.AGREEPAYDAT, " _
         &"               HBCustDrop.OVERDUETNSDAT, HBCustDrop.ACTDROP, RTObj.CUSNC,hbcustdrop.REPORTBACK " & searchqryary2(1) & " " _      
         &" ORDER BY  COMN, hbcustdrop.CUSNC, APPLYDAT " 
