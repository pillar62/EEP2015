   ...
   if STOCKCLOSE <> "" then
     ...
     ELSE
      ...
      sqlyy="insert into RTSparq499Cmtyhardwarelog " _
           &"SELECT  COMQ1, LINEQ1, PRTNO, ENTRYNO," & SEQ & ", GETDATE(),'R','" & V(0) & "', PRODNO, ITEMNO, QTY, DROPDAT, '設備作廢返轉', WAREHOUSE, ASSETNO,DROPUSR, UNIT, EQUIPSERNO " _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTSparq499CmtyHARDWARE set dropdat=NULL,dropREASON='設備作廢返轉',dropusr='' where comq1=" & KEY(0) & " and lineq1=" & key(1) & " and prtno='" & key(2) & "' and entryno=" & key(3)
