...
<% dim parmkey,aryparmkey,logonid,conn,rs,sql
   ...
   DSN="DSN=RtLib"
   sql="select * from RTSparq499CustChg where comq1=" & aryparmkey(0) &" and lineq1=" & aryparmkey(1) & " and cusid='" & aryparmkey(2) & "' and modifycode ='" & aryparmkey(3) & "' and modifydat ='" & aryparmkey(4) & "' "
'response.Write SQL   
'response.End
   conn.Open DSN
   conn.BeginTrans
