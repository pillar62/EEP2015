...
<% KEY=SPLIT(REQUEST("KEY"),";")
   ...
   RSXX.OPEN SQLXX,conn
     ...
     ELSE
        ...
        strSP="usp_RTSparq499CustRepairAR " & "'" & key(0) & "'" & "," & key(1) & ",'" & V(0) & "', 'MF', '' "
...
<form name=frm1 method=post action="RTSparq499CustRepairTRNAR.asp" ID="Form1">
