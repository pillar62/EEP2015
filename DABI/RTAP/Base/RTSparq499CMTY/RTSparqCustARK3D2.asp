...
Sub SrEnvironment()
  ...
  sqlDelete="SELECT     RTSparq499CustARDTL.TYY,RTSparq499CustARDTL.TMM,RTSparq499cmtyh.comn,RTSparq499cust.cusnc,RTSparq499CustARDTL.CUSID, RTSparq499CustARDTL.BATCHNO, " _
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if ARYPARMKEY(2) ="Sparq399" then
    sqlList="SELECT         RTSparqAdslCustARDTL.TYY,RTSparqAdslCustARDTL.TMM,RTSparqAdslcmty.comn,RTObj.cusnc, RTSparqAdslCustARDTL.CUSID, RTSparqAdslCustARDTL.BATCHNO, " _
           ...
           &"where RTSparqAdslCustARDTL.MDAT IS NULL and RTSparqAdslCustARDTL.canceldat is null AND " & searchqry & " ORDER BY RTSparqAdslCustARDTL.CUSID,RTSparqAdslCustARDTL.SEQ "
  elseif ARYPARMKEY(2) ="Sparq499" then
    sqlList="SELECT         RTSparq499CustARDTL.TYY,RTSparq499CustARDTL.TMM,RTSparq499cmtyh.comn,RTSparq499cust.cusnc, RTSparq499CustARDTL.CUSID, RTSparq499CustARDTL.BATCHNO, " _
           ...
           &"where RTSparq499CustARDTL.MDAT IS NULL and RTSparq499CustARDTL.canceldat is null AND " & searchqry & " ORDER BY RTSparq499CustARDTL.CUSID,RTSparq499CustARDTL.SEQ "  
  end if 
