...
Sub SrEnvironment()
  ...
  functionOptProgram="RTSparq499CustRepairTRNAR.asp;RTSparq499CustRepairTRNFR.asp;RTSparq499CustARK2.asp;RTSparq499CustRepairDROP.asp;RTSparq499CustRepairDROPC.asp"
  ...
  sqlDelete="SELECT  a.CUSID, a.ENTRYNO, c.CUSNC, a.ENTRYNO, a.APPLYDAT, b.CODENC, a.SETAMT, a.MOVEAMT, " &_
			...
			"FROM    RTSparq499CustRepair a " &_
					"LEFT OUTER JOIN RTCode b ON a.PAYTYPE = b.CODE AND b.KIND = 'M9' " &_
					"LEFT OUTER JOIN RTSparq499Cust c ON a.CUSID = c.CUSID " &_
			"WHERE	a.cusid='' "

  dataTable="RTSparq499CustRepair"
  userDefineDelete="Yes"
  numberOfKey=2
  dataProg="RTSparq499CustRepairD.asp"
  datawindowFeature=""
  ...
  colSplit=1
  keyListPageSize=25
  searchProg="RTSparq499custRepairS.asp"
  '========================================================================================================
