...
Sub SrEnvironment()
  ...
  functionOptName=" 取得IP ; 報 竣 ; 退 租 ; 作 廢 ;作廢返轉;異動紀錄;維修收款;設備保管收據列印;繳款記錄"
  functionOptProgram="RTSparq499CustGetIP.ASP;RTSparq499FINISH.ASP;RTSparq499CustChgK.asp;RTSparq499CustCANCEL.asp;RTSparq499CustCANCELRTN.asp;RTSparq499CustLogk.asp;RTSparq499CustRepairK.asp;/RTAP/REPORT/Common/RTStorageReceiptSparq499.asp;RTSparq499CustPayK.asp"
  functionOptPrompt="Y;Y;Y;Y;Y;N;N;N;N"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;主線;主線名稱;用戶;none;用戶IP;裝機地址;連絡電話;對帳代碼;申請日;完工日;報竣日;轉檔日;退租日;欠拆;作廢日;移入;移出"
  sqlDelete="SELECT RTSparq499Cust.COMQ1, RTSparq499Cust.LINEQ1,RTSparq499Cust.CUSID,rtrim(ltrim(convert(char(6),RTSparq499Cust.COMQ1))) +'-'+ rtrim(ltrim(convert(char(6),RTSparq499Cust.lineQ1))) as comqline,RTSparq499Cmtyh.comn,LEFT(RTSparq499Cust.CUSnc,4),RTCODE_3.CODENC,  " _
           ...
           &"RTSparq499Cust.CONTACTTEL+','+RTSparq499Cust.MOBILE, RTSparq499Cust.NCICCUSNO+'-'+RTSparq499Cust.SPHNNO, " _
           &"RTSparq499Cust.APPLYDAT, " _
           &"RTSparq499Cust.FINISHDAT, RTSparq499Cust.DOCKETDAT, RTSparq499Cust.TRANSDAT, RTSparq499Cust.DROPDAT, RTSparq499Cust.OVERDUE, RTSparq499Cust.CANCELDAT, " _
           ...
           &"RTSparq499Cust.lineq1=RTSparq499Cmtyline.lineq1 INNER JOIN RTCtyTown ON RTSparq499CmtyLINE.CUTID=RTCtyTown.CUTID AND " _
           &"RTSparq499CmtyLINE.TOWNSHIP=RTCtyTown.TOWNSHIP " _ 
           &"LEFT OUTER JOIN RTCODE RTCODE_3 ON RTSparq499Cust.CASETYPE = RTCODE_3.CODE AND RTCODE_3.KIND='L9' " _
           &"where " & searchqry & " AND RTCtyTown.AREAID " & DAREAID & " " _
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  If searchQry="" Then
     ...
     if ARYPARMKEY(2) ="" then 
		...
		searchQry=" RTSparq499Cust.COMQ1=" & ARYPARMKEY(0) & " AND RTSparq499Cust.LINEQ1=" & ARYPARMKEY(1) & " AND RTSparq499Cust.CUSID='" & ARYPARMKEY(2) &"' "
     end if
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  ...
  Emply=FrGetUserAreaID(Request.ServerVariables("LOGON_USER"))
  'Emply=FrGetUserEmply(Request.ServerVariables("LOGON_USER"))
  '-------------------------------------------------------------------------------------------
  'userlevel=2:為業務工程師==>只能看所屬社區資料
  'DOMAIN:桃中南轄區人員(客服,技術)只能看所屬轄區資料
  'Response.Write "Emply=" & userlevel & "<BR>"  
  Domain=Mid(Emply,1,2)
  select case Domain
         case "C1"
            DAreaID="<>'*'"
         case "C2"
