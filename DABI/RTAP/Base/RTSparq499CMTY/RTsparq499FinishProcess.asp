...
session.Timeout=999
K1=request("key")
K1ary=split(k1,";") '0=社區編號,1=主線序號,2=客戶代號
...
sql="update rtsparq499cust set SpHnNo ='" & NewNo & "',docketdat='" _
   & K2 & "',NCICCUSNO='" & K3 & "' where comq1=" & k1ary(0) & " and lineq1=" & k1ary(1) & " and cusid='" & k1ary(2) & "'"
