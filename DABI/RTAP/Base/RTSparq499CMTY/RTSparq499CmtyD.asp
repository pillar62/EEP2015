          ...
          For i = 0 To numberOfField-1
              ...
              '   On Error Resume Next
                ...
                select case ucase(runpgm)   
                   ...
                   case ucase("/webap/rtap/base/rtsparq499cmty/RTsparq499Cmtyd.asp")
...
'response.write "I=" & i & ";VALUE=" & dspkey(i) & "<BR>"
    ...
    if accessmode ="A" then
       runpgm=Request.ServerVariables("PATH_INFO")
       if ucase(runpgm)=ucase("/webap/rtap/base/rtsparq499cmty/RTsparq499Cmtyd.asp") then
          rs.open "select max(comq1) AS comq1 from rtsparq499cmtyh",conn
          if not rs.eof then
            dspkey(0)=rs("comq1")
          end if
          rs.close
...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT COMQ1, COMN, CUTID, TOWNSHIP,RADDR,RZONE,CUTID2,TOWNSHIP2,RADDR2,CUTID3,TOWNSHIP3,RADDR3, CUTID4,TOWNSHIP4,RADDR4, " _
             ...
             &"SURVEYDAT,AGREEDAT,AGREE,UNAGREEDESC, UPDncicCHKDAT, UPDncicCHKUSR, " _
             &"UPDncicDAT,TELCOMBOX,CONTACT,CONTACTTEL,eusr,edat,uusr,udat, " _
             &"REMITAGREE, COPYREMIT, REMITNO, REMITBANK, BANKBRANCH, REMITACCOUNT, REMITNAME, CHECKTITLE, CCUTID, CTOWNSHIP, CADDR " _
             &"FROM RTsparq499CmtyH WHERE COMQ1=0 "
...
Sub SrCheckData(message,formValid)
    ...
    if len(trim(DSPKEY(31))) = 0 THEN DSPKEY(31)=""
