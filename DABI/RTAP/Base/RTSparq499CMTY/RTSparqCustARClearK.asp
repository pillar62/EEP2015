...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;項次;方案別;沖帳金額;沖帳日期;沖帳人員;返轉日期;返轉人員"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  If searchQry="" Then
	...
	elseif ARYPARMKEY(2) ="Sparq499" then 
     ...
     searchShow="主線︰"& comq1xx & ",社區︰" & COMN & ",主線位址︰" & COMADDR & ",用戶序號︰" & aryparmkey(0) & ",用戶名稱︰" & CUSNC & ",帳款編號︰" & ARYPARMKEY(1)
  ELSE
     SEARCHFIRST=FALSE
  End If
