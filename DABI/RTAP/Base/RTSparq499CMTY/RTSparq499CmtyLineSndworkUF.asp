   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTSparq499Cmtylinesndwork set UNCLOSEdat=getdate() ,CLOSEUSR='" & V(0) & "' where comq1=" & KEY(0) & " and lineq1=" & key(1)  & " and prtno='" & key(2) & "' "
         ...
         '      SQLXX=" update RTSparq499Cmtyline set adslapplydat=getdate() ,UUSR='" & V(0) & "',UDAT=GETDATE()  where comq1=" & KEY(0) & " and lineq1=" & key(1) & " AND RTSparq499Cmtyline.ADSLAPPLYDAT IS NULL "
         '      connxx.Execute SQLXX
         '      If Err.number > 0 then
         '         endpgm="2"
         '      '發生錯誤時，刪除異動檔所新增的異動資料
