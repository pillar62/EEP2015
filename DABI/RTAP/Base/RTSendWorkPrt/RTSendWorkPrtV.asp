...
<%
  '傳入參數:session("PRTNO"):列印批號
  prtno=session("WorkPrtNo")
  reportname = "RTSendworkPRTP.rpt"
...
Session("oRpt").ParameterFields.GetItemByName("@insprtno").AddCurrentValue(CStr(prtno))
