...
Sub btn_onClick()
  ...
  If Len(TRIM(s3)) > 0 Then
     s=s &"  安裝地址:包含('" &S3 & "'字元)"
     t=t &" AND (b.CUTNC + a.TOWNSHIP3+a.RADDR3 LIKE '%" &S3 &"%')" 
  End If  
...
<tr><td class=dataListHead width="40%">經銷商</td>
  ...
  <tr> 
    <td class=dataListHead width="40%">開發業務員</td>
    <td width="60%"  bgcolor="silver"> 
  ...
  <tr> 
    <td class=dataListHead width="40%">方案別</td>
    <td width="60%"  bgcolor="silver"> 
  ...
  <tr> 
    <td class=dataListHead width="40%">用戶進度狀況</td>
    <td width="60%"  bgcolor="silver"> 
