...
Sub SrEnvironment()
  ...
  title="退貨單明細資料維護"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
  sqlFormatDB="SELECT RETURNno,prodno,itemno,RETURNqty,price,amt,cost,CAMT,warehouse,RETURNdesc " _
             &"FROM RTStockRETURND1 WHERE RETURNno='*' "
  sqlList="SELECT RETURNno,prodno,itemno,RETURNqty,price,amt,cost,CAMT,warehouse,RETURNdesc " _
             &"FROM RTStockRETURND1 WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
...
<p>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="10%" class=dataListHead>退貨單號</td><td width="10%" bgcolor=silver>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">退貨數量</font></td>
  ...
  <tr>
    <td width="15%" bgcolor="#008080"><font color="#FFFFFF">退貨原因</font></td>
    <td width="35%" COLSPAN=3 bgcolor="#C0C0C0">
