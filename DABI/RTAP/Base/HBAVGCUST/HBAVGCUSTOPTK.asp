...
'AVS499
  ...
  '    response.Redirect "/webap/rtap/base/rtcmty/rtcustk3.asp?key=" & KEYary(0)
      response.Redirect "/webap/rtap/base/HBAVGCUST/RTCMTYAVScust499.asp"
'NCIC399 
   case "NCIC399"
  '    response.Redirect "/webap/rtap/base/rtADSLcmty/rtcustk3.asp?key=" & KEYary(0)
      response.Redirect "/webap/rtap/base/HBAVGCUST/RTCMTYNCICCUST399.asp"
'CHT599T1A(HB599固定制T1線)   
   case "CHT599T1A"
  '    response.Redirect "/webap/rtap/base/rtSPARQADSLcmty/rtcustk3.asp?key=" & KEYary(0)
      response.Redirect "/webap/rtap/base/HBAVGCUST/RTCMTYCHTcust599T1A.ASP"
'CHT599T1A(HB599計量制T1線)   
   case "CHT599T1B"
    '  response.Redirect "/webap/rtap/base/rtcmty/rtcustk2.asp?key=" & KEYary(0)
      response.Redirect "/webap/rtap/base/HBAVGCUST/RTCMTYCHTcust599T1B.ASP"
'CHT599ADSL(HB599ADSL線路)
   case "CHT599ADSL"
    '  response.Redirect "/webap/rtap/base/rtcmty/rtcustk2.asp?key=" & KEYary(0)
      response.Redirect "/webap/rtap/base/HBAVGCUST/RTCMTYCHTcust599ADSL.ASP"
'CHT399
   case "CHT399"
    '  response.Redirect "/webap/rtap/base/rtcmty/rtcustk2.asp?key=" & KEYary(0)
      response.Redirect "/webap/rtap/base/HBAVGCUST/RTCMTYCHTcust399.ASP"
end select
%>