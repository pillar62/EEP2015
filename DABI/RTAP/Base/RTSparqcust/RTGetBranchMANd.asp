...
<% 'stock(0)="券商" stock(1)="分行"
  STOCK=split(request("key"),";")
  set conn=server.CreateObject("ADODB.Connection")
  set rs=server.CreateObject("ADODB.Recordset")
  DSN="DSN=RTLib"
  Conn.Open DSN
  sql="SELECT RTBussMan.CUSID, RTBussMan.STOCKID, " _
     &"RTBussMan.BRANCH, RTObj.SHORTNC " _
     &"FROM RTBussMan LEFT OUTER JOIN " _
     &"RTObj ON RTBussMan.CUSID = RTObj.CUSID WHERE stockid = '" & stock(0) & "' and branch='" & stock(1) & "' " _
