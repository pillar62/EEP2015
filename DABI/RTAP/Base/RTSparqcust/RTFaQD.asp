...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT CASENO,PRODUCT,FAQMAN,CUSID,TEL1,TEL2,MOBILE,RCVUSR,COMQ1,RCVDATE,BREAKDATE,SendDate," _
             &"dropdate,dropusr,finishdate,finishusr,finishfac,monthclose,memo,entryno, servicetype,comtype  FROM RTfaqh WHERE CASENO=0 "
  sqlList="SELECT CASENO,PRODUCT,FAQMAN,CUSID,TEL1,TEL2,MOBILE,RCVUSR,COMQ1,RCVDATE,BREAKDATE,SendDate," _
         &"dropdate,dropusr,finishdate,finishusr,finishfac,monthclose,memo,entryno, servicetype,comtype  FROM RTfaqh WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  extDBField=99
  userDefineSave="Yes"  
...
' -------------------------------------------------------------------------------------------- 
    ...
    IF len(trim(dspkey(8))) = 0 then
       sqlCMTY="select comn from RTsparqADSLCMTY where RTsparqADSLCMTY.CUTYID=" & session("COMQ1")
       dspkey(8)=session("COMQ1")       
    else
       sqlCMTY="select comn from RTsparqADSLCMTY where RTsparqADSLCMTY.CUTYID=" & dspkey(8)   
    end if
   ' Response.Write "SQLCMTY=" & SQLCMTY
    ...
    SQLCUST="select rtsparqadslcust.cusid,rtsparqadslcust.cutid1,rtsparqadslcust.township1,rtsparqadslcust.raddr1,rtobj.cusnc,rtobj.shortnc,rtsparqadslcust.office as COMTEL,rtsparqadslcust.home,rtsparqadslcust.mobile from rtsparqadslcust,rtobj where rtsparqadslcust.cusid=rtobj.cusid and rtsparqadslcust.cusid='" & dspkey(3) & "' and rtsparqadslcust.entryno=" & dspkey(19)
...
<table border="1" width="100%" cellspacing="0" cellpadding="0" height="717">
  ...
  <tr>
    ...
    <td width="36%" bgcolor="#c0c0c0"  height="23"><input name="key4"  <%=dataprotect%>  size="20" maxlength="15"  <%=fieldpa%>  class="dataListentry" value="<%=dspkey(4)%>" ></td>
    <td width="15%" bgcolor="#006666" class="DataListHead" height="23"><font  color="#FFFFFF">客戶電話(2)</font></td>
    <td width="35%" bgcolor="#c0c0c0"  height="23"><input name="key5"  <%=dataprotect%> size="20"  maxlength="15"   <%=fieldpa%>  class="dataListentry" value="<%=dspkey(5)%>" ></td>
  </tr>
  <tr>
    <td width="14%" bgcolor="#006666" class="datalisthead" height="23"><font  color="#FFFFFF">客戶行動電話</font></td>
    <td width="36%" bgcolor="#c0c0c0"  height="23"><input name="key6"  <%=dataprotect%> size="20"  maxlength="15"   <%=fieldpa%>  class="dataListentry" value="<%=dspkey(6)%>" ></td>
  ...
  <tr>
    ...
    <td width="36%" bgcolor="#c0c0c0"  height="25"><input name="key9"  <%=dataprotect%> size="20"  <%=fieldpa%>   class="dataListentry"  value="<%=dspkey(9)%>">
    ...
    <td width="35%" bgcolor="#c0c0c0"  height="25"><input name="key11"  <%=dataprotect%> size="20"  <%=fieldpa%>  class="dataListentry"  value="<%=dspkey(11)%>">
  ...
  <tr>
    ...
    rs.Close%>
		...
		<td width="35%" bgcolor="#c0c0c0" height="25">&nbsp;</td>
	</tr>
  ...
  <tr> 
    <td width="100%" colspan="4" bgcolor="#c0c0c0" height="311"> 
      ...
      <font color="#ff0000" >無法上網時間為&nbsp;&nbsp;&nbsp; <input name="key10"  <%=dataprotect%> size="20"  <%=fieldpa%>   class="dataListentry" value="<%=dspkey(10)%>">
