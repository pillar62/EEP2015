...
Sub SrEnvironment()
  ...
  numberOfKey=1
  title="縣市資料維護"
  formatName="縣市代碼;縣市名稱;輸入人員;輸入日期;異動人員;異動日期"
  sqlFormatDB="Select CUTID,CUTNC,eusr,edat,uusr,udat from RTCounty WHERE CUTID='*';"
  sqlList="SELECT CUTID,CUTNC,eusr,edat,uusr,udat " _
         &"FROM RTCounty WHERE "
  userDefineData="Yes"
  userDefineKey="Yes"
End Sub
...
%>   
     ...
     <input class=dataListEntry name="key1" maxlength=6 size=6 style="TEXT-ALIGN:left" 
     value="<%=dspkey(1)%>">
     </td>
     </tr>
     <tr>
