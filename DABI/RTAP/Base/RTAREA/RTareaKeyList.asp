...
Sub SrEnvironment()
  ...
  functionOptName="縣市別關係;業務員;業務組別"
  functionOptProgram="rtareactyKeyList.asp;rtareasalesk.asp;rtsalesGroupk.asp"
  ...
  sqlDelete="SELECT RTArea.AREAID, RTArea.AREANC, " _
           ...
           &"WHERE rtarea.areatype='1' and rtarea.areaid='*' "
  dataTable="rtarea"
  numberOfKey=1
  dataProg="rtareaDataList.asp"
  datawindowFeature=""
