...
<tr>
    <td width="25%" class=dataListHead>會員帳號</td>
...
<table width="100%" border=1 cellPadding=0 cellSpacing=0>
      <TR>
    <td width="15%" class=dataListHead>提問日期</td>
    ...
    <TR>
    <td width="15%" class=dataListHead>希望回覆電話</td>
    ...
    <td width="20%" class=dataListHead>希望回覆傳真</td>
    ...
    <td width="30%" bgcolor="silver">
     ...
     <tr>
    <td width="20%" class=dataListHead>回覆日期</td>
    <td width="30%" bgcolor="silver" >
        ...
        <IMG SRC="/WEBAP/IMAGE/IMGDELETE.GIF" alt="清除" id="C7"  name="C7"   style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td>
         ...
         <td width="20%" class=dataListHead>回覆人員</td>
    <td width="30%" bgcolor="silver" >
    ...
    <tr><td bgcolor="BDB76B" align="LEFT">提問內容</td></tr></table>
   <TD align="CENTER">
