  ...
  ' RESPONSE.END
   ...
   ELSE
      ...
      sqlyy="insert into HBADSLCMTYFIXSNDWORKlog " _
           &"SELECT  FIXNO,prtno," & ENTRYNO & ", getdate(), 'UF','" &  v(0) & "', " _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update HBADSLCMTYFIXSNDWORK set UNCLOSEdat=getdate() where FIXNO='" & KEY(0) & "' and prtno='" & key(1) & "' "
...
<script language=vbscript>
 sub window_onload()
    ...
    elseIF frm1.htmlfld.value="4" then
       msgbox "此社區主機客訴維修派工單已作廢，不可執行未完工結案作業：" & "  " & frm1.htmlfld1.value
       Set winP=window.Opener
       winP.focus()
       window.close       
    elseIF frm1.htmlfld.value="6" then
       ...
       msgbox "無法執行社區主機客訴維修派工單未完工結案作業,錯誤訊息：" & "  " & frm1.htmlfld1.value
       Set winP=window.Opener
       winP.focus()
       window.close
    end if
...
<form name=frm1 method=post action=RTFAQsndworkUf.ASP ID="Form1">
