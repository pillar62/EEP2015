...
Sub btn_onClick()
  ...
  if len(trim(s2)) > 0 then
     s="Reset次數：>=('" & s2 & "')次"  
     t=t & " and isnull(o.resetnum,0)>="&S2
  end if

  s3=document.all("search3").value
  if len(trim(s3)) > 0 then
     s="Alarm次數：>=('" & s3 & "')次"  
     t=t & " and isnull(n.alarmnum,0)>="&S3
  end if
...
<center>
<table width="85%">
  <tr class=dataListTitle align=center>請輸入(選擇)社區Reset資料搜尋條件</td><tr>
</table>
...
<tr><td class=dataListHead width="40%">Reset電話</td>
    <td width="60%" bgcolor="silver" >
		<input type=text name="search16" size="30" maxlength="15" class=dataListEntry ID="Text2">
    </td>
</tr>

<tr><td class=dataListHead width="40%">Reset次數</td>
    <td width="60%" bgcolor="silver" ><font color=blue>>=</font>
		<input type=text name="search2" size="5" maxlength="3" class=dataListEntry ID="Text1"><font color=blue>次</font>
    </td>
</tr>

<tr><td class=dataListHead width="40%">Alarm次數</td>
    <td width="60%" bgcolor="silver" ><font color=blue>>=</font>
		<input type=text name="search3" size="5" maxlength="3" class=dataListEntry ID="Text3"><font color=blue>次</font>
    </td>
</tr>
