...
Sub SrEnvironment()
  ...
  system="社區主線管理系統"
  title="iDslam自動Restart主檔維護作業<BR><font color=red>(每週一凌晨四點自動Restart iDslam)</font>"
  buttonName=" 新增 ; 刪除 ; 結束 ;重新整理;頁數;功能選項"
  V=split(SrAccessPermit,";")
  AllowA=V(0):AllowU=V(1):AllowD=V(2):AllowP=V(3)
  'ButtonEnable="Y;N;Y;Y;Y;Y"  
  ButtonEnable=V(0) & ";N;Y;Y;Y;Y"  
  functionOptName=" 作  廢 ;作廢反轉"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;工程師;社區方案;主線;社區名稱;主線<br>撤線日;主線<br>作廢日;附掛電話;Restart IP;作廢"
