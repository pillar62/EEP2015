...
Sub SrEnvironment()
 ...
 ' buttonEnable="Y;Y;Y;Y;Y;Y"
  ...
  DSN="DSN=RTLib"
  debug36=false
  formatName="none;none;對帳號;NCIC開通日;NCIC退租日;出帳日;繳款截止日;月租費;應拆金額;拆帳比;應付金額;拆帳日 "
  sqlDelete="SELECT MAINLINENO , SPHNNO , SPNO , " _
           &"NCICSTRDAT , NCICDROPDAT , APDAT , " _
           &"PAYENDDAT , YORMPAY , SPLITAMT , " _
           &"SPLITRATE , APAMT , SPLITDAT  " _
           &"FROM RTSparQ399AR " _ 
           &"WHERE mainline = '*' "
  dataTable="RTSparQ399AR"
  userDefineDelete=""  
  extTable=""
  numberOfKey=1
  dataProg="None"
...
'============================
  ...
  sqlxx="select EXTTEL,SPHNNO from rtsparqadslcust where comq1=" & aryparmkey(0) & " and CUSID='" & aryparmkey(1) & "' and entryno=" & aryparmkey(2)
...
'============================
  searchFirst=false
  If searchQry="" Then
     searchQry=" AND MAINLINENO='" & P1 & "' AND SPHNNO='" & P2 & "' "
     searchShow="全部"
  End If
  sqlList="SELECT MAINLINENO , SPHNNO , SPNO , " _
           &"NCICSTRDAT, NCICDROPDAT , APDAT , " _
           &"PAYENDDAT , YORMPAY, SPLITAMT , " _
           &"SPLITRATE , APAMT , SPLITDAT  " _
           &"FROM RTSparQ399AR " _ 
           &"WHERE mainlineNO <> '*' " &searchQry &" " _
           &"ORDER BY MAINLINENO, SPHNNO "
