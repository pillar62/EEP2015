 ...
 '  RESPONSE.END
   ...
   ELSE
      ...
      sqlyy="insert into KTSCUSTsndworklog " _
           &"SELECT   CUSID,PRTNO, " & ENTRYNO & ", getdate(), 'R','" &  v(0) & "', " _
           &"SENDWORKDAT, PRTUSR, ASSIGNENGINEER,ASSIGNCONSIGNEE, REALENGINEER, REALCONSIGNEE, DROPDAT, 'KTS用戶派工單作廢返轉'," _
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update KTSCUSTsndwork set DROPdat=NULL,DROPUSR='' where CUSID='" & KEY(0) & "' and prtno='" & key(1) & "' "
...
<script language=vbscript>
 sub window_onload()
    ...
    elseIF frm1.htmlfld.value="3" then
       msgbox "此派工單尚未作廢，不可執行派工單作廢返轉" & "  " & frm1.htmlfld1.value
       Set winP=window.Opener
       winP.focus()
       window.close       
...
<form name=frm1 method=post action=KTSCUSTSNDWORKDROPC.asp ID="Form1">
