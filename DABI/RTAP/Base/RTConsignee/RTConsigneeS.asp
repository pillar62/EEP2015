...
Sub btn_onClick()
  ...
  s="縣市別" & s1ary(1) & "　經銷商簡稱" & s2ary(1) & "　經銷商名稱：含(""" & document.all("search3").value & """)字元" & "　經銷代碼︰含(""" & document.all("search4").value & """)字元"
  t=t & "(rtobj.cutid1" & s1ary(0) & ") AND (RTObj.CUSID" & S2ARY(0) & ")"
  t=t & " and (rtobj.cusnc like '%" & document.all("search3").value & "%')"
  t=t & "  and ( rtconsignee.cusno like '%" & document.all("search4").value & "%')"
  Dim winP,docP
...
<center>
<table width="50%">
  <tr class=dataListTitle align=center>經銷商資料搜尋條件</td><tr>
</table>
...
<tr><td class=dataListHead width="40%">經銷商簡稱</td>
    <td width="60%"  bgcolor=silver>
...
<tr><td class=dataListHead width="40%">經銷代碼</td>
    <td width="60%"  bgcolor=silver>
     <input class=dataListEntry name="search4" maxlength=7 size=7 style="TEXT-ALIGN: left"></td></tr>             
</table>
