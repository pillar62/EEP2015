...
<%
  ...
  Dim detailwindowFeature,rscount,searchqry2,EMAILFIELDNO,EMAILFIELDFLAG,keyxx(10)
  searchFirst=False
  EMAILFIELDFLAG="N"
  userDefineDelete="No"
  functionOptPrompt=";;;;;;;;;;;;;;;;;;"
...
Sub runAUDI(accessMode,key)
 ...
 if accessmode="A" then
    ...
    prog="fttbcustoptk.asp?V=" &Rnd() &"&accessMode=" &accessMode &"&key=" &key &"&<%=dataProgParm%>"
    strFeature="<%=detailWindowFeature%>"
    if strfeature="" then
          Scrxx=window.screen.width -7
          Scryy=window.screen.height - 74
...
Sub SrEnvironment()
  ...
  functionOptProgram="FTTBCUSTCANCEL.ASP;FTTBCUSTCANCELRTN.ASP"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;社區;用戶;HB-HNNO;FTTB-HNNO;公司電話;分機;住家電話;行動電話;裝　　機　　地　　址;申請日;送件日;客戶類別;作廢日"
  sqlDelete="SELECT  FTTBCUST.COMQ1,FTTBCUST.CUSID, FTTBCUST.ENTRYNO, RTCmty.COMN, FTTBCUST.CUSNC,FTTBCUST.HBCUSNO,FTTBCUST.FTTBCUSNO," _
           &"FTTBCUST.OFFICE, FTTBCUST.EXTENSION, FTTBCUST.contacttel, FTTBCUST.MOBILE, " _
           &"FTTBCUST.RZONE1 + RTCounty.CUTNC + FTTBCUST.TOWNSHIP1 + FTTBCUST.RADDR1 AS Expr1, FTTBCUST.APPLYDAT, FTTBCUST.SNDDAT,RTCODE.CODENC,FTTBCUST.CANCELDAT " _
           &"FROM  FTTBCUST INNER JOIN  RTCmty ON FTTBCUST.COMQ1 = RTCmty.COMQ1 LEFT OUTER JOIN RTCounty ON " _
           &"FTTBCUST.CUTID1 = RTCounty.CUTID LEFT OUTER JOIN RTCODE ON FTTBCUST.CUSKIND=RTCODE.KIND " _
           &"where FTTBCUST.CUSID='' "

  dataTable="FTTBCUST"
  userDefineDelete="Yes"
  numberOfKey=3
  dataProg="FTTBCUSTD.ASP"
  datawindowFeature=""
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  ...
  searchFirst=FALSE
  If searchQry="" Then
     searchQry=" and FTTBCUST.COMQ1=" & ARYPARMKEY(0) 
     searchShow="全部"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if userlevel=31 or userlevel =1  or userlevel =5 or userlevel =9 then DAreaID="<>'*'"
         ...
         sqlList="SELECT  FTTBCUST.comq1,FTTBCUST.CUSID, FTTBCUST.ENTRYNO, RTCmty.COMN, FTTBCUST.CUSNC,FTTBCUST.HBCUSNO,FTTBCUST.FTTBCUSNO," _
           &"FTTBCUST.OFFICE, FTTBCUST.EXTENSION, FTTBCUST.contacttel, FTTBCUST.MOBILE, " _
           &"FTTBCUST.RZONE1 + RTCounty.CUTNC + FTTBCUST.TOWNSHIP1 + FTTBCUST.RADDR1 AS Expr1, FTTBCUST.APPLYDAT, FTTBCUST.SNDDAT,RTCODE.CODENC,FTTBCUST.CANCELDAT " _
           &"FROM  FTTBCUST INNER JOIN  RTCmty ON FTTBCUST.COMQ1 = RTCmty.COMQ1 LEFT OUTER JOIN RTCounty ON " _
           &"FTTBCUST.CUTID1 = RTCounty.CUTID LEFT OUTER JOIN RTCODE ON FTTBCUST.CUSKIND=RTCODE.CODE AND RTCODE.KIND='O7' " _
           &"where FTTBCUST.COMQ1=" & ARYPARMKEY(0) & " " & searchqry 
  'end if
