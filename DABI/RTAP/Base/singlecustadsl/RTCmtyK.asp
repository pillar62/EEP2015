...
Sub SrEnvironment()
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  sqllist="SELECT DISTINCT " _
         &"singlecustadsl.CUTID2, singlecustadsl.TOWNSHIP2, singlecustadsl.HOUSENAME, " _
         &"RTCounty.CUTNC, singlecustadsl.TOWNSHIP2 , " _
         &"singlecustadsl.HOUSENAME , COUNT(*) " _
         &"FROM singlecustadsl INNER JOIN " _
         &"RTCounty ON singlecustadsl.CUTID2 = RTCounty.CUTID INNER JOIN " _
         &"RTAreaCty ON RTCounty.CUTID = RTAreaCty.CUTID INNER JOIN " _
         &"RTArea ON RTAreaCty.AREAID = RTArea.AREAID AND AREATYPE = '1' " _
         &"WHERE " & searchqry & " AND RTAREACTY.AREAID " & DAreaid  & " and singlecustadsl.housename <> '' " _
         &"GROUP BY singlecustadsl.CUTID2, singlecustadsl.TOWNSHIP2, singlecustadsl.HOUSENAME, " _
         &"RTCounty.CUTNC, singlecustadsl.TOWNSHIP2, singlecustadsl.HOUSENAME, " _
...
'            &"RTCounty ON singlecustadsl.CUTID2 = RTCounty.CUTID " _
'            &"where " & searchqry & " " _
'            &"GROUP BY singlecustadsl.cutid2, singlecustadsl.TOWNSHIP2, singlecustadsl.HOUSENAME,RTCounty.CUTNC, singlecustadsl.TOWNSHIP2, singlecustadsl.HOUSENAME " _
'            & searchqry2 
