...
' -------------------------------------------------------------------------------------------- 
    ...
    SQLCUST="select singlecustadsl.cusid,singlecustadsl.cutid1,singlecustadsl.township1,singlecustadsl.raddr1,rtobj.cusnc,rtobj.shortnc,singlecustadsl.office as COMTEL,singlecustadsl.home,singlecustadsl.mobile from singlecustadsl,rtobj where singlecustadsl.cusid=rtobj.cusid and singlecustadsl.cusid='" & dspkey(3) & "' and singlecustadsl.entryno=" & dspkey(19)
