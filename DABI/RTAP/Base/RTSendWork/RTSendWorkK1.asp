...
Sub SrEnvironment()
  ...
  sqlDelete="SELECT b.COMQ1,b.comq2, b.COMN, b.t1apply, COUNT(a.cusid) AS custcnt " _
           ...
           &"a.sndinfodat IS NOT NULL and a.settype in ('2','3') " _
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  sqlList="SELECT b.COMQ1,b.comq2, b.COMN, b.t1apply, COUNT(a.cusid) AS custcnt " _
           ...
           &"AND a.settype IN ('2', '3') AND b.ComQ1 <> 0 AND A.SNDINFODAT IS NOT NULL " _
  ...
  Session("DSQL")=" a.sndinfodat IS NOT NULL and a.settype in ('2','3')  " & searchqrydtl
