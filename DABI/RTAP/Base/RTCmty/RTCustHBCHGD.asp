...
Sub SrEnvironment()
  DSN="DSN=RTLib"
  numberOfKey=5
  title="Hi-Building已報竣客戶資料異動維護作業"
  formatName=";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;"
...
'------社區名稱---固定(由社區序號讀取)
    ...
    DSNXX="DSN=RTLIB"
    connxx.Open DSNxx
    sqlXX="SELECT COMN FROM rtCmty where cutid=" & dspkey(0)
...
<tr>
    ...
    <td width="10%" bgcolor="silver">
<%  sql="SELECT RTCode.CODE, RTCode.CODENC FROM RTCode WHERE (RTCode.KIND = 'C8') and rtcode.code='" & dspkey(3) & "' "
    rs.Open sql,conn
