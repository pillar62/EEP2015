...
<% KEY=SPLIT(REQUEST("KEY"),";")
 ...
 '  RESPONSE.END
   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTCMTYSNDWORK set dropdat=getdate(),dropdesc='主線派工單作廢' where COMQ1=" & KEY(0) & " and prtno='" & key(1) & "' "
   ...
   IF ENDPGM="1" THEN
      ...
      jmail.Subject = "Hi-Building社區主線派工單︰" & KEY(1) & "，作廢通知"
      jmail.priority = 1  
      body="<html><body><table border=1 width=""50%""><tr><td colspan=2>" _
      &"<H3 align=center>Hi-Building主線派工單作廢通知</h3></td></tr>" _
