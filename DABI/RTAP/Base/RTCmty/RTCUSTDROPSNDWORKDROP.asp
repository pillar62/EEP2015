   ...
   ELSE
     ...
     ' Response.Write sqlyy
      ...
      If Err.number > 0 then
         ...
         SQLXX=" update RTcustdropsndwork set dropdat=getdate(),dropdesc='退租拆機工單作廢' where cusid='" & KEY(0) & "' and entryno=" & key(1) & " and prtno='" & key(2) & "' "
...
<form name=frm1 method=post action=RTcustdropsndworkDROP.asp ID="Form1">
