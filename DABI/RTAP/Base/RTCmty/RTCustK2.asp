...
Sub SrEnvironment()
  ...
  functionOptName="發包通知;撤銷通知;客訴處理;報竣異動;歷史異動;CALL-OUT"
  functionOptProgram="RTSndInfo.asp;RTDropInfo.asp;RTFaqK.ASP;RTCUSTCHGOPT.ASP;RTcusthbchgk.asp;/WEBAP/RTAP/BASE/HBCALLOUTPROJECT/RTCUSTOPTK.ASP"
  functionOptPrompt ="Y;Y;N;Y;Y;N"
  ...
  '===============================================================================
  formatName="none;客戶代碼;none;客戶名稱;客戶IP;申請日;完工日;報竣日;撤銷日;聯絡電話;裝機地址;辦公室電話;同意書編號"
  sqlDelete= "SELECT RTCust.COMQ1, RTCust.CUSID, RTCust.ENTRYNO, RTObj.SHORTNC, " &_
