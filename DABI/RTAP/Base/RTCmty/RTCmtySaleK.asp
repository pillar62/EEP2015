...
Sub SrEnvironment()
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;業務姓名;生效日期;截止日期"
  sqlDelete="SELECT RTCmtySale.COMQ1, RTCmtySale.CUSID, RTCmtySale.seq, RTObj.CUSNC, RTCmtySale.TDAT, " _
           &"RTCmtySale.EXDAT " _
  ...
  sqlList="SELECT RTCmtySale.COMQ1, RTCmtySale.CUSID, RTCmtySale.seq, RTObj.CUSNC, RTCmtySale.TDAT, " _
         &"RTCmtySale.EXDAT " _
