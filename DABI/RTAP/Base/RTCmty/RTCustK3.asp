...
Sub SrEnvironment()
  ...
  functionOptName="客訴處理;CALL-OUT"
  functionOptProgram="RTFaqK.ASP;/WEBAP/RTAP/BASE/HBCALLOUTPROJECT/RTCUSTOPTK.ASP"
  ...
  '===============================================================================
  formatName="none;客戶代碼;none;客戶名稱;客戶IP;申請日;完工日;報竣日;撤銷日;聯絡電話;裝機地址;辦公室電話;同意書編號;COT;MDF1;MDF2"
  sqlDelete= "SELECT RTCust.COMQ1, RTCust.CUSID, RTCust.ENTRYNO, RTObj.SHORTNC, " &_
             ...
             "		rtcust.consentno, RTCust.COTPORT, RTCust.ANO, RTCust.BNO " &_
