    ...
    select case exist(1)
      case "1"
         if Domain="T" or Domain="P" then
            usr=usr & " and rtemployee.authlevel in ('2') and rtemployee.tran2<>'10' and (rtemployee.dept in ('B100','B106','B107','B108','B401','B600','B700','B701')) "
      ...
      case "2"
         if Domain="T" or Domain="P" then
            usr=usr & " and rtemployee.dept='B700'  "
         else
