<%
	...
	Response.AddHeader "Content-Disposition","filename="& replace(v(0), "/", "") & "E.xls"
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Sparq499轉檔">
  <Table>

   <Row ss:AutoFitHeight="0">
    <Cell ss:MergeAcross="48" ss:StyleID="Title"><Data ss:Type="String">元訊電子轉檔報竣</Data></Cell>
   </Row>
<!--
   <Row ss:AutoFitHeight="0">
    <Cell ss:MergeAcross="49" ss:StyleID="Title"><Data ss:Type="String">速博退租戶一覽表</Data></Cell>
   </Row>
-->
   <Row>
   ...
   <Row>
    ...
    <Cell ss:StyleID="Header"><Data ss:Type="String">異動代碼</Data></Cell>
    <Cell ss:StyleID="HeaderS"><Data ss:Type="String">電話號碼</Data></Cell>
    <Cell ss:StyleID="HeaderS"><Data ss:Type="String">對帳號碼</Data></Cell>
...
<%
	rs.Open "usp_RTSparq499Ftp '2','" & v(0) &"'", CONN
	Do While Not rs.Eof
