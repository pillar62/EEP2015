...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT CASENO,PRODUCT,FAQMAN,CUSID,TEL1,TEL2,MOBILE,RCVUSR,COMQ1,RCVDATE,BREAKDATE,SendDate," _
             &"dropdate,dropusr,finishdate,finishusr,finishfac,monthclose,memo,entryno  FROM RTfaqh WHERE CASENO=0 "
  sqlList="SELECT CASENO,PRODUCT,FAQMAN,CUSID,TEL1,TEL2,MOBILE,RCVUSR,COMQ1,RCVDATE,BREAKDATE,SendDate," _
         &"dropdate,dropusr,finishdate,finishusr,finishfac,monthclose,memo,entryno  FROM RTfaqh WHERE "
  userDefineKey="Yes"
  userDefineData="Yes"
  extDBField=99
  userDefineSave="Yes"  
...
' -------------------------------------------------------------------------------------------- 
    ...
    Dim SQLCMTY,SQLCUST
    SQLCMTY="select * from rtcustadsl where cusid='" & session("cusid") & "' and entryno=" & session("entryno")
    rs.open sqlCMTY,conn
    if rs.eof then
       s=""  
       dspkey(8)=0
    else
    ...
    SQLCUST="select rtcustadsl.cusid,rtcustADSL.cutid1,rtcustadsl.township1,rtcustadsl.raddr1,rtobj.cusnc,rtobj.shortnc,rtcustadsl.office as COMTEL,rtcustadsl.home,rtcustadsl.mobile from rtcustadsl,rtobj where rtcustadsl.cusid=rtobj.cusid and rtcustadsl.cusid='" & dspkey(3) & "' and rtcustadsl.entryno=" & dspkey(19)
