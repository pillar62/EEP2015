...
<table width="100%" ><tr><td width="100%">&nbsp;</td></tr>                                                      
    ...
    <tr>
        <td width="10%" class="dataListHead" height="25">身份證字號</td>
        ...
        <td width="10%" class="dataListHead" height="25">HN號碼</td>       
        ...
        <td width="8%" bgcolor="orange"  height="25" ><FONT SIZE=2>保留撥接E-MAIL(HN號碼)</FONT></td>       
    ...
    <tr>                   
        <td width="10%" class="dataListHead" height="25">證券公司</td>                                      
...
<%    If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) And protect<1 and  len(trim(dspkey(92)))=0 Then 
    ...
    %>
        ...
        <input type="text" name="key3" size="10" value="<%=dspkey(3)%>" maxlength="12" <%=fieldpg%><%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry" readonly><font size=2>(分行)               
...
<% aryOption=Array("ADSL")
   ...
   End If%>                                  
        <td width="16%" height="25" bgcolor="silver"><select size="1" name="key21" style="font-family: 新細明體; font-size: 10pt"<%=fieldpG%><%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry">                                                                  
        <%=s%></select></td>                                     
      </tr>                                 
      <tr>                            
...
<% aryOption=Array("","先看先贏")
   ...
   <select size="1" name="key78" <%=fieldpg%><%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry">                                            
      ...
      <tr>
        ...
        <td width="15%"   bgcolor="ORANGE"  height="34">送件日期</td>                                 
...
<%
    ...
    Loop
    rs.Close%>         
   <select size="1" name="key25" style="font-family: 新細明體; font-size: 10pt"<%=fieldpg%><%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry">                                                                  
        <%=s%>
   </select><font size=2>
   &nbsp;社區名稱<input type="text" name="key26" size="15" MAXLENGTH="30" value="<%=dspKey(26)%>" <%=fieldpg%><%=fieldpa%><%=FIELDROLE(3)%><%=dataProtect%>  class="dataListEntry">
   ...
   共<input type="text" name="key27" size="4" value="<%=dspKey(27)%>" <%=fieldpg%><%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> maxlength="4" class="dataListEntry">戶</td>                                 
      ...
      <tr>                                    
        ...
        <td width="15%" class="dataListHead" height="23">傳真電話</td>                                 
      ...
      <tr>                                 
        ...
        <font size=2>分機<input type="text" name="key33" size="5" value="<%=dspkey(33)%>" maxlength="5" <%=fieldpG%><%=fieldpa%><%=FIELDROLE(1)%><%=dataProtect%> class="dataListEntry"></td>                                 
        <td width="15%" class="dataListHead" height="23">行動電話</td>                                 
        ...
        <input type="radio" value="Y" <%=OPT1%> name="key94" <%=fieldpg%><%=fieldpa%><%=dataProtec%>><font size=2>是</font>
        <input type="radio" value="N" <%=OPT2%> name="key94" <%=fieldpg%><%=fieldpa%><%=dataProtect%>><font size=2>否</font></td>                              
      ...
      <tr>                                 
        ...
        <td width="15%" class="dataListHead" height="23">收據名稱</td>                                 
      ...
      <tr>                                 
        ...
        <td width="15%" class="dataListHead" height="23" style="display:none">輸入日期</td>                                 
      ...
      <tr>                                 
        ...
        <td width="15%" class="dataListHead" height="23" style="display:none">異動日期</td>                                 
      ...
      <tr>                       
        ...
        <td width="15%" bgcolor="silver">
          ...
          <input type="button" id="B52"  name="B52" height="100%" width="100%" style="Z-INDEX: 1" value="..." <%=fieldpc%>>
           欠拆︰<input type="text" name="key97" size="1" maxlength="10" value="<%=dspkey(97)%>" class="dataListEntry"></td>                   
      </tr>                                     
      <tr>                       
