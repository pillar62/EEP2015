...
<%
	...
	Response.AddHeader "Content-Disposition","filename=收款明細表(速博).xls"
...
<%
	...
	rs.Open sql, CONN
	Do While Not rs.Eof
		sqlstr="usp_RTRcvMoneyList '" &v(0)& "', '" &v(1)& "', 'B" &rs("code")& "' "
		...
		if Not rsx.Eof then
			...
			response.Write "<Row>" &_
				...
				"<Cell ss:StyleID=""HeaderS""><Data ss:Type=""String"">地址</Data></Cell>" &_
