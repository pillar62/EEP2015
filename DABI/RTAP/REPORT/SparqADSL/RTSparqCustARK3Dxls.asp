<%
	...
	Response.AddHeader "Content-Disposition","filename="&v(2)&"應收應付帳款列表"&v(0)&"-"&v(1)&".xls"
...
<%
	if v(2)="Sparq399" then 
		sql="SELECT 	d.comn, e.cusnc, a.BATCHNO, b.ACNAMEC, " &_
