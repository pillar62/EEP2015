<%
	...
	Response.AddHeader "Content-Disposition","filename=速博退租戶一覽表.xls"
...
<%
	sql="select h.areanc as areanc, isnull(i.shortnc, k.cusnc) as belongnc, "_
		...
		&"where	 b.docketdat is not null and b.overdue <>'Y' and b.freecode <>'Y' "_
		&"and	b.dropdat between '" &v(0)& "' and '" &v(1)& "' "_
...
<%
	sql="select h.areanc as areanc, isnull(i.shortnc, k.cusnc) as belongnc, "_
		...
		&"where	b.canceldat is null and b.overdue <>'Y' and b.freecode <>'Y' "_
		&"and	b.dropdat between '" &v(0)& "' and '" &v(1)& "' "_
		&"order by i.cusnc, 2, 1, 4 "
	rs.Open sql, CONN
	serno=0				   
