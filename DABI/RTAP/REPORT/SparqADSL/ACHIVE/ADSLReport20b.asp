...
<P><center><font color="red">欲上傳之文字檔 (共 <b><%=iCount%></b> 筆資料)：</font><br><br>
<!--   <INPUT name=tbPathFile value="<%=ftpFile%>" size="20" readonly><br><br><br>   -->
   <a href="<%=ftpFileLink%>"><%=ftpFile%></a><br><br><br>
   <INPUT name=btnFtp  type=button value="FTP上傳" disabled>
   <INPUT name=btnView type=button value="檢視文字檔">
   <INPUT name=btnExit type=button value="離開">
