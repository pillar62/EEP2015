...
Session("oRpt").ParameterFields.GetItemByName("@typ").AddCurrentValue(Cint(V(1)))
						' 1: 送件已達三人
                        ' 2: 送件未達三人
                        ' 3: 社區有三戶以上申請 
                        ' 4: 社區只二戶申請
                        ' 5: 社區只一戶申請  
Session("oRpt").ParameterFields.GetItemByName("@deliverdats").AddCurrentValue(Cdate(v(4)))
Session("oRpt").ParameterFields.GetItemByName("@deliverdate").AddCurrentValue(Cdate(v(5)))
Session("oRpt").ParameterFields.GetItemByName("@edats").AddCurrentValue(Cdate(v(2)))
Session("oRpt").ParameterFields.GetItemByName("@edate").AddCurrentValue(Cdate(v(3)))
...
<HTML>
<HEAD>
    <title>ADSL券商專案客戶三人成行篩選表(送件未三人)</title>
</HEAD>
