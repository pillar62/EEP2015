...
Session("oRpt").ParameterFields.GetItemByName("@rcvds").AddCurrentValue(CDate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@rcvde").AddCurrentValue(CDate(v(1)))
