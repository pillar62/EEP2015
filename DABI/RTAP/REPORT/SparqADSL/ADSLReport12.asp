...
Session("oRpt").ParameterFields.GetItemByName("@adslapplys").AddCurrentValue(CDate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@adslapplye").AddCurrentValue(CDate(v(1)))
'Session("oRpt").ParameterFields.GetItemByName("@eusr").AddCurrentValue(CStr("T89039"))
