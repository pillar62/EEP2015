...
Session("oRpt").ParameterFields.GetItemByName("@edats").AddCurrentValue(Cdate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@edate").AddCurrentValue(Cdate(v(1)))
Session("oRpt").ParameterFields.GetItemByName("@groupid").AddCurrentValue(CStr(v(2)))
...
<HTML>
<HEAD>
    <title>ADSL券商專案客戶明細表(依鄉鎮區)</title>
</HEAD>
