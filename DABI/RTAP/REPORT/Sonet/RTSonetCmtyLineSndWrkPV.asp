 ...
 sub window_onload()
    if frm1.htmlfld.value="1" then
       ...
       select case document.all("key4").value 
			case "07"
				WINDOW.Form2.action="/RTAP/REPORT/Sonet/RTSonetCmtyLineSndWrkP07.asp" & "?parm=" & document.all("key0").value & ";"
			case "10"
				WINDOW.Form2.action="/RTAP/REPORT/Sonet/RTSonetCmtyLineSndWrkP10.asp" & "?parm=" & document.all("key0").value & ";"
			case "11"
				WINDOW.Form2.action="/RTAP/REPORT/Sonet/RTSonetCmtyLineSndWrkP11.asp" & "?parm=" & document.all("key0").value & ";"
			case else
       end select 
...
<form name=frm1 method=post action="RTSonetCmtyLineSNDWORKPV.asp" ID="Form1">
