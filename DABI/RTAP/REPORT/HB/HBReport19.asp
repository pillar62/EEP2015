...
Session("oRpt").ParameterFields.GetItemByName("@rcvd").AddCurrentValue(Cdate(v(0)))
'Session("oRpt").ParameterFields.GetItemByName("@sndwrkplacee").AddCurrentValue(Cdate("2001/10/11"))
'Session("oRpt").ParameterFields.GetItemByName("@wrkplace").AddCurrentValue(CStr("%"))
