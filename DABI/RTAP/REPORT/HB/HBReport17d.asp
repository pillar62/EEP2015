...
'response.Write sqlstr    
	...
	Response.AddHeader "Content-Disposition","filename=工務人員各方案社區線數戶數統計(總表含經銷).xls"
	response.Write "<table>"
	response.Write "<tr><td align =center colspan=14><b>元訊寬頻網路股份有限公司</b></td></tr>"
	response.Write "<tr><td align =center colspan=14><b>工務人員各方案社區線數戶數統計(總表含經銷)</b></td></tr>"
	response.Write "<tr><td align =left colspan=14><font size=2><u>統計期間 至： "&v(0)&" </u></font></td></tr>"
	...
	response.Write "<TR>" &_
		...
		"<td class=titleN align=""center"">主線序號</td>" &_
