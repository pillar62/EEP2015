...
Session("oRpt").ParameterFields.GetItemByName("@comtype").AddCurrentValue(CStr(v(2)))
Session("oRpt").ParameterFields.GetItemByName("@hnnos").AddCurrentValue(CStr(v(3)))
Session("oRpt").ParameterFields.GetItemByName("@hnnoe").AddCurrentValue(CStr(v(4)))
