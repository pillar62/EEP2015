...
'Session("oRpt").ParameterFields.GetItemByName("@bonusym").AddCurrentValue(CStr(V(0)))
'Session("oRpt").ParameterFields.GetItemByName("@groupid").AddCurrentValue(CStr(V(1)))
'Session("oRpt").ParameterFields.GetItemByName("@eusr").AddCurrentValue(CStr(V(2)))
