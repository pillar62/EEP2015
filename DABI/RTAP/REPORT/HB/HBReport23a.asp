...
<%
    ...
    sql="usp_RTCallOutArea '" &v(0)&"','"&v(1)&"','"&v(2)&"','N' "
   rs.Open sql, CONN
...
'response.Write sqlstr    
	...
	Response.AddHeader "Content-Disposition","filename=HiBuilding客戶 Call Out 名單(有效戶)"
	response.Write "<table>"
	response.Write "<tr><td align =center colspan=11><b>元訊寬頻網路股份有限公司</b></td></tr>"
	response.Write "<tr><td align =center colspan=11><b>HiBuilding客戶 Call Out 名單(有效戶)</b></td></tr>"
	...
	response.Write "<TR>" &_
		...
		"<td class=titleN align=""center"">欠拆日</td>" &_
