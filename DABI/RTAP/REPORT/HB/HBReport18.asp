...
<%
    ...
    sql="usp_RTAllCaseSalesCount '" &v(0)& "' "
   rs.Open sql, CONN
...
'response.Write sqlstr    
	...
	Response.AddHeader "Content-Disposition","filename=直銷業務員線數&戶數統計"

	response.Write "<table>"
	response.Write "<tr><td align =center colspan=17><b>元訊寬頻網路股份有限公司</b></td></tr>"
	response.Write "<tr><td align =center colspan=17><b>直銷業務員線數&戶數統計</b></td></tr>"
