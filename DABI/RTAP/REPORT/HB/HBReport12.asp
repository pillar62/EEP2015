...
Session("oRpt").ParameterFields.GetItemByName("@psdats").AddCurrentValue(CDate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@psdate").AddCurrentValue(CDate(v(1)))
Session("oRpt").ParameterFields.GetItemByName("@belong").AddCurrentValue(CStr(v(2)))
Session("oRpt").ParameterFields.GetItemByName("@consignee").AddCurrentValue(CStr(v(3)))
