...
<%
    ...
    sql="usp_RTEngCmtyCustCount 'B', '" & v(0) &"' "
   rs.Open sql, CONN
...
'response.Write sqlstr    
	...
	Response.AddHeader "Content-Disposition","filename=工務人員各方案社區線數戶數統計(明細).xls"
	response.Write "<table>"
	response.Write "<tr><td align =center colspan=6><b>元訊寬頻網路股份有限公司</b></td></tr>"
	response.Write "<tr><td align =center colspan=6><b>工務人員各方案社區線數戶數統計(明細)</b></td></tr>"
