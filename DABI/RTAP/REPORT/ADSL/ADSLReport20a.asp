...
Session("oRpt").ParameterFields.GetItemByName("@eusr").AddCurrentValue(Cstr(v(1)))
Session("oRpt").ParameterFields.GetItemByName("@typ").AddCurrentValue(CStr(v(2)))
Session("oRpt").ParameterFields.GetItemByName("@comtype").AddCurrentValue(CStr(v(3)))
Session("oRpt").ParameterFields.GetItemByName("@docketdats").AddCurrentValue(Cdate("1900'1/1"))

On Error Resume Next

session("oRpt").ReadRecords
'response.write "err=" & err.number
'response.write "parm=" & parm
If Err.Number <> 0 Then                                               
