...
<%
  reportname = "ADSLReport13.rpt"   '對應storeProcedure為 usp_RTAdslFinishRPT
  parm=request("parm")
  v=split(parm,";")  
...
Session("oRpt").ParameterFields.GetItemByName("@finishs").AddCurrentValue(Cdate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@sinishe").AddCurrentValue(Cdate(v(1)))
...
<HTML>
<HEAD>
    <title>ADSL券商專案已完工客戶報竣表列印</title>
</HEAD>
