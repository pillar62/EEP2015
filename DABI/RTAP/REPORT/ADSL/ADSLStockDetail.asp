...
<HTML>
<HEAD>
    <title>ADSL券商專案本週送件客戶明細表</title>
<% 
  parm=request("parm")
  v=split(parm,";")
  reportname = "ADSLSTOCKDETAIL.rpt"
...
'  NewParamValue = "03098908"
'  NewParamValue2 = Dateadd("d",-1, Now())
  NewParamValue = V(0)
  NewParamValue2 = V(1)
  NewParamValue3 = V(2)    '1:送件, 2:完工  
