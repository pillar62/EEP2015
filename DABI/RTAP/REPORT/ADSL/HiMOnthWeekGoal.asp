...
<%
  KEY=REQUEST("PARM")
  KEYARY=SPLIT(key,";")
  if UCASE(keyary(0))="M" then
     reportname = "HiMonthgoal.rpt"
  else 
     reportname = "HiWEEKgoal.rpt"
  END IF
...
Session("oRpt").ParameterFields.GetItemByName("@sdate").AddCurrentValue(Cdate(keyary(1)))
Session("oRpt").ParameterFields.GetItemByName("@edate").AddCurrentValue(Cdate(keyary(2)))
...
<HTML>
<HEAD>
    <title>HiBuilding·~ÁZ¤ë(¶g)³ø</title>
</HEAD>
