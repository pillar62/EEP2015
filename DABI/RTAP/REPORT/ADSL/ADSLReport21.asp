...
Session("oRpt").ParameterFields.GetItemByName("@sndwrkplace").AddCurrentValue(Cdate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@sndwrkplacee").AddCurrentValue(Cdate(v(1)))
Session("oRpt").ParameterFields.GetItemByName("@wrkplace").AddCurrentValue(CStr(v(2)))
...
<HTML>
<HEAD>
   <title>ADSL券商專案送營運處社區資料表列印</title>
</HEAD>
