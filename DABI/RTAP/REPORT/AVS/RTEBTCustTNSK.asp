...
Sub SrEnvironment()
  ...
  functionOptName="清除記錄; 結  案 ; 作  廢 ;用戶資料"
  functionOptProgram="rtebtcustTNSclr.asp;rtEBTcustTNSF.asp;rtEBTcustTNSdrop.asp;\webap\rtap\base\rtebtcmty\rtebtcustK.asp"
  ...
  End IF
  DSN="DSN=RTLib"
  formatName="none;none;none;none;主線序號;旗標;社區名稱;用戶名稱;主線合約號;none;轉檔序號;CBC合約;AVS合約;none;錯誤訊息;結<BR>案;作<BR>廢;清<BR>除"
  sqlDelete="SELECT RTEBTFtpAvsparaRpl.COMQ1, RTEBTFtpAvsparaRpl.LINEQ1, RTEBTFtpAvsparaRpl.CUSID,RTEBTFtpAvsparaRpl.flag,rtrim(convert(char(6),RTEBTFtpAvsparaRpl.COMQ1)) +'-'+ rtrim(convert(char(6),RTEBTFtpAvsparaRpl.lineQ1))  as comqline, case when RTEBTFtpAvsparaRpl.FLAG='A' THEN '申請' when RTEBTFtpAvsparaRpl.FLAG='F' THEN '報竣' WHEN RTEBTFtpAvsparaRpl.FLAG='C' THEN '取消' ELSE '' END , RTEBTCMTYH.COMN,RTEBTCUST.CUSNC, " _
           &"RTEBTFtpAvsparaRpl.CONTRACTNO, RTEBTFtpAvsparaRpl.EBTREPLYDAT, RTEBTFtpAvsparaRpl.TRANNO, " _
           &"RTEBTFtpAvsparaRpl.CBCCONTRACTNO, RTEBTFtpAvsparaRpl.AVSNO, RTEBTFtpAvsparaRpl.EBTUPDSTATUS, RTEBTFtpAvsparaRpl.ERRORMSG,CASE WHEN RTEBTFtpAvsparaRpl.CLOSEDAT IS NOT NULL THEN 'Y' ELSE '' END,CASE WHEN RTEBTFtpAvsparaRpl.DROPDAT IS NOT NULL THEN 'Y' ELSE '' END,CASE WHEN RTEBTFtpAvsparaRpl.CLRFLAG IS NOT NULL THEN 'Y' ELSE '' END  " _
           &"FROM RTEBTFtpAvsparaRpl INNER JOIN RTEBTCMTYH ON RTEBTFtpAvsparaRpl.COMQ1 = RTEBTCMTYH.COMQ1 INNER JOIN " _
           &"RTEBTCUST ON RTEBTFtpAvsparaRpl.COMQ1 = RTEBTCUST.COMQ1 AND RTEBTFtpAvsparaRpl.LINEQ1 = RTEBTCUST.LINEQ1 AND " _
           &"RTEBTFtpAvsparaRpl.CUSID = RTEBTCUST.CUSID " _
           &"WHERE RTEBTFtpAvsparaRpl.comq1=0 "            
  dataTable="RTEBTFtpAdslRpl"
...
' When first time enter this keylist default query string to RTcmty.ComQ1 <> 0
  searchFirst=FALSE
  If searchQry=""  Then
     searchQry=" and RTEBTFtpAvsparaRpl.EBTUPDSTATUS='N' AND RTEBTFtpAvsparaRpl.CLOSEDAT IS NULL AND RTEBTFtpAvsparaRpl.DROPDAT IS NULL "
     searchShow="全部尚未處理之異常資料"
  ELSE
     SEARCHFIRST=FALSE
  End If
 ...
 ' Response.Write "DOMAIN=" & domain & "<BR>"
  ...
  if UCASE(emply)="T89001" or Ucase(emply)="T89002" or  Ucase(emply)="T89020" or Ucase(emply)="T89018" or Ucase(emply)="T90076" OR _
     ...
     Ucase(emply)="T92134" or Ucase(emply)="T89031" or Ucase(emply)="P91109" then
     DAreaID="<>'*'"
  end if
  '資訊部管理員可讀取全部資料
 ...
 if userlevel=31 then DAreaID="<>'*'"  
        ...
        sqlList="SELECT RTEBTFtpAvsparaRpl.COMQ1, RTEBTFtpAvsparaRpl.LINEQ1, RTEBTFtpAvsparaRpl.CUSID,RTEBTFtpAvsparaRpl.flag,rtrim(convert(char(6),RTEBTFtpAvsparaRpl.COMQ1)) +'-'+ rtrim(convert(char(6),RTEBTFtpAvsparaRpl.lineQ1))  as comqline, case when RTEBTFtpAvsparaRpl.FLAG='A' THEN '申請' when RTEBTFtpAvsparaRpl.FLAG='F' THEN '報竣' WHEN RTEBTFtpAvsparaRpl.FLAG='C' THEN '取消' ELSE '' END ,RTEBTCMTYH.COMN,RTEBTCUST.CUSNC, " _
           &"RTEBTFtpAvsparaRpl.CONTRACTNO, RTEBTFtpAvsparaRpl.EBTREPLYDAT, RTEBTFtpAvsparaRpl.TRANNO, " _
           &"RTEBTFtpAvsparaRpl.CBCCONTRACTNO, RTEBTFtpAvsparaRpl.AVSNO, RTEBTFtpAvsparaRpl.EBTUPDSTATUS, RTEBTFtpAvsparaRpl.ERRORMSG,CASE WHEN RTEBTFtpAvsparaRpl.CLOSEDAT IS NOT NULL THEN 'Y' ELSE '' END,CASE WHEN RTEBTFtpAvsparaRpl.DROPDAT IS NOT NULL THEN 'Y' ELSE '' END,CASE WHEN RTEBTFtpAvsparaRpl.CLRFLAG IS NOT NULL THEN 'Y' ELSE '' END  " _
           &"FROM RTEBTFtpAvsparaRpl INNER JOIN RTEBTCMTYH ON RTEBTFtpAvsparaRpl.COMQ1 = RTEBTCMTYH.COMQ1 INNER JOIN " _
           &"RTEBTCUST ON RTEBTFtpAvsparaRpl.COMQ1 = RTEBTCUST.COMQ1 AND RTEBTFtpAvsparaRpl.LINEQ1 = RTEBTCUST.LINEQ1 AND " _
           &"RTEBTFtpAvsparaRpl.CUSID = RTEBTCUST.CUSID " _
           &"WHERE RTEBTFtpAvsparaRpl.comq1<>0 and RTEBTFtpAvsparaRpl.EBTUPDSTATUS='N' " & searchqry & " " _
           &"ORDER BY  RTEBTFtpAvsparaRpl.EBTREPLYDAT "
