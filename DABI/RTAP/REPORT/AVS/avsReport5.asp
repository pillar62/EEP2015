...
Session("oRpt").ParameterFields.GetItemByName("@updebtchkdats").AddCurrentValue(CDate(v(0)))
Session("oRpt").ParameterFields.GetItemByName("@updebtchkdate").AddCurrentValue(CDate(v(1)))
Session("oRpt").ParameterFields.GetItemByName("@adslapplydats").AddCurrentValue(CDate(v(2)))
Session("oRpt").ParameterFields.GetItemByName("@adslapplydate").AddCurrentValue(CDate(v(3)))
