...
<TITLE>專案社區用戶列表</TITLE>
<SCRIPT language=VBScript>
Sub cmdSure_onClick
  PGM="/report/AvsCity/Report9.asp?parm=" 
  symd=document.all("search1").value
  eymd=document.all("search2").value
  'IF LEN(TRIM(SYMD))=0 THEN SYMD="1900/1/1"
  'IF LEN(TRIM(EYMD))=0 THEN EYMD="2999/1/1"
...
<DIV align=Center><i><font face="標楷體" size="5" color="#FF00FF">專案社區 -- 報表列印(Excel)</font></i> </DIV>
<DIV align=Center><i><font face="標楷體" size="3" color="#FF00FF">用戶列表 </font></i> </DIV>

<P></P>

<table align="center" width="90%" border=0 cellPadding=0 cellSpacing=0>
  <tr><td ALIGN="RIGHT"><font face="標楷體">請輸入到期日起迄：</font></td>
	<td><input type="text" size="10" maxlength="10" name="search1" align=right class=dataListEntry value="" readonly ID="Text1">
		<input type="button" id="B1" name="B1" height=100% width=100% style="Z-INDEX: 1" value="...."></td></tr>

  <tr><td>&nbsp;</td>
	<td><input type="text" size="10" maxlength="10" name="search2" align=right class=dataListEntry value="" readonly ID="Text2">
