...
<%
reportname = "RTLessorAVSCmtyLineSNDWORKP.rpt"
  parm=request("parm")
  v=split(parm,";")  
...
Session("oRpt").ParameterFields.GetItemByName("@servicetype").AddCurrentValue(CStr("D"))
...
Session("oRpt").ParameterFields.GetItemByName("@entryno").AddCurrentValue(CInt(V(2)))
Session("oRpt").ParameterFields.GetItemByName("@prtno").AddCurrentValue(CStr(V(3)))
Session("oRpt").ParameterFields.GetItemByName("@prtusr").AddCurrentValue(CStr(V(4)))
