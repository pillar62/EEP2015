...
<DIV align=Center><i><font face="標楷體" size="3" color="#FF00FF">自營經銷商拆帳(2010/09/02 Updated) </font></i> </DIV>
...
<table align="center" width="90%" border=0 cellPadding=0 cellSpacing=0>
  ...
  <tr><td ALIGN="RIGHT"><font face="標楷體">請輸入截止日：</font></td>
	<td><input type="text" size="10" maxlength="10" name="search1" align=right class=dataListEntry value="<%=Sdate%>" readonly ID="Text1">
		<input type="button" onmousedown="Cal('search1')" height=100% width=100% style="Z-INDEX: 1" value="....">(日期請選擇月初)
	</td>
  </tr>
<!--
  <tr><td>&nbsp;</td>
