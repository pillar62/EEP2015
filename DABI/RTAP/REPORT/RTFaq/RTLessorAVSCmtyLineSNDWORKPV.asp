...
<script language=vbscript>
 sub window_onload()
    if frm1.htmlfld.value="1" then
       ...
       WINDOW.Form2.action="/RTAP/REPORT/AvsCity/RTLessorAVSCmtyLineSNDWORKP.asp" & "?parm=" & document.all("key1").value & ";" & document.all("key2").value & ";" & document.all("key3").value & ";" & document.all("key4").value
...
<form name=frm1 method=post action="RTLessorAVSCmtyLineSNDWORKPV.asp" ID="Form1">
