...
Session("oRpt").ParameterFields.GetItemByName("@workno").AddCurrentValue(Cstr(V(0)))
Session("oRpt").ParameterFields.GetItemByName("@linkno").AddCurrentValue(Cstr(V(1)))
