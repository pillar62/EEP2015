...
Session("oRpt").ParameterFields.GetItemByName("@casenos").AddCurrentValue(Cstr(Session("SCaseno")))
Session("oRpt").ParameterFields.GetItemByName("@casenoe").AddCurrentValue(Cstr(Session("ECaseno")))
Session("oRpt").ParameterFields.GetItemByName("@typ").AddCurrentValue(Cstr(Session("typ")))
