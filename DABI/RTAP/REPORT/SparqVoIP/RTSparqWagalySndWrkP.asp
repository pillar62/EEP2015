...
<%
reportname = "RTSparqWagalySndWrkP.rpt"
...
Session("oRpt").ParameterFields.GetItemByName("@workno").AddCurrentValue(Cstr(parm(0)))
Session("oRpt").ParameterFields.GetItemByName("@worktype").AddCurrentValue(Cstr(parm(1)))
