...
Session("oRpt").ParameterFields.GetItemByName("@comq1").AddCurrentValue(CINT(ARYPARMKEY(0)))
Session("oRpt").ParameterFields.GetItemByName("@comn").AddCurrentValue(CStr("＊"))
