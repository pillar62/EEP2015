...
'Session("oRpt").ParameterFields.GetItemByName("@comq1").AddCurrentValue(CInt(0))
Session("oRpt").ParameterFields.GetItemByName("@rpttype").AddCurrentValue(CStr(V(0)))
'Session("oRpt").ParameterFields.GetItemByName("@stat").AddCurrentValue(CStr(V(1)))
'Session("oRpt").ParameterFields.GetItemByName("@cmty").AddCurrentValue(CStr("Y"))
