...
'response.Write sql
	...
	Do While Not rs.Eof
		...
		response.Write "<font face=""標楷體"" size=4>　　　　　　　" &RS("zip")& "</font>"
		response.Write "<BR>"
		response.Write "<font face=""標楷體"" size=4>　　　　　　　　　" &RS("ADDR")& "</font>"
		response.Write "<BR><BR><BR>"
		response.Write "<font face=""標楷體"" size=5>　　　　　　　　" &RS("COMN")& "</font>"
		response.Write "<BR><font face=""標楷體"" size=5>　　　　　　　　社區管理委員會　收</font>"
