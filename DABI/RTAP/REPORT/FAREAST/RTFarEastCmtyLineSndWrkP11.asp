...
<%
reportname = "RTfareastCmtyLineSndWrkP11.rpt"
  parm=request("parm")
  v=split(parm,";")  
...
Session("oRpt").ParameterFields.GetItemByName("@wrktyp").AddCurrentValue("11")
Session("oRpt").ParameterFields.GetItemByName("@wrkno").AddCurrentValue(CStr(V(0)))
