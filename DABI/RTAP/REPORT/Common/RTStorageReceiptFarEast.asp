...
<%
	...
	sqlxx="select GTEQUIP, GTPRTDAT FROM RTfareastCUST WHERE comq1=" &V(0)& " and lineq1=" &V(1)& " AND CUSID='" &V(2)& "' "
	...
	IF ENDPGM ="" THEN
		reportname = "RTStorageReceiptA_fareast.rpt"
		...
		Session("oRpt").ParameterFields.GetItemByName("@casetype").AddCurrentValue(CStr("So-net"))
...
<form name=frm1 method=post action=RTStorageReceiptfareast.asp ID="Form1">
