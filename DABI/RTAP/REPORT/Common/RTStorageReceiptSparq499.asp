...
<%
	...
	sqlxx="select GTEQUIP, GTPRTDAT FROM RTSparq499Cust WHERE comq1=" &V(0)& " and lineq1=" &V(1)& " AND CUSID='" &V(2)& "' "
	RSXX.OPEN SQLXX,CONNxx
	endpgm=""
	IF len(trim(RSXX("GTEQUIP"))) = 0 THEN
			ENDPGM="2"
	'ELSEIF len(trim(RSXX("GTPRTDAT"))) > 0
	...
	IF ENDPGM ="" THEN
		...
		Session("oRpt").ParameterFields.GetItemByName("@casetype").AddCurrentValue(CStr("速博499"))
...
<form name=frm1 method=post action=RTStorageReceiptSparq499.asp ID="Form1">
