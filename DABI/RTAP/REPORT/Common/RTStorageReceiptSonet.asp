...
<%
	...
	sqlxx="select GTEQUIP, GTPRTDAT FROM RTSonetCUST WHERE comq1=" &V(0)& " and lineq1=" &V(1)& " AND CUSID='" &V(2)& "' "
...
<form name=frm1 method=post action=RTStorageReceiptSonet.asp ID="Form1">
