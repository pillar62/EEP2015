...
<%
	...
	sqlxx="select GTEQUIP, GTPRTDAT FROM RTPrjCust WHERE comq1=" &V(0)& " and lineq1=" &V(1)& " AND CUSID='" &V(2)& "' "
	...
	IF ENDPGM ="" THEN
		...
		Session("oRpt").ParameterFields.GetItemByName("@casetype").AddCurrentValue(CStr("Prj"))
