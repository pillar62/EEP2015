...
<table border="0" width="100%">
  ...
  <tr>
    <td width="20%">　</td>
    <td width="60%" align="middle"><font color="#0000ff">合約管理－各類報表列印</font></td>
...
<TABLE style="WIDTH: 400px; HEIGHT: 75px" cellSpacing=0 cellPadding=0 width=587 bgColor=antiquewhite border=1>
  <TR><TD style="WIDTH: 95%" width="95%" bgColor=#3e7373>
      <P style="COLOR: yellow" align=center>報表</P></TD></TR>
  <TR>
    <TD onclick="newurl(1)" onmouseover="rollIn(this)" onmouseout="rollOut(this)"
        ...
        <FONT style="COLOR: darkorchid;font-size:10pt">(1)合約標籤列印</FONT></TD></TR>
