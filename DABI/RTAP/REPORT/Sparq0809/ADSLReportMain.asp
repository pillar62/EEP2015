...
<script language=vbscript>
  sub newurl(num)
      ...
      select case num
		case 1
			prog="/webap/RTAP/Report/Sparq0809/ADSLReport1.asp?parm=" & symd &";"& eymd
		case 2
			prog="/webap/RTAP/Report/Sparq0809/ADSLReport2.asp?parm=" & symd &";"& eymd
		case else
	  end select
...
<table border="0" width="100%">
  ...
  <tr>
    <td width="20%">　</td>
    <td width="60%" align="middle"><font color="#0000ff">0809報表作業</font></td>
...
<TR><td>申請日：<input size="10" maxlength="10" name="search1" align=right class=dataListEntry value="<%=Sdate%>" readonly>
	...
	<input type="button" id="Button2" name="Bdate2" height="100%" width="100%" style="Z-INDEX: 1" value="....">	</td></tr>
<TR><TD onclick="newurl(1)" >
	<FONT style="COLOR: darkorchid;font-size:14pt">
	<INPUT type="BUTTON"  style="WIDTH: 100%;height:30;font-size:16pt"  VALUE="業績明細表(Excel)" ID="B1" NAME="B1"></FONT></TD></TR>
<TR><TD onclick="newurl(2)" >
	<FONT style="COLOR: darkorchid;font-size:14pt">
	<INPUT type="BUTTON"  style="WIDTH: 100%;height:30;font-size:16pt"  VALUE="申請清單(Excel)" ID="B2" NAME="B2"></FONT></TD></TR>
</TABLE>
...
<TR><td>統計截止日：<input size="10" maxlength="10" name="search3" align=right class=dataListEntry value="<%=edate%>" readonly ID="Text1">
	<input type="button" id="Button3" name="Bdate3" height="100%" width="100%" style="Z-INDEX: 1" value="....">
	</td></tr>
<TR><TD onclick="newurl(2)" >
	<FONT style="COLOR: darkorchid;font-size:14pt">
