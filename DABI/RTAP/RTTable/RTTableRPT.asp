...
Session("oRpt").ParameterFields.GetItemByName("@singleTable").AddCurrentValue(CStr("%"))
Session("oRpt").ParameterFields.GetItemByName("@printable").AddCurrentValue(CStr("Y"))
...
<HTML>
<HEAD>
    <title>元訊BiBuilding系統資料庫TABLE</title>
</HEAD>
