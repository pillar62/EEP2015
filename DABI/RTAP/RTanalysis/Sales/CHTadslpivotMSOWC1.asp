...
Sub srSpec()
 ...
 '------------------------------------------------------------ 
    ...
    '---910703修改為不挑執行人員
    parmSQL="SELECT * FROM RTCHTCUSTOT WHERE EUSR='" & V(0) & "'  order by 拆帳歸屬,業務組別,方案 "    
    defaultRowField="年度;月份;週;拆帳歸屬;方案;業務組別"
    defaultColumnField=""
    defaultFilterField=""
    fieldFormat="#,##0"
    fieldTotal="總送線數;總開通數;總撤線數;申請戶;完工戶;退租戶;報竣戶"
    fieldTotalBase="送件線數;開通線數;撤線數;申請戶數;完工戶數;退租欠拆戶;報竣戶數" 
