...
Sub srSpec()
 ...
 '---910703 modify start
    ...
    connXX.Open DSNXX
    strSP="USP_RTAVSLINEstatus " & V(0) & ",'" & KEYARY(0) & "','" & KEYARY(1) & "'"
 ...
 '------------------------------------------------------------ 
    ...
    '---910703修改為不挑執行人員
    parmSQL="SELECT * FROM RTAVSLINESTATUS WHERE EUSR='" & V(0) & "'  "    
    defaultRowField="預計施工;派工年;派工月;派工週;派工種類"
