...
Sub srSpec()
 ...
 '------------------------------------------------------------ 
    ...
    '---910703修改為不挑執行人員
    parmSQL="SELECT * FROM RTAVSCUSTOT WHERE EUSR='" & V(0) & "'  order by 拆帳歸屬,業務組別,方案 "    
    defaultRowField="年;月;週;拆帳歸屬;業務組別;業務員"
    defaultColumnField=""
    defaultFilterField=""
    fieldFormat="#,##0"
    fieldTotal="總送線數;總開通數;收件戶;申請戶;完工戶;報竣戶;退租戶"
    fieldTotalBase="送件線數;開通線數;收件戶數;申請戶數;完工戶數;報竣戶數;退租戶數" 
