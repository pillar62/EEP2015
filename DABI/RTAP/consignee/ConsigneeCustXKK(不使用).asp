...
Sub SrEnvironment()
  ...
  'End IF
  DSN="DSN=RTLib"
  formatName="none;none;社區名稱;客戶;申請單號;申請日;撤銷日;裝機地址;聯絡電話;可建置;不可建原因"
   sqlDelete="SELECT rtsparqaDslCustx.CUSID, rtsparqaDslCustx.ENTRYNO, rtsparqaDslCmtyx.comn, "_
         &"RTObj_1.SHORTNC,rtsparqaDslCustx.orderno, " _
         ...
         &"rtsparqaDslCustx.HOME,rtsparqadslcmtyx.agree,rtsparqadslcmtyx.remark   " _ 
         ...
         &"rtsparqaDslCMTYx  ON rtsparqaDslCustx.COMQ1 = rtsparqaDslCMTYx.CUTYID " _
...
'         &"RTCOUNTY.CUTNC + SINGLECUSTADSL.TOWNSHIP2 + SINGLECUSTADSL.RADDR2, " _         
 ...
 '        &"ORDER BY RTCOUNTY.CUTNC, SINGLECUSTADSL.TOWNSHIP2, SINGLECUSTADSL.RADDR2,rtobj.shortnc "
  ...
  colSplit=1
  keyListPageSize=20
  searchProg="ConsigneeCustXSS.asp"
  searchFirst=false
  If searchQry="" Then
     searchShow="全部"
     searchQry=" rtsparqaDslCustx.CUSID<>'*' and rtsparqaDslCMTYx.Consignee ='" &Session("UserID")& "' "
  ELSE
     SEARCHFIRST=FALSE
  End If  
  ...
  'ELSE
  sqllist="SELECT rtsparqaDslCustx.CUSID, rtsparqaDslCustx.ENTRYNO,  rtsparqaDslCMTYx.comn, "_
		 &"RTObj_1.SHORTNC,rtsparqaDslCustx.orderno, " _
         &"rtsparqaDslCustx.formaldat, " _
         &"rtsparqaDslCustx.dropdat, " _         
         &"RTCOUNTY.CUTNC + rtsparqaDslCustx.TOWNSHIP2 + rtsparqaDslCustx.RADDR2, " _         
