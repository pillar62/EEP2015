...
Sub SrEnvironment()
  ...
  sqlFormatDB="SELECT CUSID, CUSNC, FIRSTIDTYPE, SOCIALID, SECONDIDTYPE, SECONDNO, "_
			 ...
			 &"VALIDMONTH, VALIDYEAR, CONSIGNEE, DEVELOPERID, WRKNO1, WRKNO2, WRKRCVDAT, WRKSETDAT "_
...
Sub SrGetUserDefineKey()%>
      <table width="100%" border=1 cellPadding=0 cellSpacing=0>
       <tr><td width="25%" class=dataListHead>用戶序號</td>
           <td width="25%"  bgcolor="silver">
           <input type="text" name="key0"
                  readonly size="15" value="<%=dspKey(0)%>" maxlength="15" class=dataListdata></td>
  </tr>
      </table>
<%
End Sub
...
<DIV ID=SRTAB0>
	...
	<tr><td class="dataListSEARCH" height="23">對帳序號</td>                                 
        <td height="23" bgcolor="silver" colspan=3>
        <input type="text" name="key54" size="15" maxlength="15" <%=fieldpa%> value="<%=dspKey(54)%>"  class="dataListDATA" READONLY><FONT SIZE=2>-</FONT>
        <input type="text" name="key60" size="3"  maxlength="3" <%=fieldpa%> value="<%=dspKey(60)%>"  class="dataListDATA" READONLY></TD></TR>

	<tr><td width="15%" class=dataListHEAD>收件日</td>
		<td width="35%" bgcolor="silver" >
        <input type="text" name="key44" value="<%=dspKey(44)%>" <%=fieldpa%>  <%=dataProtect%> style="text-align:left;" maxlength="10" READONLY size="10" class=dataListEntry>
		<input type="button" name="B44" id="B44" <%=fieldpb%> height="100%" width="100%" style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick">
		<IMG SRC="/consignee/images/IMGDELETE.GIF" name="C44" id="C44" <%=fieldpb%> alt="清除"  style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td>

		<td width="15%" class=dataListHEAD>用戶申請日</td>
		<td width="35%" bgcolor="silver">
        <input type="text" name="key45" value="<%=dspKey(45)%>" <%=fieldpa%><%=dataProtect%> style="text-align:left;" maxlength="10" READONLY size="10" class=dataListEntry>
		<input  type="button" id="B45" name="B45" <%=fieldpb%> height="100%" width="100%" style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick">
		<IMG  SRC="/consignee/images/IMGDELETE.GIF" id="C45" name="C45" <%=fieldpb%> alt="清除" style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td></tr>
		
	<tr><td width="15%" class=dataListHEAD>用戶(公司)名稱</td>
		<td width="35%" bgcolor="silver">
        <input type="text" name="key1" value="<%=dspKey(1)%>" <%=fieldpa%><%=dataProtect%> style="text-align:left;" maxlength="30" size="30" class=dataListENTRY></td>

		<td class="dataListHEAD" height="23">出生日期</td>                                 
		<td height="23" bgcolor="silver">
        <input type="text" name="key6" size="10" value="<%=dspKey(6)%>" <%=fieldpa%> class="dataListentry" ID="Text1">  
        <input type="button" id="B6"  <%=fieldpb%>  name="B6" height="100%" width="100%" style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick"> 
        <IMG SRC="/consignee/images/IMGDELETE.GIF" <%=fieldpb%> alt="清除" id="C6" name="C6" style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td></tr>
...
%>
	<tr><td width="15%" class=dataListHEAD>身分證(統編)</td>
		<td width="35%" bgcolor="silver">
		<select size="1" name="key2"<%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListEntry"><%=s%></select>    
		<input type="text" name="key3" value="<%=dspKey(3)%>" <%=fieldpa%><%=dataProtect%>
...
%>
		...
		<select size="1" name="key4"<%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListEntry"><%=s%></select>	
        <input type="text" name="key5" value="<%=dspkey(5)%>" size="15" maxlength="15" <%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListEntry"></td></tr>

	<TR><td class="dataListHEAD" height="23">連絡電話</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key8" size="20" maxlength="20" <%=fieldpa%> value="<%=dspKey(8)%>"  class="dataListEntry"></td>

        <td class="dataListHEAD" height="23">行動電話</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key9" size="30" maxlength="30" <%=fieldpa%> value="<%=dspKey(9)%>"  class="dataListEntry"</td></tr>

	<tr><td class="dataListHEAD" height="23">傳真</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key10" size="30" maxlength="30" <%=fieldpa%> value="<%=dspKey(9)%>"  class="dataListEntry"</td>

		<td class="dataListHEAD" height="23">連絡EMAIL</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key7" size="50" maxlength="50" <%=fieldpa%> value="<%=dspKey(7)%>"  class="dataListEntry"></td></tr>
...
%>
	<tr><td class=dataListHEAD>戶籍/公司地址</td>
		...
		<select size="1" name="key11" <%=fieldpa%><%=dataProtect%> size="1" class="dataListEntry"><%=s%></select>
        <input type="text" name="key12" readonly  size="8" value="<%=dspkey(12)%>" maxlength="10" readonly <%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListDATA"><font SIZE=2>(鄉鎮)
        ...
        <input type="text" name="key13" <%=fieldpa%> size="40" value="<%=dspkey(13)%>" maxlength="60" <%=dataProtect%> class="dataListEntry"><font size=2>
		<input type="text" name="key14" readonly size="5" value="<%=dspkey(14)%>" maxlength="5" <%=fieldpa%><%=dataProtect%> class="dataListDATA"></td></tr>
<%
	s=""
    sx=" selected "
    If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) AND len(trim(DSPKEY(46))) = 0 Then 
...
%>
	<tr><td class=dataListHEAD>裝機地址<br><input type="radio" name="rd1" <%=fieldpb%> onClick="SrAddrEqual1()" ID="Radio3" VALUE="Radio3">同戶籍</td>
		<td bgcolor="silver" colspan=3>
		<select size="1" name="key15" <%=fieldpa%><%=dataProtect%> size="1" class="dataListEntry"><%=s%></select>
        <input type="text" name="key16" readonly  size="8" value="<%=dspkey(16)%>" maxlength="10" readonly <%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListDATA"><font SIZE=2>(鄉鎮)
		...
		<input type="text" name="key17" <%=fieldpa%> size="40" value="<%=dspkey(17)%>" maxlength="60" <%=dataProtect%> class="dataListEntry"><font size=2>
		<input type="text" name="key18"  readonly size="5" value="<%=dspkey(18)%>" maxlength="5" <%=fieldpa%><%=dataProtect%> class="dataListDATA"></td></tr>
<%
	s=""
    sx=" selected "
    If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) AND len(trim(DSPKEY(46))) = 0 Then 
...
%>
	<tr><td class=dataListHEAD>帳單地址<br><input type="radio" name="rd2" <%=fieldpb%>  onClick="SrAddrEqual2()" ID="Radio4" VALUE="Radio4"><font SIZE=2>同戶籍</font><input type="radio"  <%=fieldpb%> name="rd2" onClick="SrAddrEqual3()" ID="radio"  <%=fieldpb%>1><font SIZE=2>同裝機</font></td>
		<td bgcolor="silver" colspan=3>
		<select size="1" name="key19" <%=fieldpa%><%=dataProtect%> size="1" class="dataListEntry"><%=s%></select>
        <input type="text" name="key20" readonly size="8" value="<%=dspkey(20)%>" maxlength="10" readonly <%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListDATA"><font SIZE=2>(鄉鎮)
        ...
        <input type="text" name="key21" <%=fieldpa%> size="40" value="<%=dspkey(21)%>" maxlength="60" <%=dataProtect%> class="dataListEntry"><font size=2>
		<input type="text" name="key22" readonly size="5" value="<%=dspkey(22)%>" maxlength="5" <%=fieldpa%><%=dataProtect%> class="dataListDATA"></td></tr>

	<TR><td class="dataListHEAD" height="23">企業負責人</td>
        <td height="23" bgcolor="silver" >
        <input type="text" name="key29" size="10" maxlength="10" <%=fieldpa%> value="<%=dspKey(29)%>"  class="dataListEntry"></td>

        <td class="dataListHEAD" height="23">負責人身份證號</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key30" size="10" maxlength="10" <%=fieldpa%> value="<%=dspKey(30)%>"  class="dataListEntry"></td></tr>

	<TR><td class="dataListHEAD" height="23">行業別</td>
        <td height="23" bgcolor="silver" >
        <input type="text" name="key31" size="20" maxlength="20" <%=fieldpa%> value="<%=dspKey(31)%>"  class="dataListEntry"></td>
        
		<td class="dataListHEAD" height="23">企業連絡人</td>
		<td height="23" bgcolor="silver" >
        <input type="text" name="key23" size="15" maxlength="12" <%=fieldpa%> value="<%=dspKey(23)%>"  class="dataListEntry"></td></tr>

	<TR><td class="dataListHEAD" height="23">企業連絡電話</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key24" size="15" maxlength="15" <%=fieldpa%> value="<%=dspKey(24)%>"  class="dataListEntry">
        <font size=2>分機︰</font>
        <input type="text" name="key25" size="5" maxlength="5" <%=fieldpa%> value="<%=dspKey(25)%>"  class="dataListEntry"></td>

		<td class="dataListHEAD" height="23">企業傳真</td>
		<td height="23" bgcolor="silver" >
        <input type="text" name="key27" size="30" maxlength="30" <%=fieldpa%> value="<%=dspKey(27)%>"  class="dataListEntry"></td></tr>

	<tr><td class="dataListHEAD" height="23">企業行動電話</td>
        <td height="23" bgcolor="silver" >
        <input type="text" name="key26" size="10" maxlength="10" <%=fieldpa%> value="<%=dspKey(26)%>"  class="dataListEntry"></td>

		<td class="dataListHEAD" height="23">企業 E-Mail</td>
		<td height="23" bgcolor="silver" >
        <input type="text" name="key28" size="50" maxlength="50" <%=fieldpa%> value="<%=dspKey(28)%>"  class="dataListEntry"></td></tr>
...
%>    
	<tr><td class="dataListHEAD" height="23">建檔人員</td>                                 
        <td height="23" bgcolor="silver">
		<input type="text" name="key32" size="6" READONLY value="<%=dspKey(32)%>" <%=fieldpa%> class="dataListDATA"><font size=2><%=name%></font></td>
		
        <td class="dataListHEAD" height="23">建檔日期</td>                                 
        <td height="23" bgcolor="silver">
        <input type="text" name="key33" size="10" READONLY value="<%=dspKey(33)%>" <%=fieldpa%> class="dataListDATA"></td></tr>  
...
<%
  ...
  %>
	<tr><td class="dataListHEAD" height="23">修改人員</td>
        <td height="23" bgcolor="silver">
		<input type="text" name="key34" size="6" READONLY value="<%=dspKey(34)%>" <%=fieldpa%> class="dataListDATA"><font size=2><%=name%></font></td>

        <td class="dataListHEAD" height="23">修改日期</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key35" size="10" READONLY value="<%=dspKey(35)%>" <%=fieldpa%> class="dataListDATA"></td></tr>
	</table></div>
...
<%
    s80=""
    sx=" selected "
    If (sw="E" Or (accessMode="A" And sw="") or (sw="S" and formvalid=false)) and len(trim(dspkey(48)))=0  Then 
...
%>
	<tr><td WIDTH="15%" class="dataListHEAD" height="23">經銷商</td>
        <td WIDTH="35%" height="23" bgcolor="silver">
         <select size="1" name="KEY80" <%=fieldpg%> class="dataListEntry"><%=S80%></select></td>
...
%>
		...
		<td width="35%"><input type="text" name="key81"value="<%=dspKey(81)%>" <%=dataProtect%> style="text-align:left;" size="8" maxlength="6" readonly class="dataListDATA" ID="Text2">
			<input type="BUTTON" id="B81" name="B81" style="Z-INDEX: 1"  value="...." onclick="Srdeveloperonclick()">
			<IMG SRC="/consignee/images/IMGDELETE.GIF"  <%=fieldpb%> alt="清除" id="C81" name="C81" style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut"  onclick="SrClear">
...
%>    
	<tr><td id="tagT1" WIDTH="15%" class="dataListHEAD" height="23">業務轄區</td>
		...
		<select size="1" name="key36" <%=fieldpa%><%=dataProtect%>  class="dataListEntry"><%=s%></select>
...
%>
		<input type="text" name="key37" value="<%=dspKey(37)%>" <%=fieldpa%> <%=dataProtect%> size="3" maxlength="2" style="text-align:left;" readonly class="dataListEntry">
			<input type="button" id="B37" name="B37" <%=fieldpb%> width="100%" style="Z-INDEX: 1" value="...." readonly onclick="SrsalesGrouponclick()">
			<IMG SRC="/consignee/images/IMGDELETE.GIF" <%=fieldpb%> alt="清除" id="C37" name="C37" style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut"  onclick="SrClear">
...
%>
		<input type="text" name="key38" value="<%=dspKey(38)%>" <%=dataProtect%> style="text-align:left;" size="8" maxlength="6" readonly class="dataListDATA" ID="Hidden1">
			<input type="BUTTON" id="B38" <%=fieldpb%> name="B38"  width="100%" style="Z-INDEX: 1"  value="...." onclick="Srsalesonclick()">
			<IMG SRC="/consignee/images/IMGDELETE.GIF"  <%=fieldpb%> alt="清除" id="C38" name="C38" style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut"  onclick="SrClear">
			<font size=2><%=name%></font></td></tr>
	</table></DIV></DIV>
...
%>
	...
	<tr><td WIDTH="15%"  class="dataListHEAD" height="23">方案類別</td>               
        <td WIDTH="35%" height="23" bgcolor="silver" >
		<select size="1"name="key39" <%=fieldpC%>  <%=dataProtect%> class="dataListEntry"><%=s%></select></td>
...
%>                          
        ...
        <td  WIDTH="35%" height="23" bgcolor="silver" >
        <input type="radio" name="key40" value="Y" <%=FREECODE1%> <%=dataProtect%> ID="Radio1">是
        <input type="radio" name="key40" value="N" <%=FREECODE2%>  <%=dataProtect%> ID="Radio2">否</td></tr>

	<TR><td width=15% class="dataListHEAD" height="23">網路電話MAC號碼</td>
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key61" size="20" maxlength="17" value="<%=dspKey(61)%>" <%=fieldpc%> class="dataListEntry"></td>

        <td width=15% class="dataListHEAD" height="23">電話號碼(代表號)</td>
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key62" size="11" maxlength="11" value="<%=dspKey(62)%>" <%=fieldpc%> class="dataListEntry">
        <font size=2>，區間</font>
        <input type="text" name="key63" size="5" maxlength="4" value="<%=dspKey(63)%>" <%=fieldpc%>  class="dataListEntry"> ~ 
        <input type="text" name="key64" size="5" maxlength="4" value="<%=dspKey(64)%>" <%=fieldpc%>  class="dataListEntry"></td></tr>
...
%>
	<tr><td WIDTH="15%"  class="dataListHEAD" height="23">目前使用之寬頻服務</td>               
        <td WIDTH="35%" height="23" bgcolor="silver" >
		<select size="1"name="key65" <%=fieldpC%>  <%=dataProtect%> class="dataListEntry"><%=s%></select>
        <font size=2>　</font>
        <input type="text" name="key66" size="20" maxlength="20" value="<%=dspKey(66)%>" <%=fieldpc%> class="dataListEntry"></td>
...
%>
        ...
        <td WIDTH="35%" height="23" bgcolor="silver" >
		<select size="1"name="key67" <%=fieldpC%>  <%=dataProtect%> class="dataListEntry"><%=s%></select>
        <font size=2>　</font>
        <input type="text" name="key68" size="20" maxlength="20" value="<%=dspKey(68)%>" <%=fieldpc%> class="dataListEntry"></td></tr>
...
%>
	<tr><td WIDTH="15%"  class="dataListHEAD" height="23">上網型態</td>               
        <td WIDTH="35%" height="23" bgcolor="silver" >
		<select size="1"name="key69" <%=fieldpC%>  <%=dataProtect%> class="dataListEntry"><%=s%></select>
        <font size=2>　</font>
        <input type="text" name="key70" size="20" maxlength="20" value="<%=dspKey(70)%>" <%=fieldpc%> class="dataListEntry"></td>
...
%>
        ...
        <td WIDTH="35%" height="23" bgcolor="silver" >
		<select size="1"name="key71" <%=fieldpC%>  <%=dataProtect%> class="dataListEntry"><%=s%></select>
...
%>       
		...
		<select size="1" name="key72"<%=fieldpg%><%=fieldpa%><%=dataProtect%> class="dataListEntry">
			<option value=""></option>
			<option value="Y" <%=lineshare1%>>Y</option>
			<option value="N" <%=lineshare2%>>N</option></select></td></tr>
<!--		        
        <input type="radio" value="Y" <%=lineshare1%> name="key72" <%=dataProtect%> ID="Radio5">是
        <input type="radio" name="key72" value="N" <%=lineshare2%>  <%=dataProtect%> ID="Radio6">否</td></tr>
-->        

	<TR><td width=15% class="dataListHEAD" height="23">ADSL附掛電話</td>
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key73" size="12" maxlength="11" value="<%=dspKey(73)%>" <%=fieldpc%> class="dataListEntry"></td>
        
        <td class="dataListSEARCH" height="23">固定IP位址</td>                                 
        <td height="23" bgcolor="silver"><font color=red>
		<input type="text" name="key55" size="3" maxlength="3" value="<%=dspKey(55)%>" readonly class="dataListdata"><font size=2>.</font>
        <input type="text" name="key56" size="3" maxlength="3" value="<%=dspKey(56)%>"  readonly class="dataListdata"><font size=2>.</font>
        <input type="text" name="key57" size="3" maxlength="3" value="<%=dspKey(57)%>"  readonly class="dataListdata"><font size=2>.</font>
        <input type="text" name="key58" size="3" maxlength="3" value="<%=dspKey(58)%>"  readonly  class="dataListdata"><font size=2> ~ </font>
        <input type="text" name="key59" size="3" maxlength="3" value="<%=dspKey(59)%>"  readonly  class="dataListdata"></font></td></tr>
	</table></DIV>
...
<DIV ID=SRTAB5>
	...
	<TR><td width=15% class="dataListHEAD" height="23">代理人姓名</td>
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key41" size="15" maxlength="12" value="<%=dspKey(41)%>" <%=fieldpc%> class="dataListEntry"></td>

        <td width=15% class="dataListHEAD" height="23">代理人身份證號</td>
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key42" size="10" maxlength="10" value="<%=dspKey(42)%>" <%=fieldpc%> class="dataListEntry"></td></tr>

	<TR><td class="dataListHEAD" height="23">代理人電話</td>
        <td height="23" bgcolor="silver" colspan=3>
        <input type="text" name="key43" size="20" maxlength="20" value="<%=dspKey(43)%>" <%=fieldpc%> class="dataListEntry"></td></tr>
	</TABLE></div>
...
<DIV ID=SRTAB4 >
	...
	<tr><td width=15% class="dataListHEAD" height="23">派工單號</td>
        ...
        <input type="text" name="key82" size="12" maxlength="11" value="<%=dspKey(82)%>" <%=fieldpc%> class="dataListEntry"> / 
        <input type="text" name="key83" size="12" maxlength="11" value="<%=dspKey(83)%>" <%=fieldpc%> class="dataListEntry"></td></tr>

	<tr><td class="dataListHEAD" height="23">工單收件日(派工日)</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key84" size="10" READONLY value="<%=dspKey(84)%>" <%=fieldpC%>   class="dataListentry">
			<input type="button" id="B84" name="B84" height="100%" width="100%" <%=fieldpD%> style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick">
			<IMG SRC="/consignee/images/IMGDELETE.GIF" alt="清除" id="C84" name="C84" <%=fieldpD%> style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td>

		<td class="dataListHEAD" height="23">話機設定日(計費起算)</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key85" size="10" READONLY value="<%=dspKey(85)%>" <%=fieldpC%>   class="dataListentry">
			<input type="button" id="B85" name="B85" height="100%" width="100%"  <%=fieldpD%> style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick">
			<IMG SRC="/consignee/images/IMGDELETE.GIF" alt="清除" id="C85"  name="C85" <%=fieldpD%> style="Z-INDEX: 1" border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td></tr>

	<tr><td class="dataListHEAD" height="23">安裝完工日</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key46" size="10" READONLY value="<%=dspKey(46)%>" <%=fieldpC%>   class="dataListentry">
			<input type="button" id="B46"  name="B46" height="100%" width="100%"  <%=fieldpD%> style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick">
			<IMG SRC="/consignee/images/IMGDELETE.GIF" alt="清除" id="C46"  name="C46"    <%=fieldpD%> style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></td>

        <td class="dataListHEAD" height="23">報竣回覆日(回報Sparq)</td>                                 
        <td height="23" bgcolor="silver">
		<input type="text" name="key47" size="10" READONLY value="<%=dspKey(47)%>" <%=fieldpe%>  class="dataListDATA">
			<input type="button" id="B47"  name="B47" height="100%" width="100%" <%=fieldpf%>style="Z-INDEX: 1" value="...." onclick="SrBtnOnClick">
			<IMG SRC="/consignee/images/IMGDELETE.GIF" alt="清除" id="C47"  name="C47"   <%=fieldpf%>style="Z-INDEX: 1"  border=0 onmouseover="ImageIconOver" onmouseout="ImageIconOut" onclick="SrClear"></TD></tr> 

	<tr><td class="dataListHEAD" height="23">報竣轉檔日</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key48" size="10" value="<%=dspKey(48)%>"  class="dataListDATA"></td>

		<td class="dataListHEAD" height="23">退租日</td>
        <td height="23" bgcolor="silver">
        <input type="text" name="key49" size="10" value="<%=dspKey(49)%>"  class="dataListDATA">

        <font size=2>欠費︰</font>
        <input type="text" name="key52" size="2" READONLY value="<%=dspKey(52)%>"  class="dataListDATA"></td></tr>

	<tr><td width=15% class="dataListHEAD" height="23">作廢日期</td>                                 
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key50" size="10" value="<%=dspKey(50)%>" <%=fieldpa%> readonly class="dataListdata"></td>
...
%>         
        ...
        <td width=35% height="23" bgcolor="silver">
        <input type="text" name="key51" size="10" value="<%=dspKey(51)%>"  readonly class="dataListDATA"><font size=2><%=name%></font>
        </td></tr>           
	</table></DIV>
