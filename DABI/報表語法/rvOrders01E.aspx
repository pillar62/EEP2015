<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rvOrders01E.aspx.cs"
    Inherits="rvOrders01E" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <dx:ASPxDocumentViewer id="ASPxDocumentViewer1" runat="server" oncachereportdocument="ASPxDocumentViewer1_CacheReportDocument" onrestorereportdocumentfromcache="ASPxDocumentViewer1_RestoreReportDocumentFromCache" theme="SoftOrange">
            <ToolbarItems>
