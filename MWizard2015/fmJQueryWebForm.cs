...
{
    public partial class fmJQueryWebForm : Form
    {
        private TJQueryWebFormData FClientData;
        private DTE2 FDTE2;
        ...
        public fmJQueryWebForm(DTE2 aDTE2, AddIn aAddIn)
        {
            InitializeComponent();
            FClientData = new TJQueryWebFormData(this);
            FDTE2 = aDTE2;
            FAddIn = aAddIn;
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
                ...
                if (this.cbChooseLanguage.SelectedItem != null)
                {
                    switch (this.cbChooseLanguage.SelectedItem.ToString())
                    {
                        case "C#":
                            ...
                            this.cbWebForm.Items.Add("JQuerySingle1");
                            this.cbWebForm.Items.Add("JQuerySingle2");
                            this.cbWebForm.Items.Add("JQueryMasterDetail1");
                            this.cbWebForm.Items.Add("JQueryMasterDetail2");
                            this.cbWebForm.Items.Add("JQueryQuery1");
                            this.cbWebForm.SelectedIndex = 0;
                            break;
                        case "VB":
                            this.cbWebForm.Items.Clear();
                            this.cbWebForm.Items.Add("VBJQuerySingle1");
                            this.cbWebForm.Items.Add("VBJQuerySingle2");
                            this.cbWebForm.Items.Add("VBJQueryMasterDetail1");
                            this.cbWebForm.Items.Add("VBJQueryMasterDetail2");
                            this.cbWebForm.Items.Add("VBJQueryQuery1");
                            this.cbWebForm.SelectedIndex = 0;
                            break;
                    }
                }
            ...
            else if (tabControl.SelectedTab.Equals(tpDataSource))
            {
                ...
                else
                {
                    ...
                    if (FClientData.BaseFormName == "JQuerySingle2" || FClientData.BaseFormName == "JQueryMasterDetail1" || FClientData.BaseFormName == "JQueryMasterDetail2" ||
                        FClientData.BaseFormName == "VBJQuerySingle2" || FClientData.BaseFormName == "VBJQueryMasterDetail1" || FClientData.BaseFormName == "VBJQueryMasterDetail2")
                    {
        ...
        private void DoGenClient()
        {
            ...
            TJQueryWebFormGenerator Generator = new TJQueryWebFormGenerator(FClientData, FDTE2, FAddIn);
        ...
        private void cbWebForm_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "JQuerySingle1":
                case "VBJQuerySingle1":
                    this.label16.Text = templateName + ": JQueryGridview";
                    break;
                case "JQuerySingle2":
                case "VBJQuerySingle2":
                    this.label16.Text = templateName + ": JQueryGridview + JQueryFormview";
                    break;
                case "JQueryMasterDetail1":
                case "VBJQueryMasterDetail1":
                    this.label16.Text = templateName + ": JQueryGridview(Master) + JQueryFormview(Master) + JQueryGridview(Detail)";
                    break;
                case "JQueryMasterDetail2":
                case "VBJQueryMasterDetail2":
                    this.label16.Text = templateName + ": JQueryGridview(Master) + JQueryFormview(Master) + JQueryGridview(Detail) + JQueryFormview(Detail)";
                    break;
                case "JQueryQuery1":
                case "VBJQueryQuery1":
                    this.label16.Text = templateName + ": JQueryClientQuery + JQueryGridview";
                    break;
            }
        }
        ...
        private void SetValue()
        {
            ...
            FSelectedBlockFieldItem.HideGridColumn = checkBoxHideForGrid.Checked;
        ...
        private void DisplayValue()
        {
            ...
            checkBoxHideForGrid.Checked = FSelectedBlockFieldItem.HideGridColumn;
        }
        ...
        private void cbControlType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((sender as ComboBox).SelectedItem.ToString() == "ComboBox")
            {
                ...
                tbComboTableName_F.Enabled = true;
            }
            else if ((sender as ComboBox).SelectedItem.ToString() == "ComboGrid")
            {
                cbComboTableName.Enabled = true;
                cbDataValueField.Enabled = true;
                cbDataTextField.Enabled = true;
            ...
            else
            {
                ...
                tbComboTableName_F.Enabled = false;
            }
        }
            ...
            if (!String.IsNullOrEmpty(tbComboRemoteName_D.Text))
            {
                ...
                catch (SqlException sex)
                {
                    if (sex.Number == 208)
                    {
                        ...
                        if (sysConn.State != ConnectionState.Open) sysConn.Open();
                        comm = sysConn.CreateCommand();
                        comm.Transaction = sysConn.BeginTransaction();
                        comm.CommandText = "DELETE FROM SYS_REFVAL WHERE REFVAL_NO='Auto." + tbComboTableName_D_F.Text + "'";
                        comm.ExecuteNonQuery();
                        comm.CommandText = string.Format("INSERT INTO SYS_REFVAL (REFVAL_NO, TABLE_NAME, DESCRIPTION, DISPLAY_MEMBER, VALUE_MEMBER) VALUES('{0}', '{1}', '{2}', '{3}', '{4}')",
                                                        "Auto." + tbComboTableName_D_F.Text, FSelectedBlockFieldItem_D.ComboEntityName, FSelectedBlockFieldItem_D.ComboRemoteName, FSelectedBlockFieldItem_D.ComboTextField, FSelectedBlockFieldItem_D.ComboValueField);
        ...
        private void cbControlType_D_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if ((sender as ComboBox).SelectedItem.ToString() == "ComboBox" || (sender as ComboBox).SelectedItem.ToString() == "ComboGrid"
                || (sender as ComboBox).SelectedItem.ToString() == "RefValBox")
            {
    ...
    public class TJQueryWebFormData : Object
    {
        ...
        private MWizard2015.fmJQueryWebForm FOwner;
        ...
        public TJQueryWebFormData(MWizard2015.fmJQueryWebForm Owner)
        {
            FOwner = Owner;
        ...
        public bool IsMasterDetailBaseForm()
        {
            bool Result;
            Result = false;
            if (string.Compare(FBaseFormName, "JQueryMasterDetail1") == 0 ||
                string.Compare(FBaseFormName, "VBJQueryMasterDetail1") == 0 ||
                string.Compare(FBaseFormName, "JQueryMasterDetail2") == 0 ||
                string.Compare(FBaseFormName, "VBJQueryMasterDetail2") == 0)
            {
                Result = true;
            }
            return Result;
    ...
    partial class TJQueryWebFormGenerator : System.ComponentModel.Component
    {
        private TJQueryWebFormData FClientData;
        private DTE2 FDTE2;
        private AddIn FAddIn;
        ...
        public TJQueryWebFormGenerator(TJQueryWebFormData ClientData, DTE2 dte2, AddIn aAddIn)
        {
