...
namespace MWizard2015
{
    ...
    public partial class TJQueryWebFormGenerator
    {
        /// <summary>
        /// "Infolight"字串
        /// </summary>
        ...
        private String InitQueryField(TBlockFieldItem fieldItem, WebQueryField field)
        {
            ...
            if (string.Compare(fieldItem.ControlType, "textbox", true) == 0)
            {
                returnValue = String.Format("<JQTools:JQQueryColumn Caption=\"{0}\" Condition=\"{1}\" Editor=\"text\" FieldName=\"{2}\" />", field.Caption, field.Condition, fieldItem.DataField);
            }
            else if (string.Compare(fieldItem.ControlType, "combobox", true) == 0)
            {
                returnValue = String.Format("<JQTools:JQQueryColumn Caption=\"{0}\" Condition=\"{1}\" Editor=\"infocombobox\" FieldName=\"{2}\" " +
                                            "EditorOptions=\"valueField:'{3}',textField:'{4}',remoteName:'{5}',tableName:'{6}' \"/>",
            ...
            else if (string.Compare(fieldItem.ControlType, "refvalbox", true) == 0)
            {
                ...
                returnValue = String.Format("<JQTools:JQQueryColumn Caption=\"{0}\" Condition=\"{1}\" Editor=\"inforefval\" FieldName=\"{2}\" " +
                                        "EditorOptions=\"title:'JQRefval',panelWidth:350,columnMatches:[],valueField:'{3}',textField:'{4}',remoteName:'{5}',tableName:'{6}',columns:[{7}]\"/>",
            ...
            {
                returnValue = String.Format("<JQTools:JQQueryColumn Caption=\"{0}\" Condition=\"{1}\" Editor=\"datebox\" FieldName=\"{2}\" />", field.Caption, field.Condition, fieldItem.DataField);
            }
            else if (string.Compare(fieldItem.ControlType, "combogrid", true) == 0)
            {
                ...
                returnValue = String.Format("<JQTools:JQQueryColumn Caption=\"{0}\" Condition=\"{1}\" Editor=\"infocombogrid\" FieldName=\"{2}\" " +
                                        "EditorOptions=\"panelWidth:350,columnMatches:[],valueField:'{3}',textField:'{4}',remoteName:'{5}',tableName:'{6}',columns:[{7}]\"/>",
                                        field.Caption, field.Condition, fieldItem.DataField, fieldItem.ComboValueField, fieldItem.ComboTextField, fieldItem.ComboRemoteName, fieldItem.ComboEntityName, columns);

            }
            else if (string.Compare(fieldItem.ControlType, "numberbox", true) == 0)
            {
                returnValue = String.Format("<JQTools:JQQueryColumn Caption=\"{0}\" Condition=\"{1}\"  Editor=\"numberbox\" FieldName=\"{2}\" />", field.Caption, field.Condition, fieldItem.DataField);
            }
            return returnValue;
        }
